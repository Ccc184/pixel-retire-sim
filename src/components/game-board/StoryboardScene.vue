...
function sceneEffectClass(scene: StoryboardScene | null): string {
  ...
  const effects: Record<string, string> = {
    // 家庭
    'buy-house': 'sb-effect-smoke',
    'buy-car': 'sb-effect-speed',
    'marry': 'sb-effect-hearts',
    'date': 'sb-effect-hearts',
    'baby': 'sb-effect-twinkle',
    'divorce': 'sb-effect-broken',
    'breakup': 'sb-effect-broken',
    'couple-fight': 'sb-effect-lightning',
    'parent-sick': 'sb-effect-heartbeat',
    'midnight-baby': 'sb-effect-zzz',
    'play-kid': 'sb-effect-stars-small',
    'grandchild': 'sb-effect-stars-small',
    'blind-date': 'sb-effect-question',
    'parent-visit': 'sb-effect-hearts',
    // 生活
    'sick': 'sb-effect-heartbeat',
    'surgery': 'sb-effect-heartbeat',
    'travel': 'sb-effect-clouds',
    'friend-drink': 'sb-effect-bubbles',
    'pet': 'sb-effect-heart-small',
    'phone': 'sb-effect-screen',
    'exercise': 'sb-effect-flex',
    'fishing': 'sb-effect-water',
    'square-dance': 'sb-effect-notes',
    'read': 'sb-effect-book',
    'tv': 'sb-effect-tv',
    'lottery-win': 'sb-effect-coins',
    'lend-money': 'sb-effect-coins',
    'shopping': 'sb-effect-speed',
    // 事业
    'work': 'sb-effect-screen',
    'first-job': 'sb-effect-screen',
    'promotion': 'sb-effect-stars',
    'startup': 'sb-effect-flame',
    'fire': 'sb-effect-flame',
    'retire': 'sb-effect-confetti',
    ...
    'job-hop': 'sb-effect-stars',
    // gaokao/graduate/ipo/first-salary/digital-immortality/sunset/move/cook/walk/sleep/eat 无特效或通用pulse
  }
