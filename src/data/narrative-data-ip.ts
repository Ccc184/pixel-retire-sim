...
const commonEvents: NarrativeEvent[] = [
  ...
  // 23岁：找到自己的声音
  {
    ...
    narrative:
      ...
      '直到有一天，你剪了一条没经过任何"优化"的视频，素颜出镜，讲到一半卡壳了，你对着镜头说了句"我重说"。那条视频反而爆了。评论区最高赞来自一个叫"小棠"的ID，头像是一朵手绘的海棠花："终于有个不像在念稿的博主了。"那时候她是你的第187个粉丝。\n' +
      '你盯着这条评论，突然明白一件事：你一直在找"什么内容能火"，却没问过"什么是只有你能做的"。你的卡壳、你的口头禅、你的不完美——这些才是算法抄不走的指纹。你点进小棠的主页，她的动态里全是你的视频转发，配文永远是"又更新了"。',
    options: [
      {
        id: 'own_style',
  ...
  // 23-24岁：早期增长与第一条广告
  {
    ...
    narrative:
      ...
      '你翻遍了同行的接单记录，发现大家都在接，只是接得很"自然"。做内容的人迟早要面对的灵魂拷问，此刻也摆到了你面前：你的关注者，到底是"观众"，还是"资产"？',
    options: [
      {
...
const educatorEvents: NarrativeEvent[] = [
  ...
  // 28岁：学员成功故事
  {
    ...
    narrative:
      ...
      '你看着这张照片，眼眶突然热了。这两年你被骂过"割韭菜"、被同行嘲讽"培训班讲师"、被算法折磨得想退场。但这一刻你觉得都值了。知识真的能改变一个人的命运——而你是那个递梯子的人。',
    options: [
      {
        id: 'amplify_stories',
  ...
  // 31岁：冒名顶替综合征
  {
    ...
    oncePerGame: true,
    narrative:
      '一个行业大佬在动态圈转发了你的课程，配文"这个年轻人讲得很透彻"。你的私信瞬间爆了，报名数翻了五倍。\n' +
  ...
  // 37岁：成为导师的导师
  {
    ...
    narrative:
      ...
      '台下掌声雷动。你站在聚光灯下，看着这个当年连选题都发愁的年轻人，如今比你当年更耀眼。你突然有一种奇怪的感觉——谈不上嫉妒，更像是某种"接力棒交出去了"的释然。\n' +
...
const entertainerEvents: NarrativeEvent[] = [
  ...
  // 29岁：争议
  {
    ...
    narrative:
      ...
      '你想辩解，但每一条辩解都被当成"洗白"。在互联网上，"真相"不重要，"情绪"才重要——这个道理你算是彻底领教了。你不是在和一个观点战斗，你是在和一整片愤怒的海啸战斗。',
    options: [
      {
        id: 'apologize',
        label: '公开道歉，低头认错',
  ...
  // 32岁：粉丝见面会
  {
    ...
    narrative:
      ...
      '你愣住了。你一直把粉丝当成数据——播放量、点赞数、转化率。但此刻他们变成了一个个具体的人，有名字、有眼泪、有故事。一种沉甸甸的东西压上了肩头：你在影响活生生的人。\n' +
  ...
  // 36岁：内容同质化
  {
    ...
    narrative:
      ...
      '"过气"两个字，此刻有了实打实的触感。不是没人看了，是"你"这种风格，已经从"独创"变成了"通货"。你曾经引以为傲的个人标签，现在每个新人都会。\n' +
      '你刷到一条评论："这个博主老了，跟不上年轻人了。"你盯着这句话看了很久。你才36岁，但在互联网上，36岁已经是"前浪"。一个念头挥之不去：是该转型，还是该认命？',
    options: [
      {
        id: 'reinvent',
        label: '彻底转型，开辟新赛道',
...
const thoughtLeaderEvents: NarrativeEvent[] = [
  ...
  // 29岁：主题演讲
  {
    ...
    narrative:
      '一个行业大会邀请你做开场主题演讲，两千人，二十分钟。这种规格的台子，你还没站过。你准备了一个月，把稿子背得滚瓜烂熟，PPT改了十七版。\n' +
      '上台前一秒你腿还在抖。但当灯光打下来，台下安静下来，你开口的瞬间，那种恐惧突然消失了。你讲的是你思考了三年的那个观点，越讲越顺，金句自然地从嘴里流出来。结束时全场起立鼓掌。\n' +
      '下台后无数人加你社交软件，有投资人、有CEO、有记者。"思想变现"的滋味，你算是尝到了——与其说是钱，不如说是"被需要"。但你也意识到：台上的二十分钟，是你用三年的孤独思考换来的。聚光灯很亮，但照不到你熬夜的那些夜晚。',
    options: [
      {
        id: 'tour_speaking',
  ...
  // 31岁：被媒体引用
  {
    ...
    narrative:
      '你在动态圈刷到一条新闻：某主流媒体在分析一个社会现象时，引用了你提出的一个概念，还标注了你的名字。你截图发了条动态，半小时点赞过千。\n' +
      '但这只是开始。接下来一个月，你的概念被十几家媒体转引，被写进了几份行业报告，甚至出现在某位官员的讲话稿里。你的思想从"网络观点"变成了"公共话语"的一部分。\n' +
      '你既兴奋又惶恐。你想起当初提出这个概念时，只是想解释一个现象，没想到它会被这么多人拿去用——而用的人，未必理解你的本意。"思想失控"的恐惧爬上脊背：观点一旦离开你，就不再属于你了。',
    options: [
      {
        id: 'define_canon',
...
const crossBranchEvents: NarrativeEvent[] = [
  ...
  // 29岁：自己讨厌但数据最好的内容
  {
    ...
    eventType: 'normal',
    narrative:
      '你发了一条自己都讨厌的内容。标题是"99%的人都不知道的XX"，配了一张夸张的封面图。你写的时候就知道这是标题党，但发布后数据暴涨——三小时阅读量破十万，评论区一片叫好"太有用了"。\n' +
      '你盯着后台数据，快感与恶心同时涌上来。评论区每一条"谢谢博主"都像一巴掌——他们感谢的内容，你自己都不信。你翻到一条差评"这就叫标题党"，居然松了口气：至少还有人不买账。\n' +
  ...
  // 32岁：倦怠
  {
    ...
    narrative:
      '你坐在电脑前，光标闪了两个小时，一个字没写。你打开以前的内容，那种"想表达"的冲动消失了。灵感还在，只是热情没了。\n' +
      '你做了十年内容，把所有想说的都说尽了。你曾经为一条爆款兴奋整夜，现在百万播放只让你觉得"又一条而已"。你的情绪被流量磨平了，你的表达被算法驯化了，你的人被"IP"两个字掏空了。\n' +
      '伴侣说你"像个演员，下了台还在演"。你愣住——你已经分不清，镜头前的你和镜头后的你，哪个是真的。你倦怠了。身体还撑得住，垮掉的是灵魂。',
    options: [
      {
        id: 'real_sabbatical',
        label: '彻底停更半年，去生活',
  ...
  // 34岁：遇见偶像
  {
    ...
    narrative:
      ...
      '你忽然明白了一件事：你崇拜的那个人，其实从未存在过——你崇拜的，一直是你自己想象出来的那个"完美的自己"。神坛上没有神，只有一个个和你一样疲惫、一样挣扎、一样会老的人。你跪了十二年，跪的是自己的影子。',
    options: [
      {
        id: 'learn_from_flaws',
        label: '从偶像的"不堪"里学到教训',
  ...
  // 日常缝隙：深夜发呆
  {
    ...
    eventType: 'normal',
    narrative:
      '凌晨两点，你按下"发布"，看着那条内容缓缓飘上时间线。屏幕的蓝光照着你的脸，屋里安静得能听见冰箱的嗡嗡声。你忘了自己在这个姿势里坐了多久——手还搭在键盘上，但已经没在打字了。\n' +
      '窗外传来一声猫叫，又一声。你扭头看了一眼，窗台上蹲着一只橘猫，正盯着你。它叫了两声，跳下去走了。\n' +
      '你没追出去。但你站了起来，走到窗边，把窗户推开了一条缝。夜风灌进来，凉飕飕的。你深吸一口气，才发现自己从吃完晚饭到现在没动过。',
    options: [
      {
        id: 'write_about_cat',
        label: '把那只猫写进明天的内容里',
  ...
  // 镜像角色：小K
  {
    ...
    eventType: 'normal',
    narrative:
      '一个行业活动上，你被介绍给"小K"。你当然知道小K——他的粉丝比你多两倍，每条视频都几十万赞。你也知道他怎么做到的：标题党、擦边、情绪化内容，什么能煽动情绪就发什么。\n' +
      '小K主动来找你喝酒，说他"挺佩服你"。"你那条讲XX的视频我看了三遍，"他说，"但我不敢那么做——太慢了。"他掏出手机给你看他的后台：粉丝涨得快，取关也快，评论区一半是骂的。\n' +
...
const ipWarningEvents: NarrativeEvent[] = [
  ...
  // 预警1：数据断崖下跌，评论区开始骂你，掉粉
  {
    ...
    narrative:
      '你打开后台，手指停住了。\n\n' +
      '最新一条视频的播放量是你平时的十分之一。不是算法波动——前三条也在跌，一条比一条低。粉丝数从上周开始净流出，每天掉两三百，像一个漏水的桶。\n\n' +
      '你点开评论区。第一条热评："你最近怎么了？内容越来越水了。"第二条："取关了，以前的你不是这样的。"第三条是一个你曾经的铁粉，头像是你三年前的老粉丝牌，写着："失望。商业化之后就不是那个味儿了。"下面有两百多个赞。\n\n' +
      '你往下翻，越翻越冷。有人在分析你"为什么凉了"——选题重复、情绪过载、广告太硬、没有进步。每一条批评都精准得像刀子。你想反驳，但你知道他们说的是对的。你已经三个月没有写过一个让自己兴奋的选题了。你最近的五条内容全是广告。你在消耗过去积累的信任，而你自己心知肚明。\n\n' +
      '你关掉后台，房间里很安静。手机屏幕上还停留在那条"失望"的评论上。你第一次意识到：观众的爱不是存款，不会产生利息——它只会被花光。',
    options: [
      {
  ...
  // 预警2：灵感枯竭，对着镜头笑不出来，想删号
  {
    ...
    conditions: (s) => s.isAllInPath === true && (s.pathFaith < 40 || s.currentSavings < 50000),
    narrative:
      '补光灯亮着，相机在录，你张了张嘴，什么都没说出来。\n\n' +
      '这是今天的第七遍了。第一遍忘词，第二遍表情不对，第三遍声音沙哑，第四遍你发现自己说的内容和上一条视频一模一样——连笑话都是同一个。第五遍你对着镜头笑了三秒然后停下来，因为你发现那个笑容不是你的，是"账号人设"的。第六遍你直接说不下去了，坐在镜头前发呆了五分钟。\n\n' +
      '你看着取景框里的自己。那个表情你太熟悉了——嘴角上扬15度，眼睛微微眯起，头向右偏3厘米，那是你在几百条视频里反复练习过的"真诚笑容"。但现在这张脸让你觉得陌生。你不记得上一次真正笑是什么时候了。\n\n' +
      '桌面上摊着你的选题本，最近十页全划掉了。"没意思"、"说过了"、"没人看"、"我自己都不信"——每一个被划掉的选题后面都是你的批注。你已经连续两周没有产出任何让自己满意的内容了。你的MCN在催，你的经纪人在催，你的粉丝在催——但你最害怕的是，你好像已经没有东西可以给了。\n\n' +
      '你伸手碰了一下鼠标，光标悬停在"删除账号"按钮上。只需要点一下，一切就结束了。',
    options: [
      {
...
const postAllInEvents: NarrativeEvent[] = [
  ...
  // 空白页：全职创作的恐惧
  {
    ...
    narrative:
      '辞职后的第三个月，你坐在家里的书桌前，面对一个空白文档。\n' +
      '以前上班的时候，你总觉得"如果有一整天的时间，我能写出最好的东西"。现在你有了——整整一天，一周，一个月，全是你的。但光标就是不闪了。\n' +
      '没有人给你派活，没有人催你交稿，没有人开周会问你"这周产出什么"。你曾经梦寐以求的自由，此刻变成了一张白色的、空旷的、令人窒息的页面。你突然理解了那句话：自由不是没人管你，自由是你必须管自己。\n' +
      '以前做不出东西可以怪老板、怪会议、怪通勤太长。现在呢？怪谁？你端起咖啡，手有点抖——你第一次意识到：辞职辞掉的不只是工作，还有所有可以推卸责任的对象。从今往后，每一个空白的日子，都得由你自己填满。',
    options: [
      {
        id: 'build_routine',
        label: '给自己定规矩，模拟上班节奏',
  ...
  // 真名：现实中遇到粉丝
  {
    ...
    conditions: (s) => s.isAllInPath === true,
    narrative:
      '你在便利店排队结账，前面一个戴眼镜的年轻人一直回头看你。你低头刷手机，假装没注意。\n' +
      '"请问……你是XXX吗？"他终于开口了，声音有点抖，"我看你的内容三年了。"\n' +
      '你愣了一秒。在网上被认出来是常态——每天都有评论和私信。但在便利店、穿着拖鞋、手里拿着泡面和牙膏的时候被认出来，是完全不同的体验。屏幕上的粉丝是头像和ID，眼前这个是活生生的人，有青春痘，有洗得发白的背包，有紧张时攥紧塑料袋的手。\n' +
      '"你那条讲辞职的视频，"他说，"我看了十七遍。就是因为那条，我才敢从那家公司出来。"他笑了笑，"现在我自己做设计工作室，虽然不大，但……谢谢你。"\n' +
      '你想说点什么，但喉咙有点堵。你无数次怀疑过"做内容到底有什么意义"——播放量是虚的，点赞是虚的，连粉丝数都是平台给的。但此刻站在便利店里，面前这个人因为你说过的话改变了人生轨迹。你突然意识到：你在屏幕前说的每一句话，都可能穿过屏幕，落到某个真实的人的人生里。',
    options: [
      {
        id: 'deep_connection',
        label: '认真聊几句，加个联系方式',
  ...
  // 创作瓶颈：创意枯竭
  {
    ...
    narrative:
      '你已经三天没发出一条内容了。\n' +
      '屏幕上是一个写了标题又删掉的文档，光标在第三行闪了一整天。你试过换环境——去咖啡馆、去公园、去图书馆——没用。你试过看书、看电影、听播客找灵感——脑子里一片浆糊。你甚至试过喝酒——喝到半醉写了三百字，第二天醒来全删了。\n' +
      '最可怕的不是写不出东西，是你开始怀疑自己是不是"写完了"。那些曾经让你热血沸腾的选题，现在看起来全是陈词滥调。那些你以为取之不尽的观点，原来在几年前就已经说尽了。你盯着屏幕，像盯着一口枯井——你曾经从里面打出过水，但现在井底是干的。\n' +
      '以前上班时遇到瓶颈，你可以怪"没时间""没精力""被琐事分散了注意力"。现在你有全部的时间和精力，却什么也写不出来。这个事实像一记闷棍：原来那些借口，全是借口。瓶颈就是瓶颈，和忙不忙没关系。',
    options: [
      {
        id: 'through_block',
        label: '硬写，哪怕写出来的是垃圾',
  ...
  // v13新增：品牌年框合作（All In后中期变现事件）
  {
    ...
    narrative:
      '一家你真正用过且喜欢了三年的品牌找来了——不是那种什么都接的乱投，是市场总监亲自发的长邮件，说TA看了你两年内容，觉得你的调性和品牌完全契合。\n' +
      '报价是一年框架合作：每月两条深度内容，年底分红，总金额比你去年全年收入还高。而且合同里写得很清楚——内容方向你完全自主，品牌不审稿，只要求"真实使用感受"。\n' +
      '这是你接过的最大的单。但你也清楚：一旦签了年框，你的内容日历就被锁住了十二个月，灵活度会下降。而且你的老粉丝对"恰饭"一向敏感——哪怕是你真心喜欢的品牌。',
    options: [
      {
        id: 'sign_frame_deal',
        label: '签年框，稳定变现一整年',
  ...
  // v13新增：知识付费课程上线
  {
    ...
    narrative:
      '你的私信里永远有一类问题："能不能系统讲讲你是怎么做内容的？"你回复了几百次"以后会做"，现在是时候兑现了。\n' +
      '你花了三个月打磨一门系统课程——从选题到剪辑到变现，把你踩过的所有坑全部写进去。不是那种割韭菜的"三天涨粉十万"，是你真刀真枪干了十年的方法论。\n' +
      '课程录制完成的那天，你看着五十个小时的素材，知道这是你做过的最重的资产——它可以在你睡觉的时候卖，在你旅行的时候卖，在你不想更新内容的时候卖。这才是真正的被动收入。',
    options: [
      {
...
const lateGameEvents: NarrativeEvent[] = [
  ...
  // 新人：看到年轻创作者做同样的事
  {
    ...
    oncePerGame: true,
    narrative:
      '你刷到一条视频，一个二十二岁的年轻人在讲你十五年前讲过的话题。\n' +
      'TA比你当年讲得更好——镜头感更自然，节奏更快，数据可视化做得漂亮，连幽默都恰到好处。那条视频的播放量是你今年所有内容加起来的三倍。评论区全是"这个UP主太有才了""未来可期"。\n' +
      '你盯着屏幕，心里五味杂陈。屏幕里那张年轻的脸，像极了你第一次按下录制键时镜子里的自己——也是那样意气风发，觉得自己能改变世界。而现在，你看着这个年轻人，就像看着一个更年轻、更锋利、更适应这个时代的自己。TA用的方法是你十五年前发明的，但TA用得比你好。\n' +
      '一个念头冒出来，凉飕飕的：你是不是过时了？你花了十五年打磨的手艺，在新人眼里不过是起点。你曾经以为自己走在前面，回头一看，后面的人已经跑到了你旁边——而且跑得更快。',
    options: [
      {
        id: 'collaborate_new',
        label: '主动联系，和新人合作',
  ...
  // 你写过的东西：内容改变了某个人的人生
  {
    ...
    oncePerGame: true,
    narrative:
      '你收到一封邮件，标题是"感谢你十年前写的那篇文章"。\n' +
      '发件人你不认识。TA在邮件里说，十年前TA正处在人生最低谷——失业、失恋、差点做了不可逆的决定。某个深夜刷到你写的一篇文章，"具体内容已经记不清了"，但里面有一句话让TA放下了手里的刀。那句话是："再撑撑看，反正你也没什么可失去的了。"\n' +
      '"现在我结婚了，有了孩子，开了一家小书店，"TA写道，"我一直想找到你，告诉你这件事。你可能早就忘了你写过那句话，但我记了十年。"\n' +
      '你盯着这封邮件，完全不记得自己写过那句话。你翻遍了十年前的内容，在一篇现在看来粗糙、幼稚、数据平平的文章里找到了它。你当时只是随手写了一句给自己打气的话，甚至写完就忘了。\n' +
      '但那句话穿过了十年的时光，穿过了屏幕和距离，落在了一个绝望的人身上，接住了TA。你做了二十年内容，追过热点、算过数据、焦虑过流量、怀疑过意义——而这一封邮件，把所有的怀疑都击碎了。',
    options: [
      {
        id: 'write_back',
        label: '认真回信，告诉TA你的感受',
  ...
  // 不需要人设：终于做自己
  {
    ...
    oncePerGame: true,
    narrative:
      '你对着镜头准备录一条新视频。打板前你习惯性地清了清嗓子，调整了表情——那个"镜头里的你"的表情：嘴角上扬十五度，眼神略带深邃，声音比平时低半个key。\n' +
      '但今天你看着监视器里的自己，突然觉得累。\n' +
      '那个表情你戴了二十年。你知道哪个角度上镜、哪种语气讨喜、哪类观点安全不会翻车。你演"你自己"演了太久，久到有时候分不清哪个才是真的你——是镜头前那个睿智从容的IP，还是私下里会偷懒、会发脾气、会在超市为几毛钱犹豫的中年人。\n' +
      '你关掉了补光灯，把脚本扔到一边，对着黑乎乎的镜头坐了很久。然后你打开手机，用前置摄像头、没化妆、没打光、没脚本，按了录制键。"今天不聊干货，"你听见自己说，"我想聊聊我累了。"\n' +
      '那一刻你感觉脸上的什么东西碎了——不是崩塌，是脱落。像戴了二十年的面具终于摘下来，空气直接贴在皮肤上，有点凉，但很轻。',
    options: [
      {
  ...
  // 46岁：被流量反噬
  {
    ...
    eventType: 'normal',
    narrative:
      '你五年前说过的一句话被翻了出来。那是你在一期播客里随口说的一个观点——当时没人在意，现在被剪成切片，配着"塌房""人设崩塌"的标题传遍全网。\n' +
      '评论区疯了。老粉说"失望""原来你是这种人"，路人说"活该"，营销号批量搬运你"前后矛盾"的言论。你翻评论翻到凌晨三点，手指停不下来——每一条骂你的话都像一根针，扎在你最软的地方。\n' +
      '更让你难受的是小棠——你从0到千万的第一个粉丝，那个从你只有200个订阅就每期必看的人——私信你说："我需要想想还要不要继续关注你。"你盯着那条消息，眼泪掉在屏幕上。你做了二十年内容，第一次觉得：流量是借来的，它给你多少光环，就能加倍收回多少。',
    options: [
      {
