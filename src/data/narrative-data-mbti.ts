...
const MBTI_NARRATIVE_EVENTS: NarrativeEvent[] = [
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '棋盘上的手',
    narrative:
      '季度复盘会上，所有人都在称赞那个"天衣无缝"的项目。只有你知道，它的成功是因为你让流程绕开了一个"会拖慢速度"的搭档。\n' +
      '他上周递了辞呈，临走留下一句："在你眼里，我从来不是一个人，是一个会出错的变量。"你盯着那份完美的PPT，第一次感到说不清的恶心——你可以控制每一个变量，却控制不了这种"被自己控制"的空虚。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'INTJ',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '山顶的图纸',
    narrative:
      '四十岁那年，你人生的五年计划第一次全部兑现：职位、存款、房产，连"合适的伴侣"都按时间表到位了。\n' +
      '可那天夜里你坐在装修好的书房里，看着墙上的甘特图，忽然不知道自己为什么坐在这里。你从没失败过，因为你从没真正选择过——你只是在执行那个"最优解"，而最优解里，没有"你"。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'INTJ',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '拆到停不下来',
    narrative:
      '那个跳槽的机会你研究了整整两个月：行业报告看了四十份，架构图画了三版，连新上司的社交媒体都扒了一遍。deadline 那天你还在写第十七页的"风险分析矩阵"，HR 发来消息：岗位已关闭。\n' +
      '你这才意识到，你不是在"做准备"，你是在用分析逃避决定——没有哪个选择真正合理，所有的"最优"都是你给自己编的故事。理解得越深，你越无法迈出那一步。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'INTP',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '看见底牌之后',
    narrative:
      '你用了十几年，终于想通了"这一切是怎么运转的"——婚姻是契约，工作是交易，连"意义"都不过是大脑分泌的安慰剂。理论上你获得了自由，实际上你瘫痪了：去爱是激素，去奋斗是多巴胺陷阱，去相信是自我欺骗。\n' +
  ...
  // ----------------------------------------------------------
  {
    ...
    narrative:
      ...
      '那天中午你端着餐盘走进食堂，一整张桌子的人在你坐下前各自找借口散了。"跟他吃饭像被审计。"你一个人吃完那顿饭——你赢了 KPI，却输掉了一张能一起吃饭的桌子。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ENTJ',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '山顶只有风',
    narrative:
      '四十二岁，你坐进了独立办公室，窗外是整座城市的天际线。团队、营收、行业地位，一切都按效率到位了。\n' +
      '可医生说你的心脏在"用四十岁的年龄跑六十岁的节奏"。你想找人说说，翻遍通讯录——所有人都是"资源"，没有一个是"人"。你站在落地窗前，第一次问自己：你爬上来的到底是山，还是你自己垒的牢笼？',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ENTJ',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    narrative:
      ...
      '你赢了那场辩论，会后却没人再找你——他们说你"什么都能反驳，什么都不信"。你的聪明看穿了一切立场，可看穿之后，你连一个愿意跟你并肩的人都没有。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ENTP',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '无立场的自由',
    narrative:
      '四十岁，你终于做到了"不被任何立场绑架"——你能在任何一个阵营里找出漏洞，在任何信仰里挖出虚伪。你引以为傲。\n' +
      '可那天一个年轻人郑重地问你："那你相信什么？"你张了张嘴，答不上来。没有根基的自由，原来不是飞翔，是失重——你什么都能站，也就哪里都站不稳。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ENTP',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '没人信的预言',
    narrative:
      '半年前你就看出那个新方向是个坑，你写了三封预警邮件，开会提了五次，所有人都点头，没人当回事。如今坑真的塌了，领导却皱着眉看你："你既然早看出来了，为什么不更用力地拦住我们？"\n' +
  ...
  },
  {
    ...
    title: '火焰也需要燃料',
    narrative:
      '为了那个你看见了十年的理想，你燃烧了一切：加班、储蓄、健康，连仅有的几段关系都被你"暂时搁置"。那天你晕倒在工位上，醒来时病房里没有一个人。\n' +
      '护士问你联系谁，你忽然说不出一个名字。你可以为理想燃烧自己，但火焰也需要燃料——而你这团火，快要烧到自己的根了。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'INFJ',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '不演的那个',
    narrative:
      '那个能让你升职的项目，要求你在汇报里把一个你自己都不信的"愿景"讲得热血沸腾。同事劝你"大家都这样，fake it till you make it"，你对着镜子练那句假话，练到反胃。\n' +
      '可世界不给理想主义者发工资。第二天汇报，你选择了沉默——你保住了自己，也保住了那份永远"格格不入"的孤独。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'INFP',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '纯粹与面包',
    narrative:
      '四十岁，房租涨了，父母病了，你的原则第一次撞上一道算不过来的账。一个你瞧不起的甲方递来你十年都赚不到的钱，条件是——把你的名字，署在一篇你鄙视的东西上。\n' +
      '你的内心丰富得像一座教堂，外部粗糙得像一把锉刀。守住那座空无一人的教堂，还是走进会让你面目模糊的人间？你的纯粹，到底是盾牌，还是你为自己画的牢？',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'INFP',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '没人问你还好吗',
    narrative:
      '这一年你帮同事改简历、帮朋友调解吵架、帮下属争取晋升、帮父母挂号——你是所有人的树洞、军师、保姆。价值感全建立在"被需要"上。\n' +
      '那天你发烧到 39 度，翻通讯录想找个人说说难受，划了三百个名字，一个都没发出去——你太擅长理解别人，以致没人记得你也会倒下。你烧得迷迷糊糊，第一次问自己：给予是爱，还是你逃避"自己也需要被爱"的方式？',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ENFJ',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '照亮所有人的灯',
    narrative:
      '四十岁，你成了所有人眼里的"光"——下属说你改变了他们的人生，朋友说没有你他们撑不下去。可你听着锦旗，心里却空得发慌。\n' +
      '你的温暖照亮了所有人，唯独照不到你自己。你忽然很想知道：如果有一天你不再"有用"，这些人还会留下吗？还是你早就用"被需要"，把"我是谁"这个问题藏起来了？',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ENFJ',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '五扇开着的门',
    narrative:
      '你同时报了三个班、谈着两段暧昧、存着一个创业点子、还想着出国读书——每一个都"说不定就是我的真爱"。可半年过去，没有一样落了地。\n' +
      '你害怕扎根，因为扎根就意味着关上其他所有的门。可你盯着五扇开着的门，第一次害怕起来：每一个选择都意味着杀死其他所有可能性。一直不选，你是不是正在杀死自己？',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ENFP',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '门一扇扇关上',
    narrative:
      '四十岁，那些开着的门正在一扇扇自己关上——不是你选的，是时间替你选的。想去的公司不要 35+，想爱的人结了婚，想学的手艺"年纪大了学不动"。\n' +
      '你追逐了半生自由，才发现自由是你最大的牢笼——自由从来不是"什么都能选"，而是"必须选一个，然后为它负责"。你站在最后一扇还没关上的门前，这次怕的不是选错，是不选。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ENFP',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '所有人的兜底',
    narrative:
      '你从来不做"不该做的事"——所以同事甩锅、领导加活、父母要钱、伴侣抱怨时，第一个被想到的永远是你。这个月你连轴转了三十天，没人问过你累不累，而"拒绝"在你字典里属于"不该做的事"。\n' +
      '你用责任填满了所有时间，可能只是为了逃避那个问题：如果不做这些"该做的事"，你究竟是谁？责任是美德，还是你不敢质疑的暴君？',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ISTJ',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    narrative:
      ...
      '那天你翻到二十岁的日记，一行被你划掉的字："我想去看海。"这二十五年里你一次海都没去过——因为"那时候该忙事业"，"后来该顾家庭"。你用一辈子的"该"，换来的，到底是自己的人生，还是别人画好让你填的格子？',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ISTJ',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '看不见的付出',
    narrative:
      '你记得每个人咖啡加几块糖、记得领导的忌口、记得同事孩子的生日。你把自己缩到最小，好让所有人都有空间。\n' +
      '那天你累病了请了半天假，回来发现家里乱成一团，所有人都在问"我的东西你放哪了"，没人问过你"好点了吗"。你的付出是无声的，所以也是无形的——没人看见，也就没人当回事。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ISFJ',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '咽下去的石头',
    narrative:
      '二十年了，你为他们做了一切，他们回报你的是理所当然。你给父母养老、给伴侣兜底、给孩子铺路，自己病了硬扛，累了不说。\n' +
      '那天你听见伴侣对孩子说"你妈/你爸反正闲着也是闲着"。这些年咽下去的委屈，一下变成一块石头堵在喉咙里。你用付出绑架关系——可如果有一天你不再付出，他们爱的，是你，还是你的"有用"？',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ISFJ',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '优化掉的那个人',
    narrative:
      '你把整个部门重组成了一条高效流水线，效率涨了 50%，你很满意。\n' +
      '直到那个被你"优化"掉岗位的老员工红着眼来找你："我在这个岗位二十年，你用一张表就把我的全部抹掉了。"你赢了效率，却忘了——人是目的，不是手段。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ESTJ',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    narrative:
      ...
      '你坐在自己搭的系统中央，忽然觉得活着的不是你，是你的系统。当一切都优化到极致，那个"多余的你"，是不是也该被优化掉？',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ESTJ',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '中心的孤岛',
    narrative:
      '你是所有聚会的发起人、所有矛盾的调停者、所有人情的记账员。通讯录有一千个名字，日历排满了别人的生日。\n' +
      '那天你失恋了，想找个人哭一场，却发现所有人都"认识"你，没有一个人"了解"你。你用关系织了一张网，把自己困在最中间——而中心，恰恰是最孤独的位置。被需要，原来和被爱，是两回事。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ESFJ',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '不再被需要的那天',
    narrative:
      '四十五岁，孩子大了不需要你张罗，伴侣独立了不需要你照顾，朋友都有了各自的圈子。你那张精心编织的关系网，一夜之间松了。\n' +
      '你这辈子的身份，都是"谁的谁"——谁的妈妈、谁的妻子、谁的靠山。当这些"谁"都不再需要你，剩下的那个空壳，叫什么名字？你从没真正认识过，那个不被任何人需要的自己。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ESFJ',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '修不好的人',
    narrative:
      '单位那台谁都搞不定的机器，你二十分钟就让它重新转起来。你只信手感——手摸到的地方，就是真相。\n' +
      '可那天伴侣红着眼说"我觉得你根本不在乎我"，你伸出手，却不知道该拧哪颗螺丝。你能修好任何机器，修不好任何一段关系——你的手，只会修不会抱。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ISTP',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '手停下来的那一刻',
    narrative:
      '四十二岁，你受了伤，三个月不能动手，第一次必须"待着"——没有机器可修，没有危机可解，只有你自己。\n' +
      '你不信语言，只信手感，可手被绑住了，你只剩语言，而你的语言贫瘠得吓人。当手停下来的时候，你是谁？你是在用行动感知世界，还是在用行动，逃避认识自己？',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ISTP',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '没人看见的颜色',
    narrative:
      '你花了一个月，把那个枯燥的报告做成了你心里那幅画的样子——配色、留白、节奏，每个细节都是你对"美"的信仰。领导三秒翻完："花里胡哨，数据呢？"\n' +
      '你活在一个别人看不见的色彩世界里，解释一个天生看不见的颜色，只会让自己更孤独。可沉默不是答案——在一个只看结果的世界里，你的敏感，到底是天赋，还是一种没人付费的残疾？',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ISFP',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '美与面包',
    narrative:
      '四十岁，一个能让你安心创作的机会摆在面前，代价是放弃一份安稳但窒息的工作——而你的积蓄只够撑半年。\n' +
      '你站在美术馆一幅画前，问自己：美值得用半生安稳去换吗？在一个只看结果的世界里，追求美本身就是一种不被原谅的奢侈？你的敏感是天赋还是残疾，取决于你敢不敢为它付账。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ISFP',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    narrative:
      ...
      '可庆祝的酒还没醒，"活着"的感觉就褪色了——下一个刺激在哪？你不知道，你只知道没有刺激的时候浑身发痒。你说"此刻即永恒"，可当此刻一个接一个流逝，你回头看，手里什么都没留下。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ESTP',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '等不起的东西',
    narrative:
      '四十岁，你回看自己的战绩：抓住的机会一个比一个漂亮。可那些真正珍贵的——一段需要慢慢长的感情、一个十年磨一剑的手艺、一个需要等待的承诺——你一个都没有。\n' +
      '不是抓不到，是它们都"太慢了"，你等不起。你赢了一切瞬间，却输掉了一整段人生。你想等一次了，却不知道，还等不等得起。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ESTP',
    ageRange: [38, 48],
  ...
  // ----------------------------------------------------------
  {
    ...
    title: '派对之后',
    narrative:
      '你是那场派对的灵魂——让陌生人变成朋友，让沉默变成大笑，让所有人记得"那晚真开心"。你天生就会创造快乐。\n' +
      '可派对散场，关上门，笑容像被人按了暂停键一样垮下来。你坐在没开灯的客厅里，第一次承认：你的快乐是给别人看的，不是给自己活的。你用欢笑掩盖痛苦，久而久之，连你自己都快分不清，哪个笑容是真的。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ESFP',
    ageRange: [25, 33],
  ...
  },
  {
    ...
    title: '笑不出来的那天',
    narrative:
      '四十三岁，你照常准备上台活跃气氛，却发现这一次怎么都笑不出来。那块撑了你半生的"快乐面具"，忽然裂开了一道缝。\n' +
      '底下的人还在等你抖包袱，你的嘴却像被缝住了。快乐是最孤独的情绪——没人相信快乐的人也会痛，所以没人问过你痛不痛。面具戴了太久，长进了肉里，今天它裂了，你不知道露出来的是真正的你，还是一个再也笑不出来的空壳。',
    pathId: 'ai_symbiote',
    crossPath: true,
    mbtiExclusive: 'ESFP',
    ageRange: [38, 48],
