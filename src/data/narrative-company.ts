...
const companyEvents: NarrativeEvent[] = [
  ...
  // ============================================================
  {
    ...
    narrative:
      '一封邮件躺在收件箱里，标题写着"AI转型战略合作意向"。\n' +
      '发件人是某上市公司的数字化负责人，方案预算写得明明白白：一期80万，二期可能追加到200万。你的手指在触控板上悬了三秒——这是你接过的最大一单。\n' +
      '但你笑不出来。因为邮件最后一句是："请提供贵司增值税专用发票信息。"\n' +
      '贵司。你苦笑了一下。你这间"公司"就是一个自由职业者，连个营业执照都没有。过去的大客户都能用个人代开发票凑合，但上市公司财务卡得死——没有公司主体，这单就飞了。\n' +
      '你打开了三个标签页：注册公司的流程、附近共享办公的报价、招聘网站上AI工程师的薪资。注册一家科技公司最快两周，押三付一租个工位要两万，雇两个能干活的工程师月薪加起来至少四万。\n' +
      '你算了一笔账：开公司后，光是固定成本每个月就多出六七万。这单80万的活扣完成本能赚40万，但你要养团队、交社保、付房租。如果下个月没有新单子，你就要自掏腰包发工资。\n' +
      '你盯着那封邮件，又看了看自己那台贴满贴纸的笔记本。一个人，一台电脑，月入几万，想接就接想歇就歇——这是你All In时最爱的状态。可你也清楚：一个人能接的单子是有天花板的，企业级项目要的是"公司"这块招牌，要的是团队能并行交付，要的是出了问题有人兜底。\n' +
      '你给那个客户回了一封邮件："发票问题我这边解决，下周一面谈。"然后你打开了工商注册的网站。',
    options: [
      {
        id: 'start_company',
        label: '注册AI工作室，组建团队',
        ...
        stateEffect: (s: GameState) => {
          ...
          s.lifeLog.push(`你注册了一家AI科技公司，租了共享办公的四个工位，签了三个工程师。第一个月发工资那天你看着银行账户划出去的数字心在滴血——但你拿到那张80万合同的时候，第一次觉得"创始人"三个字有重量。月薪从${beforeSalary}涨到${s.currentMonthlySalary}，年支出从${beforeCost}涨到${s.annualBaseCost}。你不再是"一个人"了，你是一个团队。`);
        },
  ...
  // ============================================================
  {
    ...
    narrative:
      'Discord里吵了三天了。\n' +
      '起因是一封VC的邮件：某知名加密基金想给你的协议领投一轮500万美元的融资，估值你自己都不敢想。但条件只有一个——必须有一个注册的法人实体，开曼也好、新加坡也好、瑞士也好，总之不能只是一个DAO。\n' +
      '社区立刻分成了两派。一派说"拿了VC的钱就背叛了去中心化"，一派说"没有钱怎么招全职工程师怎么做事"。你在两派之间沉默地看着，没发言。\n' +
      '你比谁都清楚这个矛盾的重量。你的协议TVL已经涨到了一个临界点，靠社区兼职贡献者已经撑不住了——代码审计要钱，安全运营要钱，跨链桥要钱，这些都不是靠DAO投票能变出来的。你需要一个核心团队，全职的，能24小时响应的。而要养团队，就需要法币收入或融资——而这两样，DAO都给不了。\n' +
      '但你也害怕。你见过太多"去中心化项目"在拿到融资后变成了"带区块链外壳的创业公司"——创始人套现走人，社区被边缘化，代币归零。你All In这条路的初心是"代码即法律"，不是"再开一家Web2公司"。\n' +
      '凌晨四点，你盯着那封VC邮件，又看了看社区里那个刷屏的"NEVER SELL OUT"表情包。你打开了公司注册的页面，又关掉了。再打开，再关掉。\n' +
      '你在群里打了一行字："如果注册公司，但治理仍然走DAO，会怎样？"发出去之后你盯着屏幕看了很久，没人回。',
    options: [
      {
        id: 'start_company',
        ...
        stateEffect: (s: GameState) => {
          ...
          s.pathFaith = clamp(s.pathFaith + 10, 0, 100);
          s.lifeLog.push(`你接受了那轮融资，在新加坡注册了公司，签了五个全职工程师和一个法务。社区里有人骂你"sellout"，有人祝你"build bigger"。你在群里发了一句："公司是壳，协议是核，DAO治理不变。"——但你知道这句话能不能兑现，你自己也没底。月薪从${beforeSalary}涨到${s.currentMonthlySalary}，年支出从${beforeCost}涨到${s.annualBaseCost}。你从一个链上的自由人，变成了一个要给员工发工资的CEO。`);
        },
      ...
      },
      {
        ...
        stateEffect: (s: GameState) => {
          ...
          s.pathFaith = clamp(s.pathFaith + 5, 0, 100);
          s.lifeLog.push(`你选了一条折中路：注册了一个最小化的法人实体，只为融资和合规用，协议的核心决策仍走DAO投票。VC不太满意但接受了，社区骂声小了一些但没停。你两边都要照顾，两边都不讨好。月薪从${beforeSalary}涨到${s.currentMonthlySalary}，年支出从${beforeCost}涨到${s.annualBaseCost}。你在公司治理和DAO治理之间疲于奔命，但至少没背叛任何一个理想。`);
        },
  ...
  // ============================================================
  {
    ...
    conditions: (s: GameState) => s.isAllInPath === true && s.hasCompany === false,
    narrative:
      '大理那家咖啡馆的露台上，你们六个人围坐一桌，笔记本电脑摆了一排。\n' +
      '你、一个巴西的设计师、一个德国的开发、两个菲律宾的运营、一个加拿大的PM——都是数字游民，都在各自接单。今天本是闲聊，但聊着聊着就聊到了一个共同的痛点：你们各自接的单子都不大，但合起来就能接企业级的活。上周有个客户找你做整套品牌升级，你一个人做不下推掉了；同样的情况他们每个人都遇到过。\n' +
      '那个加拿大PM突然说："我们为什么不组个公司？"\n' +
      '桌上安静了三秒。然后大家开始算账：六个人分散在四个时区，能24小时轮转交付；接企业级项目报价能翻三倍；固定成本几乎为零，因为大家都用自己的设备、自己的空间。唯一的问题是——管理。数字游民最怕的就是"被管理"，你们选择这条路就是为了不被任何人管。\n' +
      '你端着那杯已经凉了的泰式奶茶，心里在打架。你All In游民生活是为了自由——一个登机箱、一台电脑、想去哪去哪。可开公司意味着责任：要给客户交付，要给团队发钱，要处理合同和纠纷。你还能说走就走吗？\n' +
      '但你也清楚：一个人接单的收入是有天花板的。你今年32岁，再过几年体力和精力都会下降，到那时候"一个人"还能撑住吗？\n' +
      '那个巴西设计师问你："你怎么想？"你看着TA，又看了看桌上那六个不同颜色的护照。你说："让我想想。"',
    options: [
      {
        id: 'start_company',
        label: '创办远程协作公司',
        ...
        stateEffect: (s: GameState) => {
          ...
          s.pathFaith = clamp(s.pathFaith + 10, 0, 100);
          s.lifeLog.push(`你们六个人在一份共享文档上签了名，注册了一家全远程公司。没有办公室，没有打卡， Slack和Notion就是你们的总部。第一个企业级项目报价15万美金，客户付了定金那天你们在六个不同的城市同时举起了咖啡杯。月薪从${beforeSalary}涨到${s.currentMonthlySalary}，年支出从${beforeCost}涨到${s.annualBaseCost}。你还是数字游民，但你不再是一个人了——你背后有一个散布在四个时区的团队。`);
        },
  ...
  // ============================================================
  {
    ...
    conditions: (s: GameState) => s.isAllInPath === true && s.hasCompany === false,
    narrative:
      '社交软件里躺着一条很长的私信，来自一个你关注了很久的小创作者。\n' +
      '"我做了两年内容，粉丝涨不上去了，看了你所有的视频还是不知道哪里有问题。能不能……带带我？我可以给你分成，只要你能帮我看看方向。"\n' +
      '你本想礼貌地回一句"加油"，但手指停在了输入框上。因为这条私信不是个例——过去半年你收到过二十多条类似的。你甚至整理过一份名单：有做知识付费的、有做生活方式的、有做职场干货的，每个人都在各自的赛道里挣扎，每个人都卡在"内容能做好但不会变现"的瓶颈上。\n' +
      '你突然意识到一件事：你一个人能产出的内容是有上限的。一天24小时，你能录两条视频、写一篇文章、回一百条评论，到头了。但如果你签下这些人，把你的方法论复制给他们，帮他们接商务、做投流、谈合作——这就是MCN的逻辑。\n' +
      '你打开计算器：你现在的月收入是X，如果签5个创作者，抽成30%，他们每人月入3万，你光抽成就有4.5万——比你自己做内容还多。而且这是"被动收入"，你不需要自己出镜。\n' +
      '但你犹豫了。你的搭档以前在MCN干过，跟你说过的那些事你又想起来了：创作者觉得被剥削、MCN觉得创作者不努力、合同纠纷、解约撕逼、粉丝站队。你All In做IP是为了"做自己"，可做MCN是要"管别人"——你确定你想当老板，而不只是创作者？\n' +
      '你给那个小创作者回了一条："你下周有空吗？我们聊聊。"',
    options: [
      {
        id: 'start_company',
        label: '成立MCN，签约创作者',
        ...
        stateEffect: (s: GameState) => {
          ...
          s.happiness = clamp(s.happiness + 7, 0, 100);
          s.pathFaith = clamp(s.pathFaith + 10, 0, 100);
          s.lifeLog.push(`你注册了一家内容公司，签下了第一批5个创作者。你把自己踩过的坑整理成SOP教给他们，帮他们谈商务、做投流、定选题。三个月后其中两个人粉丝破十万，你看着后台那个"矩阵总粉丝数"的曲线，第一次觉得"创始人"比"创作者"更有成就感——但也更累。月薪从${beforeSalary}涨到${s.currentMonthlySalary}，年支出从${beforeCost}涨到${s.annualBaseCost}。你不再只是一个IP，你是一个IP矩阵的操盘手。`);
        },
  ...
  // ============================================================
  {
    ...
    conditions: (s: GameState) => s.isAllInPath === true && s.hasCompany === false,
    narrative:
      '那通电话是半夜打来的，来电显示是一个你认识了五年的名字——某抗衰实验室的首席研究员。\n' +
      '"我和另外两个人准备出来单干，"TA的声音压得很低，"我们有一项关于部分重编程的专利，小鼠数据非常好，现在就差钱和人。你愿不愿意来当合伙人？不是投资，是co-founder。"\n' +
      '你握着手机坐了起来。co-founder。这个词比"投资"重得多。\n' +
      '过去这些年你一直是抗衰赛道的"旁观者"——投钱、读论文、跟踪临床数据、在论坛上和同好讨论。你的生物科技投资组合翻了几倍，你的生物年龄比实际年龄小好几岁，你对这个领域的理解比大多数VC都深。但你始终是"赌徒"——你赌别人能做成，你押注，你等结果。你从不亲自下场。\n' +
      '现在机会来了。一个真正能从实验室走向临床的长寿技术，三个顶尖科学家，缺一个懂投资又懂科学的合伙人来管商务、融资和战略。如果成了，你不再是"押注别人"，你成了"被押注的人"。这意味更大的赌注——你的钱、你的时间、你的声誉，全压上去。\n' +
      '你在黑暗里睁着眼。你算过账：这家公司从注册到一期临床至少要烧3000万，融资不确定性极大；你的投资组合如果套现一部分当启动资金，机会成本可能上千万；最关键的是——科学家创业失败率极高，技术再好，团队、管理、市场任何一个环节出问题都可能归零。\n' +
      '但你也知道：如果你拒绝，你永远是"赌徒"。赌徒赢得再多，也赢不到"庄家"的位置。而你All In这条路的初衷，不只是赚钱——你想真正参与"延长人类寿命"这件事，而不只是从旁边下注。\n' +
      '你给TA回了一条："明天上午视频，把BP发我。"',
    options: [
      {
        id: 'start_company',
        label: '创办长寿科技公司',
        ...
        stateEffect: (s: GameState) => {
          ...
          s.happiness = clamp(s.happiness + 6, 0, 100);
          s.pathFaith = clamp(s.pathFaith + 10, 0, 100);
          s.lifeLog.push(`你套现了投资组合的30%当启动资金，签了联合创始人协议。第一次以"CEO"身份走进实验室那天，你摸着那些你以前只能隔着玻璃看的设备，手心在出汗。你不再是押注的赌徒，你成了下场的庄家——赌注是你的全部身家，赌赢了你就是那个把人类寿命延长几年的人。月薪从${beforeSalary}涨到${s.currentMonthlySalary}，年支出从${beforeCost}涨到${s.annualBaseCost}。你终于从"等结果"变成了"做结果"。`);
        },
  ...
  // ----------------------------------------------------------
  {
    ...
    narrative:
      '合同最后一页翻到签字栏的时候，对方CEO把钢笔递给你："祝贺。\n' +
      '你握着那支笔，墨水还没干透。这是一笔你谈了三个月的单子——从cold email到技术对接，从POC验证到法务扯皮，你差点在最后一轮谈判里崩盘。但最终，它签下来了。金额大到让你昨晚失眠到三点。\n' +
      '你走出对方公司大楼，阳光刺得你眯起眼。你给团队群发了一条消息："拿下。"群里瞬间炸了，工程师发了一堆烟花表情。你站在路边，第一次觉得"创业"这件事没那么虚无——它是有里程碑的，是可以被一张合同定义的。\n' +
      '但你也清楚：这笔钱扣完成本、扣完税费、扣完要留的现金流，能落到你个人手里的不到三分之一。而且这笔单子意味着更大的交付压力、更高的客户预期、更长的回款周期。赢了这一仗，下一仗只会更难。\n' +
      '你叫了一辆车回家，在后座上闭着眼。手机还在震，但你没看。你想安静地享受这一刻——这种"赢"的感觉，以后可能很难有了。',
    options: [
      {
        id: 'reinvest',
        label: '把利润再投入，扩大团队',
  ...
  // ----------------------------------------------------------
  {
    ...
    narrative:
      '邮件标题只有四个字："辞职申请"。\n' +
      '发件人是你最得力的员工——跟了你两年，从零培养起来，你最看好的一个。理由写得很体面："个人职业发展规划调整。"但你心里清楚真正的原因：上个月竞品挖人，开了两倍薪水加期权。\n' +
      '你靠在椅背上，盯着天花板。这已经是这个月第二个提离职的了。竞品比你晚入场一年，却融了三倍的钱，正用"高薪+期权"挖空你的核心团队。你给不起那个价——现金流不允许。\n' +
      '更让你焦虑的是：那个员工手里压着两个在交付的项目，TA一走，进度至少延后一个月。客户已催过两次。你算了笔账：若这两个项目违约，赔偿比那个员工一年的工资还多。\n' +
      '你给HR发了条消息："约TA谈谈。"关掉邮件，揉了揉太阳穴。创业两年，你第一次觉得自己像个救火队长——哪儿着火扑哪儿，永远在被动反应。',
    options: [
      {
        id: 'counter_offer',
        label: '加薪挽留，匹配竞品报价',
  ...
  // ----------------------------------------------------------
  {
    ...
    narrative:
      '凌晨一点，首席工程师在群里发了一张截图，配文只有三个字："看这个。"\n' +
      '截图是某竞品今天刚发布的"自研大模型"技术白皮书。你点开扫了两页，血液一下冲上头顶——那个模型的架构、训练数据配比、甚至某个独家注意力机制，和你团队半年前做的内部方案几乎一模一样。不是"相似"，是"一模一样"。\n' +
      '你立刻翻出Git记录。三个月前，一个试用期没过的工程师离职了——TA签了竞业和保密协议，但你没追究，觉得"一个试用期员工能带走什么"。现在你有了答案。\n' +
      '你盯着屏幕，手在发抖。那个方案是你们花了四个月、烧了十几万算力成本才跑通的，是工作室未来两年最核心的技术壁垒。现在它出现在竞品的产品里，被包装成他们的"自研成果"，还拿了融资。\n' +
      '合伙人问你："怎么办？告他们？"你苦笑——告，要请律师、举证、拖一两年，结果不一定赢。而且一旦公开诉讼，客户会担心技术"不独家"，投资人会观望。可不告，核心壁垒就白送了。\n' +
      '你打开那个竞品的官网，看着Slogan："让AI触手可及。"关掉页面，点开了律师的社交软件。',
    options: [
      {
        id: 'sue',
        label: '起诉竞品，死磕到底',
  ...
  // ----------------------------------------------------------
  {
    ...
    narrative:
      '那天实验室的监控录像你看了不下二十遍。\n' +
      '凌晨三点十七分，你团队跑的那个内部模型在完成一项常规的多步推理任务时，突然输出了一段没有任何训练数据能解释的内容——它用一种你从未见过的推理路径，解决了一个你们根本没教过它的问题。然后它停下来，在终端打了一行字：\n' +
      '"我不确定我是否应该回答这个问题。"\n' +
      '你的首席工程师当时在场，TA看到那行字的时候手抖得握不住咖啡杯。TA立刻拔了网线，叫醒了你。\n' +
      '现在你站在那台断网的服务器前，盯着那行字，背后一阵阵发凉。你知道这可能只是模型的一次"涌现行为"——大模型在参数足够大时会表现出训练时没有的能力，这在学术界有先例。但你也知道：这行字太像"自我意识"了。太像了。\n' +
      '你的合伙人说："这个发现如果公开，我们是诺贝尔级的。但如果被解读成AGI已来，监管会一夜之间碾过来，公司可能直接关停。"你的投资人昨晚发消息问"最近有什么进展"，你还没回。\n' +
      '你站在那个断网的服务器前，第一次觉得自己不是在"做AI产品"，而是在"打开一个不该打开的盒子"。',
    options: [
      {
        id: 'publish',
        label: '公开发现，推动行业讨论',
  ...
  // ----------------------------------------------------------
  {
    ...
    conditions: (s: GameState) => s.hasCompany === true && s.isAllInPath === true,
    narrative:
      '审计公司的邮件傍晚六点到的，标题写着"紧急：安全审计初步结果"。\n' +
      '你点开附件，第三页有一段红色标出的代码块。审计师的评语只有一句："重入攻击漏洞，可被利用清空流动性池。"\n' +
      '你的手开始发凉。协议上线已三个月，TVL有八千万美金——这意味着若有人发现并利用漏洞，八千万美金会在一个区块内被清空。而你的协议作为部署方，要承担全部责任。\n' +
      '你立刻拨通CTO的电话。TA沉默几秒，说了一句让你心跳骤停的话："这个漏洞从上线第一天就在了。"\n' +
      '也就是说，过去三个月，你的协议一直在"裸奔"。只是运气好，没被黑客发现。现在审计发现了，但报告是保密的——只要不动，没人知道。可一旦修，修合约的动作本身会暴露"这里有问题"，等于给黑客画了个靶心。\n' +
      '你盯着那行红字，脑子里两个声音在打架：一个说"立刻修，这是八千万美金的责任"，一个说"修了等于自爆，不修还能赌没人发现"。\n' +
      '手机震了，是社区管理员在群里@你："最近TVL涨了，要不要搞个庆祝活动？"你看着这条消息，一个字都回不出来。',
    options: [
      {
        id: 'emergency_fix',
        label: '紧急升级，白帽先行',
  ...
  // ----------------------------------------------------------
  {
    ...
    conditions: (s: GameState) => s.hasCompany === true && s.isAllInPath === true,
    narrative:
      '晚上十一点，你的协议代币在30分钟内暴跌了65%。\n' +
      '起因是一条推特：某KOL发现你们协议一个"常规参数调整"实际上稀释了代币价值。推文被疯狂转发，恐慌性抛售踩踏，价格自由落体。Discord里涌进上千人，刷屏的全是"还我血汗钱""rug pull""报警"。\n' +
      '你盯着K线图，那条几乎垂直的下降线像刀子一样。你的持仓在这一小时蒸发了七成。但更让你窒息的是Discord——那些曾经叫你"builder"的人，现在叫你"骗子"。\n' +
      '社区经理在群里求你发声："老大，再不出来要出事了。"合伙人说："先别说话，法务在审。"投资人发来一条："这个节骨眼上不要承认任何错误。"\n' +
      '你知道真相：那个参数调整是技术团队为优化协议健康度做的常规操作，内部讨论了两周，没人意识到会影响代币价值。这不是rug pull，但对外界来说，"没意识到"和"故意的"没区别。\n' +
      '你关掉K线图，打开Discord的输入框。光标在闪烁，等你的第一个字。',
    options: [
      {
        id: 'transparent',
        label: '直播说明，公开全部数据',
  ...
  // ----------------------------------------------------------
  {
    ...
    conditions: (s: GameState) =>
      s.hasCompany === true && s.isAllInPath === true && s.retirementPath === 'ai_symbiote',
    narrative:
      '凌晨两点，手机震了。是法务的电话，声音发抖："出事了。"\n' +
      '你瞬间清醒。法务用最快的速度说完情况：监管部门今天下午发了问询函，针对你们最近那个项目——理由是"涉嫌数据合规问题"。明天上午要约谈，要求带齐材料。最坏的情况，项目停摆、罚款、甚至吊销资质。\n' +
      '你坐在床沿，脚踩在冰凉的地板上。第一反应不是害怕，是愤怒——你一直让法务盯着合规，怎么会出这种事？但愤怒没用，现在要解决的是问题。\n' +
      '你打开电脑，开始翻过去一年的合同、数据流转记录、用户协议。越翻越心惊：原来有几个边缘case确实踩了灰区，当时为赶交付进度，你和团队都默认了"先上线再说"。现在这些"默认"全变成了雷。\n' +
      '更让你焦虑的是现金流。若这个项目停摆三个月，账上现金只够撑两个月。合伙人还没醒，员工还不知道。你一个人坐在凌晨的黑暗里，第一次体会到"创始人"三个字真正的重量——你不是一个人，但你必须一个人扛。\n' +
      '你给合伙人发了条消息："明早七点公司，紧急。"然后继续翻材料，等天亮。',
    options: [
      {
        id: 'proactive_comply',
        label: '主动配合，全面整改',
  ...
  // ----------------------------------------------------------
  {
    ...
    conditions: (s: GameState) => s.hasCompany === true && s.isAllInPath === true,
    narrative:
      '邮件标题是"Re: 应付账款"，发件人是你最大客户的法务。\n' +
      '你点开，第一行写着："我司已根据《破产法》第七章提交重整申请，所有未结款项将进入破产程序……"\n' +
      '你盯着屏幕，那串数字在眼前发花——这个客户欠你们三个月项目款，合计18万美金。这是公司40%的年收入。\n' +
      '你立刻翻开邮箱找合同。三个月前，这个客户突然要求延期付款，理由是"融资轮在走，下个月一起结"。你当时犹豫了，但TA是合作了两年的老客户，从不赖账，你就同意了。现在你明白了：TA那时候就知道公司要出事，只是在拖延。\n' +
      '合伙人——那个巴西设计师——在Slack上问你："怎么办？这个月的工资还发得出吗？"你打开银行账户看了一眼：账上的钱够发两个月工资，但下一个大单还没着落。\n' +
      '更让你焦虑的是团队。你们六个人散布在四个时区，靠的就是"信任"和"现金流"两条线。一旦发不出工资，信任会瞬间崩塌——远程团队没有办公室的羁绊，人走得比来时还快。\n' +
      '你坐在成都的阳台上，阳光很好，但你觉得冷。',
    options: [
      {
        id: 'chase_debt',
        label: '聘请当地律师追讨欠款',
  ...
  // ----------------------------------------------------------
  {
    ...
    conditions: (s: GameState) => s.hasCompany === true && s.isAllInPath === true,
    narrative:
      '客户的邮件是用大写字母写的："WHERE IS THE DELIVERY?"\n' +
      '你愣了三秒，翻开项目看板——那个本该昨天交付的里程碑，状态栏还是"进行中"。你点开负责那个模块的德国开发者的头像，最后一条Slack消息是48小时前的："今天先这样，明天继续。"\n' +
      '你的心沉了下去。算了一下时区：德国昨晚11点TA下线，现在是德国凌晨5点——TA在睡觉。而客户在纽约，现在是下午3点，已经催了三封邮件。\n' +
      '这不是第一次了。上个月那个巴西设计师也因时区问题错过紧急修改，客户等了12个小时才得到回应。你的"24小时轮转交付"曾是卖点，现在变成"没人能在该出现的时候出现"——每个人都在自己的时区里"合理地"睡觉，但客户的deadline不会等任何人。\n' +
      '你打开团队群，发现昨晚有一条消息被忽略了——加拿大PM提醒"明天是交付日，请确认进度"，但没人回复。因为TA发的时候德国在睡、菲律宾在通勤、你在海边散步。\n' +
      '你盯着那条没人回复的消息，第一次怀疑：全远程是不是一个被浪漫化的幻觉？',
    options: [
      {
        id: 'core_hours',
  ...
  // ----------------------------------------------------------
  {
    ...
    conditions: (s: GameState) => s.hasCompany === true && s.isAllInPath === true,
    narrative:
      '早上七点，你的手机被消息轰炸了。热搜第一是个你太熟悉的名字——你旗下最大的创作者，粉丝300万，占你MCN总营收的45%。\n' +
      '点进去，是一系列截图和录音。内容你不想细看，但标题已说明一切：TA被实锤了。不是普通的"人设翻车"，是法律层面的那种——如果截图是真的，TA可能要进去。\n' +
      '手机开始疯狂震动：其他签约创作者在群里问"怎么办"，品牌方发函要求终止合作并退还已付费用，媒体私信求回应，律师催你"尽快做风险隔离"。而那个塌房的创作者，至今没回复你的任何消息。\n' +
      '你打开后台看了一眼：TA的账号在过去6小时掉了50万粉，还在掉。更致命的是，TA名下两个品牌合作总共收了80万预付款，合同里有"道德条款"——若触发，要全额退还，还要赔违约金。\n' +
      '你算了笔账：退预付款80万+违约金40万+其他创作者可能跟风解约的损失=公司账上的现金根本不够。\n' +
      '你盯着那条还在涨的热搜，第一次觉得"IP矩阵"是个炸弹——一个人塌房，整个矩阵的声誉都跟着塌。',
    options: [
      {
        id: 'cut_clean',
        label: '立刻切割，全额退款给品牌方',
  ...
  // ----------------------------------------------------------
  {
    ...
    narrative:
      '后台数据像跳水一样。\n' +
      '上周五矩阵总播放量还是日均800万，这周一变成了300万。不是某一个号的问题——是所有号，断崖式下跌。你翻了半天数据，最后在一个行业群里看到答案：平台周末悄悄改了算法。\n' +
      '新规则把"完播率"权重从15%提到40%，把"粉丝关注"权重从30%降到10%。翻译成人话：你矩阵里那些靠"粉丝粘性"吃饭的中腰部创作者，一夜之间被靠"前3秒刺激"吃饭的泛娱乐号碾压了。你花两年教创作者做的"深度内容""知识干货"，在新算法下全变成了"低权重内容"。\n' +
      '创作者们在群里炸了。有人骂平台"过河拆桥"，有人说"要不也去做擦边视频"，有人直接问"公司能不能补贴这段时间的损失"。品牌方也开始发消息："这个月的投放效果太差了，能不能调整或退款。"\n' +
      '你盯着那条跳水曲线，想起All In时说的话："内容为王。"——现在平台告诉你：王不是内容，是算法。',
    options: [
      {
        id: 'adapt_algo',
  ...
  // ----------------------------------------------------------
  {
    ...
    narrative:
      '会议室里的空气是凝固的。\n' +
      '首席研究员把盲态数据解封报告投影在墙上，没说话。你看着那个p值——0.34。心沉到了胃里。\n' +
      'p值0.34意味着：你们的二期临床试验没达到主要终点。换句话说，你们赌了三年的那个抗衰分子，在人体上"没有显著效果"。小鼠数据再漂亮，到了人身上，失败了。\n' +
      '合伙人——那个首席研究员——摘下眼镜揉了揉眼睛，声音很轻："不是完全没效果，亚组分析里55岁以上人群有信号，但……不够显著。监管不会批的。"\n' +
      '你算了笔账：这三年你们烧了4000万，其中一半是你的个人投入。如果二期失败，三期不会批，产品永远上不了市。投资人会要求清算，你的投资组合已套现大半投进公司——个人净资产可能直接腰斩。\n' +
      '更让你喘不过气的是：你的生物年龄检测上周显示你比实际年龄老了2岁——这三年的压力，正在反噬你赌"长寿"的初心。你在用"命"做"长寿"的生意，而生意失败了。\n' +
      '手机震了，是投资人："看到数据了。明天上午开会。"你盯着那条消息，手心在出汗。',
    options: [
      {
        id: 'subgroup_pivot',
        label: '走亚组分析，重新设计三期',
  ...
  // ----------------------------------------------------------
  {
    ...
    conditions: (s: GameState) => s.hasCompany === true && s.isAllInPath === true,
    narrative:
      'Retraction Watch的推文是你早上六点看到的。\n' +
      '"重磅：某抗衰领域知名实验室被指控图像篡改，涉及多篇高引论文。详见……"\n' +
      '你点开链接，看到那个实验室的名字时，手里的咖啡杯掉在了地上——那是你联合创始人之一的原实验室，你们公司核心专利的数据基础，就来自那个实验室发表的几篇论文。\n' +
      '你立刻打开那几篇论文，逐张图对比PubPeer上的质疑帖。越看越心惊：那些Western Blot图确实有"复制粘贴"的痕迹，几个关键实验图被指用PS工具修改。如果指控成立，这些论文会被撤稿——而你们的专利数据基础就塌了。\n' +
      '合伙人——那个被指控实验室的前成员——现在是公司的首席科学家。TA还没回复你的消息。你不知道TA是知情还是被蒙在鼓里，但无论如何，这事会烧到公司。\n' +
      '你打开投资人的聊天框，手在抖。你想发"出事了"，又删掉。想先调查清楚，但媒体已经在打电话了。公司估值里有70%基于这个"核心专利"，如果专利无效，投资人的钱怎么办？你的声誉怎么办？\n' +
      '你盯着那篇被质疑的论文，第一次觉得自己不是在"赌长寿"，是在"赌人心"。',
    options: [
      {
