...
const allInEvents: NarrativeEvent[] = [
  ...
  // ============================================================
  {
    ...
    narrative:
      '你{age}岁了。AI副业收入是主业工资的三倍，带三个徒弟、十几个客户，开源项目star过千——但你还在上班。新来的主管比你小五岁，说的那套"AI赋能"全是你三年前玩剩下的。你妈问"什么时候升职"，你说"快了"——你没说的是，你根本不想升。\n' +
      '晚上你翻到《35岁还在写代码的人都去哪了》，关掉页面，打开了第四次开口的辞职信文档。你忽然意识到：你不是在等更好的时机，你是在害怕离开公司的名头之后就什么都不是。可如果这次还不跳，以后就真的跳不动了。',
    options: [
      {
        id: 'all_in_now',
        label: '这次真的走——辞职',
        description: '不再等了。{age}岁了，等不起下一个五年了。',
...

  {
    ...
    conditions: (s: GameState) => s.isAllInPath === false && s.pathFaith >= 25,
    narrative:
      '你{age}岁了。链上资产经历过两次牛熊，够付首付了——但你还在上班。午休看K线被实习生撞见，他问"哥你也炒币啊"，你说"玩玩"。他不知道你的仓位比他见过的所有钱都多。\n' +
...

  {
    ...
    conditions: (s: GameState) => s.isAllInPath === false && s.pathFaith >= 25,
    narrative:
      '你{age}岁了。远程客户稳定在5-6个，美元收入换算成人民币是工资的两倍，护照上已经攒了三本盖章的戳。你妈发社交软件说"隔壁小王二胎都生了，你什么时候稳定下来"，你回"快了"，然后打开机票网站——清迈飞曼谷120块，曼谷飞里斯本2300块。\n' +
...

  {
    ...
    conditions: (s: GameState) => s.isAllInPath === false && s.pathFaith >= 25,
    narrative:
      '你{age}岁了。粉丝二十万，月收入稳定在三万以上——是你工资的三倍，但你还在上班。同事都刷到过你的视频，却没人知道那是你：你用了网名、戴了帽子，从不在视频里露工位。\n' +
...

  {
    ...
    conditions: (s: GameState) => s.isAllInPath === false && s.pathFaith >= 25,
    narrative:
      '你{age}岁了。兼职运营的养老点已服务80多个老人、雇了3个员工、月流水五万多，但你还在上班。民政局找你谈想做大连锁，需要全职投入还要投钱扩建，你说"我考虑考虑"。\n' +
...

  {
    ...
    conditions: (s: GameState) => s.isAllInPath === false && s.pathFaith >= 25,
    narrative:
      '你{age}岁了。生物科技投资组合翻了六倍，你的抗衰方案让生理年龄指标比同龄人好8-10岁，但你还在上班。公司体检让医生惊讶，他问"怎么保养的"，你说"睡觉运动"——没说每天吃12粒补剂、每月抽血测生物标志物、晚上泡冰水浴。\n' +
