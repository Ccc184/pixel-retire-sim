...
const commonEvents: NarrativeEvent[] = [
  ...
  // 22岁：第一份远程合同（副业起步）
  {
    ...
    eventType: 'normal',
    narrative:
      '2026年，你在Upwork上投了六十多份提案，终于有个客户回复了——一个深圳创业公司，要你搭个多语言官网，时薪180块。面试时对方问你熟不熟AI工具，你说AI编程器、v0、通用大模型都行，对方眼睛一亮："那效率应该很快。"\n' +
      '你没辞职——客户太少，没缓冲金，没有长期合同。但这180块一小时，就是你未来的入场券。只剩下一个问题：白天上班已经够累了，剩下的时间，你打算怎么分？',
    options: [
      {
        id: 'night_owl',
        label: '熬夜接单，白天上班晚上干活',
        ...
        log: '{startAge}岁，你开始了双线作战。白天在公司写代码，晚上回家打开Upwork接海外单。你的生物钟被劈成两半：白天用中文开会，晚上用英文谈需求。凌晨三点对着英文文档查单词的时候，你偶尔会想：这种日子能撑多久？但每次看到美元到账的数字，你又觉得值了。',
      },
      {
        id: 'weekend_warrior',
        ...
        log: '{startAge}岁，你没选择熬夜——你知道身体是革命的本钱。你把周六周日全部留给远程工作，工作日认真上班养精蓄锐。同事约你周末出去玩，你说"有事"。他们不知道你的"事"是在给硅谷的小公司做网站，赚他们一个月的工资。进度慢了点，但你活得久。',
      },
      {
        id: 'find_community',
        label: '先混进游民社群，找人带路',
        ...
        log: '{startAge}岁，你在游民群里问了一句"新人怎么开始接海外单"，收到了几十条回复。有人发来了整份"Upwork接单攻略"，有人分享了自己第一个客户的故事，有人约你以后面基喝杯咖啡聊聊经验。你第一次发现：游民圈子比你想的更抱团——因为每个人都知道"从零开始"是什么滋味。',
      },
    ],
  },
  ...
  // 23岁：副业与主业的冲突（副业阶段）
  {
    ...
    eventType: 'normal',
    narrative:
      '你已经连续三个月白天上班、晚上接单了。白天用公司电脑写CRUD，晚上回家打开AI编程器，让AI把海外客户的活儿干完——以前要熬通宵的量，现在两三个小时就交差。Upwork评分从零涨到五星，客户从一家变三家。代价是：你瘦了八斤，黑眼圈重得遮瑕都盖不住，开会时坐着睡着了，被组长叫到走廊训了一顿。\n' +
      '现在又有一个新客户来问长期项目。你盯着那条消息，心里在算账：接了，副业收入正式超过主业；不接，你就能多睡两个小时。',
    options: [
      {
        ...
        log: '{age}岁，你接下了那个长期项目。从此你的生活变成了：早上9点打卡上班，下午6点下班，7点回家打开AI编程器开始给海外客户干活，AI把开发效率拉满，凌晨2点睡觉。你妈打电话问你"最近怎么样"，你说"挺好的"——你不敢说你好几个月没在凌晨前睡过了。但月底你看了一眼副业收入：28000，已经超过主业了。你攥着手机，觉得这些失眠都值了。',
      },
      {
        id: 'pace_yourself',
        label: '稳住节奏，不接新单先保身体',
        ...
        log: '{age}岁，你忍住了接新单的冲动。你把现有的三个客户维护好，不再熬夜，改用早起赶工——早上5点起床，用AI编程器和v0干两小时再上班，AI工具让效率比去年翻了一倍。同事问你"怎么最近精神好了"，你笑了笑没回答。你知道慢一点没关系，关键是能走得远。',
      },
      {
        ...
        log: '{age}岁，你鼓起勇气找组长谈了弹性工作制。你说"我家离公司远，每周想远程两天"。组长犹豫了一下同意了——因为你的绩效一直不错，AI工具帮你把分内活儿提前干完了，他也没话说。从此每周有两天你在家办公，省下的三小时通勤全部用来接单——Upwork上接海外，电鸭社区上接国内。多出来的时间让你接了一个加急小单，到账3000块。你发现"争取自由"不是一次性的壮举，而是一寸一寸往前挪的过程。',
      },
    ],
  },
  ...
  // 23-24岁：文化冲击与语言困境
  {
    ...
    narrative:
      '你以为英语够用就够了，直到你在清迈移民局续签，柜台后的官员连珠炮一样说着泰语，你全程听不懂，只能陪着笑把护照递进去。办完翻开护照才发现——他给你盖的不是你申请的那种签证，但你想回去理论，又开不了口。\n' +
      '类似的挫败每天都在发生：房东发来一长串泰语语音你只听懂一半，夜市卖芒果糯米饭的阿姨一口一个"farang"（老外）叫你。你站在街角，第一次真正理解了一件事：语言不只是工具，它是一张入场券。没有它，你永远是这座城市的"客人"，而不是"参与者"。',
    options: [
      {
        ...
        log: '{age}岁，你能用泰语点菜、砍价、跟双条车师傅讨价还价了。卖芒果糯米饭的阿姨终于不再叫你"farang"，而是叫你的小名。你第一次觉得自己"属于"这条街——哪怕只是一点点。',
      ...
      },
      {
        ...
        log: '{age}岁，你的英语从"磕巴但能沟通"变成了"流利且有感染力"。跨国客户开会你终于不用提前写逐字稿了。你发现：在游民圈，英语水平直接等于时薪天花板。',
      },
      {
        ...
        log: '{age}岁，你不再执着于"融入"。你用英语工作，用AI翻译耳机生活，用旁观者的眼光看这个世界。你发现自己反而看得更清楚——因为你始终站在文化之外，没有被任何一种规则驯化。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你在电鸭社区和游民社群里找到了一群同样在接海外单的"准游民"，组建了一个"深夜接单党"群，每周三在一家常去的咖啡馆聚一次。来的人换了一茬又一茬，但总有人在。你发现这种孤独不是无解的——只要你愿意先伸出手，永远有另一只手会握住你。',
      ...
      },
      {
        ...
        log: '{age}岁，你把孤独变成了工时。凌晨接单，清晨交活，AI工具帮你把活儿干得又快又好，日历上没有一天是空的。月底看着到账的美元你笑了一下，但关掉手机后那间屋子又空了。你用收入买到了安全感，但买不到一个可以一起吃晚饭的人。',
      },
      {
        id: 'call_home',
        label: '给家里打个电话，哪怕被唠叨',
        ...
        log: '{age}岁，AI助手提醒你"已经三周没联系家人了"，你拨通了家里的电话。妈妈照例问"什么时候回来"，你照例说"快了"。挂掉电话你哭了一场，不是因为难过，是因为你第一次意识到：你说"快了"的时候，自己都不信。但你还是想接着走——因为你害怕的是"回来"，而不是"回不去"。',
      },
    ],
  },
];
...
const branchSelectEvent: NarrativeEvent[] = [

  {
    ...
    narrative:
      ...
      '{age}岁这年，你坐在出租屋里，面前是三条路。窗外是国内城市的霓虹灯，你的屏幕亮着，等你做一个决定——不是决定去哪里，而是决定在这个AI重新洗牌的世界里，你靠什么活下去。',
    options: [
      {
        ...
        memorySet: { choseFreelancer: true, choseEntrepreneur: false, choseConsultant: false },
        stateEffect: (s) => {
          ensureSkills(s);
          s.stress = clamp(s.stress + 5, 0, 100);
          s.pathFaith = clamp(s.pathFaith + 5, 0, 100);
        },
        log: '{age}岁，你选了最"稳"的那条路——把接单做成事业。你开始专注打磨一项AI够不着的核心技能，把零散的活变成系统化的服务。别人在追风口，你在筑地基。你赌的是：当AI把入门级远程工作的门槛压到地板，技能深度就是唯一能让你站着挣钱的东西。',
      },
      {
        ...
        memorySet: { choseFreelancer: false, choseEntrepreneur: true, choseConsultant: false },
        stateEffect: (s) => {
          ensureSkills(s);
          s.stress = clamp(s.stress + 10, 0, 100);
          s.pathFaith = clamp(s.pathFaith + 8, 0, 100);
        ...
        log: '{age}岁，你不再满足于"接单"。你把积蓄砸进了第一个AI原生产品的搭建——服务器、域名、支付网关，全用AI工具生成代码和客服话术。没有老板，也没有客户保底。你赌的是：这个时代，一个人加一台电脑加一堆AI，就能做一个跨国公司。',
      },
      {
        ...
        memorySet: { choseFreelancer: false, choseEntrepreneur: false, choseConsultant: true },
        stateEffect: (s) => {
          ensureSkills(s);
          s.stress = clamp(s.stress + 3, 0, 100);
          s.pathFaith = clamp(s.pathFaith + 6, 0, 100);
        },
        log: '{age}岁，你接了第一单付费咨询——帮一家出海企业做南方市场调研，两小时收了800美元。挂掉电话你愣了半天：AI能翻译合同，但翻译不了"这家公司老板跟当地政府关系好，走这条路更快"——原来你这几年攒下的"人肉跨文化经验"，本身就是一种AI替代不了的产品。你赌的是：文化套利，是AI时代最后的护城河。',
      },
    ],
  },
];
    ...
    options: [
      {
        ...
        log: '{age}岁，你报了一个让自己手抖的价。对方沉默了三秒，说"可以，我们签合同"。挂掉电话你瘫在椅子上，又想笑又想哭——原来不是你不够好，是你一直不敢要。从今天起，你的时薪翻了一倍。',
      },
      {
        id: 'quote_safe',
        label: '报稳妥价，先拿下再说',
        ...
        log: '{age}岁，你报了一个"安全价"，对方秒答应。合同签了你却有点失落——你不知道自己是不是卖便宜了。但这个客户后来成了你的长期金主，连续合作了两年。有时候，"稳"也是一种策略。',
      },
      {
        ...
        log: '{age}岁，你没报工时，而是做了一份"这个网站12个月能帮你们多接多少客户"的测算，然后按收益的10%报价。对方CEO看完说"你比我们市场总监还懂生意"。你拿到了单子，也拿到了一种全新的报价思路——从此你卖的不是时间，是结果。你心里清楚：执行那部分AI迟早能做，但"读懂客户生意"这件事，AI还差得远。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你跟所有客户立了规矩：除非火烧眉毛，否则不打电话，用Loom录屏+Notion文档沟通。新出的AI异步工具帮了大忙——会议纪要自动生成、多语言团队的视频自动翻译字幕，你悉尼客户的澳洲口音再也不用反复回放猜。最初有客户不适应，但一个月后他们发现"不用约时间开会"反而更高效，AI把语言和时差的鸿沟抹平了大半。你终于能睡整觉了，时区不再是枷锁，只是墙上的一个数字。腾出来的整块时间让你多接了一个加急单，到账5000块。',
      },
      {
        ...
        log: '{age}岁，你狠心砍掉了欧洲和澳洲的客户，只留美洲。收入少了一截，但你终于有了固定的"工作时间"——你的晚上是纽约的白天，你成了夜行动物，至少是规律的那种。',
      },
      {
        id: 'embrace_chaos',
        label: '硬扛，用咖啡和褪黑素维持',
        ...
        log: '{age}岁，你用浓缩咖啡和褪黑素把自己焊在了时区的接缝上。多赚了钱，但体检报告上多了几个箭头。某个凌晨四点开完会，你在浴室吐了——不是生病，是身体在抗议。你开始明白：用健康换的自由，不叫自由，叫透支。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你给自己定了个铁律：不管多忙，每天雷打不动花一小时开发新客户。三个月后，"荒月"再也没出现过——因为你永远在漏斗里养着下一批单子。其中一个新客户的第一单结了8000块，你终于明白：自由职业的核心技能不是干活，是"持续地让人知道你能干活"。',
      },
      {
        ...
        log: '{age}岁，你把两个老客户谈成了月费制retainer——每月固定收一笔，负责他们的日常维护。从此你的收入有了"底"，丰荒周期被熨平了一半。你终于敢在闲月里安心看本书，而不是焦虑地刷新邮箱。',
      },
      {
        id: 'save_buffer',
        label: '存够12个月的生活费再说',
        ...
        log: '{age}岁，你在丰月把一半收入锁进了"荒月基金"。生活质量降了一档，但心里踏实了。你跟自己说：自由的前提，是兜里有粮。没有安全感的自由，只是另一种流浪。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你给新客户报了涨50%的价，老客户维持原价。新客户一口答应，老客户那边也没人因为你"涨价"而跑——因为他们根本不知道。半年后你的客户结构自然换血，时薪悄无声息地上了一个台阶。',
      },
      {
        id: 'raise_everyone',
        label: '全员涨价，涨不动的就放手',
        ...
        log: '{age}岁，你给所有客户发了涨价邮件。有两个老客户没续约，你心痛了一周。但新价带来的新客户很快填上了空缺，而且质量更高。你学到一句话：涨价的本质不是多收钱，是筛选出真正认可你价值的人。',
      },
      {
        id: 'package_service',
        ...
        log: '{age}岁，你没涨价，而是把服务做成了三个档位的"套餐包"——基础版、专业版、旗舰版。客户买的不再是"你的时间"，而是"一个解决方案"。基础版里那些AI也能干的活，你干脆明码标价让客户自己用AI跑；真正值钱的是专业版和旗舰版里那套"诊断+策略+落地"的组合拳，AI拆不开、复制不了。客单价翻了倍，客户反而觉得更值。你第一次摸到了"产品化"的甜头——也是第一次摸到"AI啃不动"的甜头。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你花了三个月把客户数从3个拓展到了7个，最大的客户占比降到了25%。累是真累，但月底看着多元化的收入结构，你睡得着觉了。你终于理解了那句话：自由职业的安全感，不在于某个客户多大，在于你能失去任何一个客户都不崩盘。',
      },
      {
        id: 'deepen_anchor',
        ...
        log: '{age}岁，你没分散，反而跟大客户谈成了更深的合作——固定月薪+项目分红。收入涨了，但你心里清楚：你正在从"自由职业"滑向"远程员工"。自由的边界，在悄悄变窄。',
      },
      {
        id: 'build_passive',
        ...
        log: '{age}岁，你把给不同客户重复做的"建站脚手架"做成了一套模板，挂在网上卖订阅。你用AI把模板的生成、适配、文档全自动化了——买家填个表，AI就能吐出八成可用的成品，剩下两成才是他们要自己动手的。第一个月只有3个买家，但这是你第一次拥有了"睡觉时也在赚钱"的收入。被动收入的种子，种下了。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你第一次对一个询盘说了"No, thank you"。对方预算太低，接了只会消耗你的声誉。拒掉的那一刻你有点心疼，但更多的是释然——你终于有底气挑客户了，而不是被客户挑。腾出的产能接了一个高价位优质项目，12000块落袋，你第一次体会到"拒绝也是一种变现"。',
      ...
      },
      {
        ...
        log: '{age}岁，你给每个合作过的客户发了一封"求推荐信"的邮件，收到了十几封热情洋溢的回复。你把它们整理成了作品集页面，挂在个人网站上。从此新客户的转化率翻了倍——别人不再问你"能不能做"，而是问"什么时候能开始"。',
      },
      {
        ...
        log: '{age}岁，你接了一个超出你单人产能的大单，把它分包给了两个游民圈的后辈。你从"干活的"变成了"管活的"，赚了差价，也操了心。好在现在有一堆AI协调工具——自动排期、进度同步、跨时区standup都能让AI代办，你管三个时区的人没比管自己累多少。你隐隐摸到了"小工作室"的雏形——也许有一天，你会从一个自由职业者，变成一个小老板。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你第一次有了"下班后不想工作"的奢侈。你报了葡语课，开始规律健身，周末跟新认识的朋友去冲浪。收入没涨，但生活质感涨了。你发现：自由职业的终极目的，不是为了赚更多，是为了有资格"不赚"。',
      },
      {
        id: 'push_higher',
        label: '趁稳定，冲击更高客单价',
        ...
        log: '{age}岁，你用retainer托底，大胆去谈了一个过去不敢碰的大单——给一家上市公司做年度品牌系统。对方看了你的作品集和retainer客户名单，觉得"这人靠谱"，签了。你的年收入第一次突破了六位数美元。',
      },
      {
        id: 'mentor_others',
        label: '开始带徒弟，把经验传承下去',
        ...
        log: '{age}岁，你收了第一个"徒弟"——一个刚辞职想做游民的年轻人。你把自己踩过的坑、报过的价、谈过的客户全教给了TA。看着TA从磕磕绊绊到独当一面，你有一种奇怪的满足感：原来"被需要"，比"赚钱"更让人踏实。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你招了两个自由职业者，搭起了一个三人的小工作室。第一个月你忙得脚不沾地——不是做活，是教人、排期、对齐标准。但第三个月，你终于把那些曾被推掉的单子接了回来。你不再是"一个人"，你成了"老板"。这个身份有点重，但你扛住了。',
      },
      {
        ...
        log: '{age}岁，你把报价又涨了三成，单子少了，但每个都更值钱。你拒绝了前同事的提议，选择继续一个人。自由比规模重要——至少对现在的你来说。你在日记里写："我不想要一家公司，我想要一种生活。"',
        isRestOption: true,
      },
      {
        id: 'partner_up',
        ...
        log: '{age}岁，你没招员工，而是跟前同事合伙，五五分账。TA带来一批客户，你带来交付体系，两个人各自做擅长的事。你不用当"老板"，但也不再孤单。你跟TA开玩笑："我们是两个自由职业者凑在一起，假装成一家公司。"TA说："管它叫什么，能接住单子就行。"',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你砍掉了七成不相关的业务，把全部精力砸进了一个细分领域——那些AI啃不动的、需要十年行业直觉和人情判断的活。前半年收入掉了三成，你慌过。但一年后，你成了这个圈子里"提到这个需求第一个想到的人"，客户宁可排队等你也懒得去试AI。客单价翻倍，客户排队。你终于懂了：自由不是什么都做，是有底气只做一件事——而那件事，得是AI做不了的。',
      },
      {
        id: 'stay_generalist',
        label: '保持通才，用多元对冲风险',
        ...
        log: '{age}岁，你没专业化，继续做"瑞士军刀"。任何一个领域风吹草动，你都能切到另一个。收入没爆发，但也从没断过。你安慰自己：游民的本质就是"不把根扎死"，这样风来了你能飞，风停了你也不会倒。',
      },
      {
        ...
        log: '{age}岁，你开始系统性地输出内容——每周一篇深度复盘，每月一次公开直播。半年后你的名字开始出现在行业媒体上，客户从"你找他"变成了"他找你"。你发现：通才的护城河不是某项技能，是"被足够多的人知道你什么都会"。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你在动态圈发了一条："从今天起，我只接让我兴奋的活。"下面一堆人问"你财务自由了？"你回了个笑脸。你知道"自由"不是不用工作，是终于有底气对不想做的事说不。十二年前那张去大理的单程票，终于在今天兑现了。',
      },
      {
        id: 'keep_grinding',
        label: '继续接单，趁能赚多赚点',
        ...
        log: '{age}岁，你没停下来。你跟自己说"再干几年，攒够FIRE的数字再说"。但你心里隐隐知道：安全感的数字会随着你的收入一起涨，你永远到不了那个"够了"。也许"够"从来不是一个数字，是一个决定。',
      },
      {
        ...
        log: '{age}岁，你把十二年的游民经验做成了一套免费入门课，挂在YouTube上。第一周播放破十万，评论区全是"谢谢你不收钱"。你看着那些留言，手指停在一条"新人求带"的评论上——当年你也是这样在群里打出第一行字的。原来你也成了当年帮你的人。',
      },
    ],
  },
];
...
const entrepreneurEvents: NarrativeEvent[] = [
    ...
    options: [
      {
        ...
        log: '{age}岁，你进入了"每周一更"的疯狂节奏。那两个用户成了你的产品顾问，你每个版本都先发给他们试用。三个月后用户涨到了50，留存率80%，月费19美元攒下了第一笔5000块的订阅收入。你发现：早期不缺用户，缺的是"愿意陪你打磨的死忠"。',
      },
      {
        id: 'find_seed_users',
        ...
        log: '{age}岁，你没急着写代码，而是跑去跨境卖家群里当起了"客服"。谁有汇率换算的痛点你立刻私信安利。一个月手动拉来了40个用户，其中8个成了付费。你学到一句话：产品冷启动，前100个用户只能靠手动一个一个搬。',
      },
      {
        id: 'pivot_problem',
        label: '根据反馈果断转向',
        ...
        log: '{age}岁，你跟用户聊深了发现：他们真正头疼的不是记账，是收不同国家的钱。你狠心把做了一半的记账功能砍掉，转向做"多币种收款"。这次转向让你晚两个月上线，但用户数两周翻了十倍——因为你终于戳中了真痛点。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你没贪便宜，花了双倍价钱招了个有三年远程经验的菲律宾姑娘。她上班第一周就把你的客服流程理顺了，第二周开始主动优化FAQ。你第一次体会到了"花钱买回自己时间"的爽感——贵，但值。',
      },
      {
        id: 'hire_cheap_train',
        label: '招便宜的新人，自己手把手带',
        ...
        log: '{age}岁，你招了那个英语磕巴但眼里有光的菲律宾新人。前两个月你几乎是在"教英语+教业务"，累到怀疑人生。但第四个月她能独立处理80%的工单了，第六个月她成了你最得力的左手。你发现：带新人最大的回报不是省下的钱，是她成长时你眼里那点光。',
      },
      {
        ...
        log: '{age}岁，你没雇人，而是把设计、文案、测试全发包给了游民圈的朋友。保持了"一人公司"的轻盈，但协调成本高得吓人。你成了"项目经理"，每天一半时间在催稿。你开始理解：外包省的是固定成本，费的是管理精力。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你花了三个月把客服、交付、财务全写成了SOP，上了Notion+Zapier+Loom的组合拳。最初员工不适应"按文档办事"，但一个月后你发现：你请假三天，公司居然没塌。你第一次尝到了"系统比人可靠"的甜头。',
      },
      {
        id: 'hire_ops_lead',
        ...
        log: '{age}岁，你招了个远程运营负责人——一个在欧洲的前大厂PM。她上班第二周就把你那堆乱七八糟的流程理成了甘特图。你从"救火队长"变回了"产品负责人"，终于又能写代码了。你学到：创始人的第一课，是承认自己不是全能的。',
      },
      {
        ...
        log: '{age}岁，你没扩张，反而砍掉了一半低利润客户，把团队精简到2人。收入少了，但利润率涨了，你每周能睡够七小时。你跟自己说：不是所有公司都要做大，"小而美"也是一种成功。你赌的是：活得久，比长得快重要。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你在爱沙尼亚注册了e-Residency公司，全套数字化运营，全球收付。注册费花了一万五，但从此你的税务结构清晰了，合规成本降了一半。你第一次理解了：对数字游民来说，"公司注册地"也是一种地理位置选择——而且是最重要的一种。',
      },
      {
        id: 'hire_pro_advisor',
        ...
        log: '{age}岁，你花了八千请了个专门做跨境数字生意的税务顾问。她帮你把三个国家的申报理顺了，还发现了两个你一直在多交的税。你看着省下来的钱，心想：这八千花得比任何营销费都值。合规不是成本，是保险。',
      },
      {
        id: 'ignore_risk',
        label: '先不管，赚到钱再说',
        ...
        log: '{age}岁，你把那封税务局的信塞进了抽屉，安慰自己"小生意没人管"。省下了顾问费，但每个深夜你都会想起那封信。你知道这是颗定时炸弹，只是你选择假装它不存在。一年后它真的炸了——罚款比顾问费贵了十倍。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你忍痛砍掉了自己最得意的自动化模块，把全公司精力压在协作功能上。前两周有老用户骂你"阉割产品"，但一个月后新增付费涨了40%。你学到一句话：PMF不是你以为的好，是用户愿意续费的好。放下执念，是创始人最难的修行。',
      },
      {
        ...
        log: '{age}岁，你发现跨境卖家市场到顶了，但同一个产品卖给"远程团队"反而需求更旺。你重新写了所有营销文案，换了个赛道。三个月后用户翻倍——你赌对了：同一个功能，换个人群，就是一门新生意。',
      },
      {
        id: 'accept_plateau',
        label: '接受增长停滞，做成"现金牛"',
        ...
        log: '{age}岁，你停止了追增长，把产品变成了"印钞机"——不再加功能，只做维护和留存。利润稳定，你解放了出来。有投资人劝你"该冲一波了"，你笑了笑：不是每家公司都要上市，能稳定下蛋的鹅，也是好鹅。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你没去打官司，而是把全部精力投到了"做品牌"上——办线上社群、做用户访谈直播、写深度行业内容。半年后你的用户开始自发安利："抄的那个便宜但没人理，这家的创始人是真人。"你发现：功能是商品，信任是资产。抄得走代码，抄不走关系。',
      },
      {
        id: 'out_innovate',
        label: '用更快的迭代甩开抄袭者',
        ...
        log: '{age}岁，你进入了"两周一个大版本"的节奏，把抄袭者永远甩在身后。他们抄的是你上个月的，你已经上线了下个月的功能。代价是你的发际线和睡眠。你赢了，但你不确定这种"领先"能撑多久——毕竟你也终会累。',
      },
      {
        ...
        log: '{age}岁，你给那个抄袭者发了封邮件："与其互相消耗，不如聊聊？"对方震惊了一周才回。最后你们没合并，但达成了"差异化定位"的默契——你做高端，他做下沉，各赚各的。你学到：商业里最大的杠杆不是打败对手，是把对手变成生态的一部分。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你没分红，把利润全砸进了新市场和团队扩张。一年后MRR破了十万，但也养出了一支臃肿的团队和失控的成本。你学到了"增长瘾"的代价——不是所有增长都是好增长，有些只是虚荣指标在膨胀。',
      },
      {
        id: 'optimize_profit',
        label: '不追增长，把利润率做到极致',
        ...
        log: '{age}岁，你停止了烧钱获客，转而把留存和续费做到极致。MRR没涨多少，但利润率翻倍，分红进了口袋。你第一次给自己发了笔"老板工资"之外的分红，看着到账的数字想：原来"赚钱"和"长大"是两件事。',
      },
      {
        ...
        log: '{age}岁，你提拔了运营负责人做"代理CEO"，自己退到只管战略和融资。第一周你无所事事到焦虑，第二周你开始享受"不被会议绑架"的清晨。你第一次相信了一句话：创始人最高级的成功，是让自己变得"不重要"。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你拉了个小分队，闷头三个月做出了第二个产品。上线那天你紧张得像第一次创业。好在老客户们果然有这个需求，第一批种子用户几乎不用拉——他们已经在排队了。你看着两条增长曲线并排往上走，心里想：原来第二曲线不是找来的，是蹲在第一曲线旁边听用户抱怨听出来的。',
      },
      {
        id: 'double_down_core',
        label: '把第一个产品做到极致',
        ...
        log: '{age}岁，你按住了想做新产品的冲动，把全部精力砸回第一个产品。你优化了留存、打磨了体验、砍掉了所有分散注意力的功能。增速没回到20%，但稳在了8%，而且利润更厚了。你跟团队说："不是每个曲线都需要立刻找第二条，先把这条走扎实。"',
        isRestOption: true,
      },
      {
        ...
        log: '{age}岁，你没从零做，而是花了一笔钱收购了一个快撑不下去的小竞品——它的技术正好补上你客户念叨的那个B问题。整合的头两个月鸡飞狗跳，代码风格冲突、团队文化打架。但三个月后，两套产品并成了一套，用户的B问题被顺手解决了。你学到了：有时候增长不是"做"出来的，是"买"回来的。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你签了收购协议。交割那天你看着银行账户多出来的零，有一种不真实感。你在过渡期帮新东家整合产品，两年后彻底脱手。从此你不再是"那个做XX的创始人"，但你银行里的数字，足够你做任何想做的事——包括什么都不做。',
      },
      {
        ...
        log: '{age}岁，你拒了那个offer。朋友说你"疯了"，但你心里清楚：你做这家公司从来不是为了卖掉它。你要的是一个"完全属于自己"的东西——这种所有权，比任何套现都值钱。你赌的是：独立带来的复利，会超过一次性套现。',
      },
      {
        id: 'partial_exit',
        ...
        log: '{age}岁，你没全卖，而是出让了30%股权给一家成长型基金。拿了一笔可观的现金落袋，同时保留了对公司的控制权。你既有了"上岸"的安全感，又没失去"船长"的身份。你发现：商业里最高级的操作，不是非黑即白，是找到那个"既要又要"的平衡点。',
      },
    ],
  },
  ...
  // 35岁：地点无关的真正含义
  {
    ...
    narrative:
      ...
      '你想起{startAge}岁那个在丽江天台上做选择的夜晚。那时"地点无关的生意"只是一个赌注，现在它成了一台机器。这十年世界翻了个个儿：AI接管了大半的远程活计，远程办公从"少数人的特权"变成了默认选项，数字游民签证也从几个国家蔓延到了半个地球。你{startAge}岁时还要为自己"不坐班"辩解，{age}岁时反而是坐班的人开始羡慕你。你看着枫叶飘落，第一次有了一种"够了"的平静——不是赚够了，是终于分清了"想要"和"需要"。',
    options: [
      {
        id: 'become_investor',
        ...
        log: '{age}岁，你开始用赚来的钱投早期的游民创业者。你投的不只是钱，是你十年踩坑换来的"避雷指南"。看着那些年轻的脸像当年的你一样眼里有光，你有一种奇妙的传承感——你的自由，正在通过别人的事业继续复利。',
      },
      {
        ...
        log: '{age}岁，你花了半年写完了《地理套利者》。书出版那天你收到上百条私信："谢谢你，我终于敢出发了。"你看着那些留言，眼眶有点湿——原来你十年走过的弯路，最大的价值不是让你少走，是让别人不必走。',
      },
      {
        id: 'truly_retire',
        label: '真正退休，把公司交给团队',
        ...
        log: '{age}岁，你把CEO的位置交给了跟了你六年的运营负责人，自己只保留股东身份。交棒那天你清理了Slack通知，关掉了邮箱推送。走出办公室那一刻，你回头看了眼这台运转良好的机器——它不再需要你了。这就是你十年前赌的"地点无关"的终极形态：连你自己都可以不在场。',
      },
    ],
  },
];
    ...
    options: [
      {
        ...
        log: '{age}岁，你接了人生第一笔咨询单——每小时200美元，10小时。你认真做了proposal、列了交付物清单。对方收到后回复："比我们请过的咨询公司还专业。"你这才明白：你的经验不是闲聊素材，是真金白银的知识资产。',
      },
      {
        ...
        log: '{age}岁，你给了个半价"友情价"接下了第一单咨询。交付时客户很满意，但你心里清楚：你贱卖了自己的经验。下次绝不再这样了。',
        isRestOption: true,
      },
      {
        id: 'pilot_split',
        ...
        log: '{age}岁，你把十个小时劈成两半：前五小时按200美元全价收，后五小时算"试水折扣"，但要求客户写一封公开推荐信作为交换。你既没贱卖自己，也没吓跑第一个客户。那封推荐信后来为你引来了三个新客户——你学会了折中：不是非此即彼，是各取一半。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你做了一个痛苦但正确的决定：拒绝所有非"跨境市场进入"的咨询需求。头两个月收入暴跌，你慌得睡不着。但第三个月，三个客户主动找上门——因为他们听说你是"做跨境进入最专业的那个人"。你终于明白了前辈的话：定位就是放弃。',
      },
      {
        id: 'stay_generalist',
        label: '继续什么单都接',
        ...
        log: '{age}岁，你选择继续当"万金油"咨询师。收入确实更高了，但每天在完全不同的领域之间切换，脑子像被人搅拌过。你开始怀疑：到底是在做咨询，还是在打零工？',
      },
      {
        ...
        log: '{age}岁，你没把自己绑死在一个领域，也没继续当万金油。你挑了"跨境市场进入"和"品牌本土化"两个相邻的细分方向——既有了辨识度，又留了转身余地。前辈看了你的定位说："这才是聪明人的做法，不把路走窄，也不把路走散。"',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你签下了人生第一份六位数美元的咨询合同。手抖着签完字那天你吐了——不是夸张，是真的吐了。但三个月后交付完毕，客户CFO发邮件说："你给我们省了至少两百万美元的试错成本。"你把那封邮件截图保存了下来，每次自我怀疑时就翻出来看看。',
      },
      {
        id: 'negotiate_down',
        label: '谈一个更安全的范围',
        ...
        log: '{age}岁，你把12万的合同砍到了4万，只做自己最有把握的部分。项目顺利完成，但你心里一直有个"如果"：如果当初全接了，会怎样？你告诉自己这是稳健，但深夜里你知道那不全是稳健，还有怕。',
        isRestOption: true,
      },
      {
        id: 'bring_partner',
        ...
        log: '{age}岁，你签下了12万的合同，但没一个人扛——你请了一位做过二十年日企项目的资深前辈联合交付，收入五五分账。他补上了你最缺的大型项目交付经验，你贡献了对南方市场的在地理解。项目顺利收官，客户问"下次能不能还是你们俩"。你学到：承认自己不够，比假装自己够更值钱。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你找到了自己真正的定位：不做市场分析，做文化翻译。你帮跨国团队拆解误解、建立信任、对齐预期。你的报价单上多了一行字："跨境协作与文化桥接顾问"。客户们开始把你当"不可或缺的人"——不是因为你懂技术，是因为没有你，他们连会都开不起来。中德项目的咨询费尾款15000块到账，你第一次觉得"走了七年弯路"终于变现了。',
      },
      {
        ...
        log: '{age}岁，你选择不转型。市场进入咨询虽然"硬核"但好交付、好报价。你在中德项目里扮演的"文化翻译"角色让你印象深刻，但你没有把它变成主业。也许某天你会后悔这个选择——也许不会。',
        isRestOption: true,
      },
      {
        id: 'bridge_as_addon',
        ...
        log: '{age}岁，你没把"文化桥梁"变成全部身家，也没放弃它。你把它打包成一个高客单的增值模块——市场进入咨询照做，客户若需要跨国协作协调，再加价购买"文化桥接"服务。一半客户选了加购。你的主业没断，副线在长。你发现折中 sometimes 是把两条路都走一半，反而都走通了。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你做了一个"反直觉"的决定：减少了出差。你开始拒绝必须到场的会议，转而用远程协作工具完成交付。收入少了一些，但你终于能在同一个城市待超过两周了。你在厦门租了一个月的公寓，每天早上在阳台上喝咖啡，看着楼下的公交车慢慢驶过。你想起朋友的话——空心，得先停下来才能填满。',
        isRestOption: true,
      },
      {
        id: 'push_through',
        ...
        log: '{age}岁，你选择了继续跑。收入确实在涨，但你开始忘记自己为什么出发了。每次落地一个新城市，你不再兴奋，只剩疲惫。你在飞机上吃安眠药，在会议室里喝双倍浓缩，在酒店里对着天花板失眠。你赚到了钱，但花在了买褪黑素上。',
      },
      {
        id: 'hire_va',
        label: '雇个远程助理，砍掉一半行程',
        ...
        log: '{age}岁，你没彻底停掉出差，也没硬扛。你雇了一位在菲律宾的远程助理，把行程预订、会议排期、发票整理全甩给了TA，自己只保留关键的线下会面，出差砍掉一半。你在同一张候机椅上坐下时，手机里少了一半的红点。你第一次知道：雇人不是偷懒，是把你的时间从"杂事"里赎回来。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你开始认真经营个人品牌。每周一篇长文，每月一次播客，每季度一次公开演讲。你的关注者从几千涨到了几万。你的咨询报价翻了一倍——因为"你不是在卖时间，是在卖认知"。有客户跟你说："我们找你不是因为你便宜，是因为你在这个领域有声音。"你第一次体会到了"思想也能变现"的感觉。',
      },
      {
        ...
        log: '{age}岁，你选择了低调。文章火了之后你没有继续输出，而是默默回到了项目交付中。客户质量在提升，但你始终是一个"行业内知名、行业外无名"的人。有时候你会想：如果我当初顺势做了个人品牌，现在会是什么样？',
        isRestOption: true,
      },
      {
        id: 'quarterly_output',
        ...
        log: '{age}岁，你没顺势把自己变成全职KOL，也没躲回幕后。你定了个规矩：每季度只写一篇"压箱底"的长文，演讲只接1-2个收费最高的重磅场次，其余全拒。你的输出少了，但每篇都被反复引用；你的曝光少了，但每次出场都更贵。你学会了：影响力不是靠量堆的，是靠"出现就得值得"。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你推出了订阅制咨询。五个老客户签约，每月固定收入覆盖了你的全部生活开销。你第一次不必为"下个月的客户在哪里"而焦虑了。你在大理的公寓里对着屏幕笑了很久——这不是退休，但这是"不用再狩猎"的自由。你终于理解了什么叫"被动的心智"。',
      },
      {
        ...
        log: '{age}岁，你选择继续做项目制咨询。灵活是灵活了，但你依然在每个项目间隙焦虑地找下一个。你偶尔会想起朋友说的"卖订阅"那句话，然后摇摇头继续写proposal。',
        isRestOption: true,
      },
      {
        id: 'hybrid_model',
        ...
        log: '{age}岁，你没把全部身家压在订阅上，也没固守项目制。你给三个最信任的老客户上了订阅，新客户继续按项目收。半年后订阅收入稳了，你才慢慢把更多客户迁过去。你跟朋友说："我不是在赌一个模式，我是在让它先证明自己。"折中不是怯懦，是给自己留退路的同时往前走。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你跟德勤签了专家合作协议。第一次以"德勤合作专家"的身份出现在客户面前时，对方的态度明显不同了——不再是"你一个人靠谱吗"的质疑，而是"大厂都认可你"的信任。你的报价单又涨了30%。德勤转介的第一笔大企业专家费25000块到账，但深夜里你偶尔会想：现在来找你的人，到底是因为你，还是因为你背后的logo？',
      },
      {
        id: 'stay_independent',
        label: '保持独立，拒绝排他',
        ...
        log: '{age}岁，你拒绝了排他条款，只签了非排他性的项目合作。德勤的项目你做，别的客户你也做。收入不如全签来得多，但你保住了最看重的东西——自由选择客户的权利。你在日记里写："我不想成为任何人的附属品。包括德勤。"',
        isRestOption: true,
      },
      {
        ...
        log: '{age}岁，你没全签也没全拒。你跟德勤谈了18个月的限时排他，加了一条：18个月后复盘，若达不到最低保底转介量，自动转回非排他。大厂的法务磨了你两周，最后同意了。你既拿到了背书，又给未来的自己留了一扇门。你想起一句话：合同里最重要的不是签了什么，是"什么时候能退出"。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你把那套框架命名为"跨境文化桥接模型"（CCBM），写成了一本书、做了一套在线课程、还建了一个认证体系。第一批100个学员里，有3个人后来成了你的合作顾问。你的知识第一次脱离你的身体独立运转了——就算你明天去海岛躺一个月，CCBM的课程还在为你赚钱，你的方法论还在帮别人解决问题。这就是知识产品化的终极自由。',
      },
      {
        ...
        log: '{age}岁，你选择把方法论留在自己手里。你用它服务客户，但从不对外公开。你的咨询质量因此一直很高——因为只有你能用这套方法。但你也知道：这意味着你的收入永远跟你的时间绑定。你想自由，却选择了不自由的方式保护自由。',
        isRestOption: true,
      },
      {
        id: 'handbook_first',
        ...
        log: '{age}岁，你没急着把方法论做成课程去卖，也没把它锁在抽屉里。你先把它写成一本内部手册，找了两个老客户"试跑"——用手册带着他们走了一遍流程，收集反馈。一年后你才决定要不要产品化。你跟自己说："先把东西磨对，再决定要不要卖。"折中有时就是：不抢跑，也不躺平。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你选了厦门做你的"基地"。不是因为厦门最好，是因为你在厦门有过一段最平静的日子。你签了一年的租约——这是你十三年来第一次签超过三个月的租约。你在阳台上种了一盆罗勒，每天早上浇水时你都会想：原来"停下来的勇气"比"出发的勇气"更难。但你做到了。',
      },
      {
        id: 'keep_nomading',
        label: '继续游牧，只是节奏慢下来',
        ...
        log: '{age}岁，你没有选基地。你把节奏从"每月一个城市"调到了"每季一个城市"——厦门三个月，大理两个月，杭州一个月。你依然在路上，但不再赶路了。有人问你"家在哪里"，你说："我的家在云端。它不是一个地方，是一种状态。"',
      },
      {
        id: 'build_consulting_firm',
        label: '趁势建一个小型咨询公司',
        description: '拿出存款的一部分启动公司，把个人品牌升级为机构，招募团队接更多单，投得越多团队越强',
        hint: '远程能力+8 · 跨文化+8 · 投入存款30% · 被动收入+年化50% · 信念+8 · 压力+10',
        hintColor: 'danger',
        skillGains: { remoteSkill: 8, crossCulturalSkill: 8 },
        savingsChangeFn: (s: GameState) => -pctInvestment(0.30, 0.50).investFn(s),
        passiveIncomeChangeFn: (s: GameState) => pctInvestment(0.30, 0.50).returnFn(s),
        stateEffect: (s) => {
          ensureSkills(s);
          s.pathFaith = clamp(s.pathFaith + 8, 0, 100);
          s.stress = clamp(s.stress + 10, 0, 100);
        },
        log: '{age}岁，你拿出积蓄的一部分把个人咨询升级成了一家小型精品咨询公司。招了三个你信任的CCBM认证学员，接了更大的单子。投入越多，公司规模和客户层级就越高。你从"一个人"变成了"一个品牌"。白天开会带团队，晚上写书做课程。你比做游民时更忙了，但你忙得心甘情愿——因为你在建造一个比你更大的东西。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你第一次走了"正规路"申请数字游民签证。提交了远程工作收入证明、买了覆盖全球的医疗保险、等了三周审批。拿到签证那天你长舒一口气——你终于不用每隔几个月就为"能不能留下来"焦虑了。合法的自由，比灰色地带的自由踏实得多。',
      },
      {
        ...
        log: '{age}岁，你拎着行李箱飞去了巴厘岛——印尼的数字游民签证好办，对远程工作者友好。落地苍古那天，你站在街边闻着椰子壳和香茅的气味，心想：每个新国家的第一天都是一样的——兴奋、陌生、和一点点想家。',
      ...
      },
      {
        ...
        savingsChange: -2000,
        log: '{age}岁，签证到期你回了国。父母看到你回来高兴得做了一大桌子菜。你在老家的床上睡了一个月以来最踏实的一觉。但两周后你开始坐立不安——你发现自己已经不适应"静止"了。你订了下一张机票。',
        isRestOption: true,
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你为TA在成都多待了半年。你们一起买菜做饭，一起在阳台上看日落，一起吵过架又和好。你第一次体会到"漂泊的人也有日常"是什么感觉。半年后TA跟你说"我们继续走吧"——但你知道你们已经不是一个人了。',
      },
      {
        ...
        log: '{age}岁，你选择了自由。你们约定"各自走，路上见"。TA去了重庆，你去了昆明。你们靠视频和消息维系着，但距离像一把钝刀，慢慢割着这段关系。半年后你们在丽江重逢了五天，分别时在机场哭得像生离死别。你知道这条路很难走，但你不知道还有别的走法。',
      },
      {
        id: 'let_go',
        label: '和平分手，各自安好',
        ...
        log: '{age}岁，你跟TA在成都的最后一天喝了最后一杯精酿。TA说"我理解"，你说"我也是"。你们没有争吵，没有怨恨，只有一种深深的遗憾——两个对的人，在对的时间相遇，却走在不同的路上。你在飞机上看了一路的云。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你订了回家的机票。你跟客户说明了情况，调整了交付节奏。你在国内待了两个月——陪爸爸去医院体检，陪妈妈去菜市场买菜，陪弟弟喝了顿酒。临走那天你妈在机场哭了，你说"我会常回来的"。但你知道你和她对"常"的理解不一样。',
        isRestOption: true,
      },
      {
        ...
        log: '{age}岁，你往家里打了5万块钱，告诉弟弟"帮我照顾好爸妈"。你妈收到钱后在电话里说"我们不要钱，要你"。你握着手机在昆明的公寓里沉默了很久，然后打开电脑继续写proposal。钱能解决很多问题，但解决不了思念。',
      },
      {
        ...
        log: '{age}岁，你给爸妈订了来大理的机票。他们在大理住了一个月——你爸学会了用Google Maps导航，你妈爱上了过桥米线。走的时候你爸说"原来你在外面过得还行"，你妈说"下次去你说的那个厦门看看"。你笑了，眼眶有点热——他们终于不只是在电话里"想象"你的生活了。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，出院第一周你就买了一份覆盖全球的商业医疗保险。年费一万，不便宜。但你想起那个凌晨独自在清迈叫车去医院的夜晚——那种"如果出了大事没人管"的恐惧，比任何保险费都贵。你终于明白：自由的前提是有一个安全网。',
        isRestOption: true,
      },
      {
        ...
        log: '{age}岁，你省下了保险费。阑尾炎的事很快就被新的工作和旅行覆盖了。但偶尔深夜你会想起那个独自在异乡病房的夜晚——那种无力感像一根刺，扎在某个你看不见的地方。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你在清迈住了六个月。你有了固定的咖啡馆座位、固定的粿条阿姨、固定的洗衣店、甚至固定的摩托修理师傅。Maya成了你固定的早餐同伴——你们不聊天，就是各坐各的，但有个人在对面翻画册，你就不觉得孤独了。你第一次发现：游牧不是"永远在移动"，而是"有能力在任何地方建立生活"。六个月后你续了约。',
        isRestOption: true,
      },
      {
        id: 'use_as_hub',
        ...
        log: '{age}岁，你把清迈的公寓当成了枢纽。平时在公寓工作，每隔一两个月飞出去一趟——曼谷、河内、吉隆坡、兰卡威。你有了"回来"的地方，也有了"出发"的理由。行李箱不再是你的全部家当，它只是你的旅行包。',
      },
      {
        id: 'keep_moving',
        label: '不签长约，继续保持移动',
        ...
        log: '{age}岁，你退掉了那间公寓。你跟自己说"还早"。你继续住在短租平台和青旅里，继续每两三个月换一个城市。但你偶尔会想起那盆薄荷——不知道它在阳台上活得好不好。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你跟家里约好了每周六晚上视频。一开始很生硬——你妈问"吃了吗"，你说"吃了"，然后沉默。但慢慢的，你们有了新的话题：你爸学会了用AI修图，你妈在学广场舞视频剪辑。固定的联系像一根线，把你和那个叫"家"的地方连在一起，不紧，但不断。',
        isRestOption: true,
      },
      {
        ...
        log: '{age}岁春节，你在游民群里喊了一句"有人没吃年夜饭吗"，来了七个人——一个成都的产品经理、一个台湾的设计师、两个德国的远程工程师、一个巴西的摄影师、一个日本的自由撰稿人、还有你。你们在短租平台的厨房里凑了一桌菜：川菜、卤肉饭、意大利面、巴西烤肉。没人看春晚，但有人放了音乐。你发现：乡愁是可以分享的，分享了就没那么沉了。',
      },
      {
        id: 'embrace_solitude',
        ...
        log: '{age}岁春节，你一个人在咖啡馆坐到打烊。你没约人，也没再打电话。你走回公寓的路上，里斯本的石板路被雨打湿了，路灯映在上面像碎金子。你突然觉得：孤独不是自由的敌人，是自由的影子——你走到哪里它跟到哪里，但你不必怕它。你学会了和它共处。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你和那晚认识的五个人建了一个Signal群。你们不聊工作，聊的是"清迈哪家公寓不发霉""里斯本哪个医生会说英文""日本游民签证怎么办""孤独的时候怎么办"。有人到你的城市你接风，你到他们的城市他们带路。你第一次有了"全球家人"的感觉——不是血缘，是选择。',
      },
      {
        id: 'collaborate_work',
        label: '和遇到的游民合作项目',
        ...
        log: '{age}岁，你和那个成都的产品经理、巴西的摄影师三个人一起做了一个面向游民的SaaS工具——帮数字游民自动计算多国税制和社保方案。你们三个时区协作，用AI做翻译和项目管理，第一个月就有了50个付费用户。你发现：游民不只是一种生活方式，也是一种人脉网络——你身边的每个人都带着一整个世界的资源。',
      },
      {
        ...
        log: '{age}岁，你们吃完晚饭互加了Instagram，然后各自散了。你没有建群，也没有约下次。你知道你们大概率不会再见面——游民的社交就是这样，像天上的云，碰到了下场雨，然后各飘各的。但那晚的记忆留在了那里——你知道世界上有跟你一样的人，这就够了。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你在72小时内做了两件事：给所有认识的人发了消息找新客户，同时申请了另一个国家的数字游民签证。两周后你到了新国家，三个新客户签了约——虽然收入比之前少了30%，但你活下来了。你后来在日记里写："自由不是没有风险，是能在风险中继续前行。"',
      },
      {
        id: 'retreat_home',
        label: '回来休整，等风暴过去',
        ...
        log: '{age}岁，你回家了。父母的沙发成了你的临时基地。你用老家的低成本生活重建客户群，远程接海外单子。三个月后收入恢复了，但你心里始终有个声音在问：你是因为"暂时回去"还是"回去了就出不来了"？信念值在你心里动摇着——你不确定自己还有没有勇气再买一张单程票。',
        isRestOption: true,
      },
      {
        ...
        log: '{age}岁，你在数字游民的Discord群组里发了一条求助帖。24小时内你收到了50多条回复——有人给你推荐客户，有人帮你联系新国家的签证代办，有人直接说"我在巴厘岛有间空房，你先来住"。你坐在屏幕前哭了。你以为你是一个人在路上，但你不是——这条路你从来不是一个人走的。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你花了三倍价格从黄牛手里买到了一张去曼谷的机票。落地素万那普机场那一刻你双腿发软，直接坐在了地板上。你看着明亮的航站楼和有序的人群，第一次觉得"秩序"是世界上最奢侈的东西。你在曼谷待了两周恢复，然后默默把"选择基地国家"的标准从"便宜"改成了"稳定"。',
      },
      {
        id: 'shelter_in_place',
        label: '留在原地，等局势稳定',
        ...
        log: '{age}岁，你留在了原地。断网的一周里你靠着泡面和瓶装水过活。你听到了远处的警报声和近处的哭声。两周后局势稳定了，网络恢复了，你打开邮箱发现客户们已经发了无数封"你还好吗"的邮件。你回复了"我还好"，但你知道"还好"这两个字背后藏着多少恐惧。你开始重新审视"自由"的代价。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你在封锁的公寓里用两周时间开发了一个线上咨询产品和一个"远程团队管理"课程。你把AI工具用到了极致——用生成式AI快速产出课程大纲、用AI翻译做成多语言版本、用自动化工具搭起了整套交付流程。全球封锁反而成了你的机会——所有公司都在学怎么远程工作，而你是这方面的专家。你的收入在三个月后不仅恢复了，还超过了疫情前。你在日记里写："危机淘汰的是不适应的人。我在路上走了十二年，适应变化是我的本能。"',
      },
      {
        id: 'wait_it_out',
        label: '削减开支，等风暴过去',
        ...
        log: '{age}岁，你选择了"冬眠"。搬到了更便宜的公寓，取消了一切不必要的订阅，靠着存款和微薄的项目收入过日子。每天在公寓里做饭、运动、看书、发呆。三个月后封锁解除，你走出来的时候阳光很刺眼。你活下来了，但你心里知道：你在最该出击的时候选择了防守。你不后悔，但你记住了这种感觉。',
        isRestOption: true,
      },
      {
        ...
        log: '{age}岁，你在Discord上发起了一个"游民互助网络"。300多个全球游民加入——有人分享客户资源，有人提供法律咨询，有人帮忙找便宜的住所。你不仅渡过了危机，还建立了一个比任何公司都紧密的全球社区。有人在群里说："我们不是流浪者，我们是新世界的拓荒者。"你把这句话设成了你的签名。',
      },
    ],
  },
...
const lateGameEvents: NarrativeEvent[] = [
    ...
    options: [
      {
        ...
        log: '{age}岁，你做了一个痛苦的决定：砍掉所有执行层的客户，只留战略咨询。头三个月收入跌了40%，你慌得睡不着。但第四个月，一个老客户介绍了一个大企业的新市场进入策略项目——报价是你以前一年执行收入的五倍。你终于明白：AI淘汰的是"干活的人"，不是"想清楚的人"。',
      },
      {
        ...
        log: '{age}岁，你没放弃执行层，而是用AI把它自动化了。你搭了一套pipeline：客户提需求→AI生成初稿→你审核修改→自动部署。以前一个项目要两周，现在两天。你用同样的时间接了五倍的量，利润率反而比以前高。但你心里清楚：你在跟AI赛跑，总有一天它会跑得比你快。',
      },
      {
        ...
        log: '{age}岁，你开了一门课："AI时代的跨文化协作"。你教的不是技能——技能AI能教。你教的是"怎么在德国工程师沉默的时候读懂他其实不同意"、"怎么在日本客户说"我们研究研究"的时候知道这是拒绝"。这些东西AI学不会，因为它没有在路上走过十四年。课程上线第一个月卖了200份，你发现：你走过的路本身就是产品。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你在成都长租了一间公寓。你发现国内的地理套利依然成立——你的远程收入是成都平均工资的四倍，但生活成本只有一线城市的一半。你不用再办签证、不用再买国际机票、不用再在异国急诊室里独自签手术同意书。你偶尔会想念清迈的椰子壳味道，但你不再需要"永远在路上"来证明自己了。',
        isRestOption: true,
      },
      {
        ...
        log: '{age}岁，你没回头。你把基地收缩到了三个对游民最友好的国家——日本、葡萄牙、马来西亚。你花了更多时间研究签证政策、税务协定、医疗保险。自由的成本变高了，但你愿意付。你在日记里写："墙在长高，但总还有门。找到门是我的工作。"',
      },
      {
        id: 'hybrid_model',
        ...
        log: '{age}岁，你找到了一个折中方案：一年十个月在成都或大理，两个月去海外。你在国内有稳定的社区、医保、生活节奏，但每年还有两个月的"在路上"。你发现这种节奏比"永远在路上"更可持续——你不再需要证明什么，你只是享受它。你在清迈的咖啡馆里遇到一个24岁的年轻游民，TA问你"你怎么做到走这么久的"，你笑了："因为我知道什么时候该停。"',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你第一次把"身体"排在了"工作"前面。你推掉了两个项目，买了把人体工学椅，开始每天游泳。你用AI把剩余的重复性工作自动化了——以前要你亲自动手的排版、测试、部署，现在一条prompt就搞定。你发现养病的三个月反而让你的收入没怎么跌，因为AI替你干了你以前"亲力亲为"的那些事。你跟朋友说："身体是本钱这句话，以前觉得是废话，现在觉得是真理。"',
        isRestOption: true,
      },
      {
        id: 'push_through',
        ...
        log: '{age}岁，你选择了硬扛。止疼药、膏药、护腰——你把它们塞进登机箱，继续飞。在曼谷的机场你弯不下腰提行李，只好蹲下来一点一点挪。你的客户不知道你疼得冒冷汗还在给他们开会——你以为这是"专业"，其实这是"透支"。三年后你的腰椎彻底出了问题，医生说"早该治的"。你后悔了，但来不及了。',
      ...
      },
      {
        ...
        log: '{age}岁，你雇了一个当地的大学生帮你跑腿——取快递、办手续、搬行李。每个月花两千块，但你的腰不再疼了。你把省下来的精力全部投入高价值工作——跟客户开会、做战略规划、写方案。你发现：花钱买体力劳动的替代，是你这个年纪最值的投资。',
      },
    ],
  },
  ...
  // 39-40岁：传承冲动（跨分支）
  {
    ...
    narrative:
      ...
      '你看着那条消息，想起了自己{startAge}岁时在Upwork上投了六十多份提案的日子。那时候没有人给你指南，你全靠自己摸。你踩过的坑——签证被拒、客户跑路、在异国急诊室独自签字——每一个都能写成一本书。\n\n' +
    ...
    options: [
      {
        ...
        log: '{age}岁，你成了那个年轻人的导师。你带TA接了第一个项目，教TA怎么跟客户谈判、怎么管理时区、怎么在异国买保险。TA第一次拿到美元到账时给你发了张截图，你看着那个数字，想起了自己{startAge}岁时手抖着按下回车键的那一刻。你没说"我羡慕你"，你说"你会走得比我远"。这是真话。',
      ...
      },
      {
        ...
        log: '{age}岁，你花三个月写了一本《游民生存手册：从零到自由》。你写了签证攻略、税务规划、客户管理、跨文化沟通、AI工具链——还有你在清迈急诊室独自签字的那个夜晚。书上线第一天卖了500份。你在后记里写："这本书不是鼓励你上路，是让你知道路上有什么。走不走，是你的事。"',
        triggersRetirementCheck: true,
      },
      {
        id: 'honest_answer',
        ...
        log: "{age}岁，你跟那个年轻人聊了两个小时。你说：\"AI能干你以前干的活，但不代表这条路走不通了。它只是变了——从'出卖执行力'变成了'出卖判断力'。你要问自己的不是'AI能不能替代我'，是'我有没有AI给不了的判断'。\"年轻人沉默了很久，说\"谢谢你没骗我\"。你挂掉电话，觉得这比接了一个大单子还满足。",
      },
    ],
  },
  ...
  // 40岁：回望与选择（跨分支，归巢期开端）
  {
    ...
    conditions: (s) => s.narrativeBranch !== 'unassigned' && s.isAllInPath === true,
    narrative:
      '你{age}岁了。你坐在大理的阳台上，面前是一杯普洱茶，远处是苍山的轮廓。你打开了一个空白文档，标题写了两个字："十八年"。\n\n' +
      '从{startAge}岁在Upwork上投第一份提案，到现在已经十八年了。你住过18个城市，跨越了11个国家，用过从Notion到AI编程器到通用大模型的每一代工具。你的护照换了三本，你的登机箱换了五个，你的腰椎间盘突出了一次。你赚过最贵的一小时是500美元，也经历过连续三个月没有收入的恐慌。\n\n' +
    ...
    options: [
      {
        ...
        log: '{age}岁，你创建了"游民学院"。不是教技能——技能AI能教。你教的是"怎么在不确定性中生存"、"怎么在异国读懂空气"、"怎么在自由和孤独之间找到平衡"。第一批50个学员里有3个后来成了你认识的游民。你看着他们在群里分享自己的第一单、第一次签证被拒、第一次在异国急诊室独自签字——你想起了自己。火炬传下去了。',
        triggersRetirementCheck: true,
      },
      {
        ...
        log: '{age}岁，你选了大理。长租了一间带院子的房子，养了一条狗，种了一院子的花。你还在工作——远程客户、被动收入、偶尔接一个有意思的咨询。但你不再追了。你坐在院子里喝茶的时候，偶尔想起18个城市和11个国家，觉得像做了一场很长的梦。你醒了，但不后悔梦里的每一个早晨。',
        isRestOption: true,
        triggersRetirementCheck: true,
      },
      {
        ...
        log: '{age}岁，你没停。你买了下一张机票。你的朋友说你"疯了"，你笑了笑。你知道你不是在逃避什么——你只是还没看够。你在登机口排队的时候，看到旁边一个20出头的年轻人也拎着登机箱，眼睛里是你十八年前的那种光。你们对视了一眼，都没说话，但你们都懂。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你在清迈买了一间小公寓——不大，但阳台够放四盆香草和一把藤椅。你终于不再续租了，这是你的。签完合同那天你坐在阳台上喝了一杯美式，第一次理解了"家"不是你出生的地方，是你选择留下来的地方。你还是数字游民吗？你不确定。但你确定的是，你回家了。',
        isRestOption: true,
      },
      {
        ...
        log: '{age}岁，你没买房，但也没走。你把租约续了一年，行李箱还是放在衣柜顶上——没打包，但随时可以拿下来。你跟那个年轻游民说："游民不是永远在移动，是永远有选择移动的自由。"TA不太懂，但你懂。你不再需要用"下一站是哪里"来证明自己是游民了。',
      },
      {
        id: 'shake_up',
        ...
        log: '{age}岁，你卖掉了冰箱和洗衣机，把四盆香草送给了楼下的咖啡馆老板娘，买了一张去墨西哥城的机票。落地的那一刻你发现——三年没动，你的背包比以前重了，你的心却轻了。你不确定这是"重新出发"还是"逃避"，但你确定的是：路还在脚下。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你把旅行节奏从"每月一城"改成了"每季一城"。不再追着便宜机票跑，不再为了多去一个国家而压缩停留时间。你发现慢下来之后，你开始真正"看见"一个城市——不是游客眼里的景点，是当地人去的菜市场、街角的面包店、邻居家的猫。你的身体感谢你，你的灵魂也感谢你。',
        isRestOption: true,
      },
      {
        id: 'pick_timezone',
        ...
        log: '{age}岁，你做了一个艰难的决定：推掉了所有美洲客户，只接欧洲和亚洲的单子。你把基地定在了里斯本——跟亚洲差七八个小时，但跟欧洲完全同步。收入少了一截，但你再也不用凌晨三点开会了。你终于理解了：自由不是什么时区都能工作，是有能力选择对自己好的时区。',
      },
      {
        id: 'push_body',
        label: '靠运动和补药硬扛',
        ...
        log: '{age}岁，你办了健身卡，买了GNC全套补剂，学会了用褪黑素和蓝光眼镜管理生物钟。你确实还能飞，但每次落地恢复的时间越来越长。你像一台老旧的机器，靠润滑油和维修勉强运转着。你知道这不是长久之计，但你还不想承认。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你在京都留了下来。不是因为京都有多美——虽然它确实美——是因为TA。你们在町屋附近租了一间带小庭院的房子，你种了一棵枫树，TA养了一只三花猫。你还是远程工作，TA还是去大学做研究。早上你们一起在庭院喝咖啡，晚上你们一起在厨房做饭——你做中餐，TA做日料。你花了二十多年才明白：游牧的终点不是某个地方，是某个人。你终于不用再找了。',
        triggersRetirementCheck: true,
      },
      {
        ...
        log: '{age}岁，你在京都的町屋续了长约。你加入了当地的町内会，学会了在祭典上抬神舆，教田中太太的孙子用AI做作业。你开了一间小小的中文教室，教附近的老人用智能手机跟海外的孙子视频。你的归处不是一栋房子，是这一整条街的人——他们认识你，你认识他们。你的护照上还有很多空白页，但你不急着填满了。',
        triggersRetirementCheck: true,
      },
      {
        id: 'home_is_road',
        ...
        log: '{age}岁，你谢了田中太太的和菓子，第二天打包了行李。你发了一条消息给那个在京都的朋友："和菓子很好吃，下次我请你喝墨西哥的mezcal。"TA回了一个笑的表情。你买了一张去里斯本的机票——不是为了逃避什么，是因为你终于确认了一件事：有些人的家是一座房子，有些人的家是一个人，而你的家是下一站的风。你不需要归处，因为你从未离开过家。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '{age}岁，你在机场等了十二个小时，飞了二十八个小时，赶到医院的时候你爸已经脱离危险了。他看到你第一句话是"你怎么回来了"，嘴上抱怨但手紧紧攥着你的手。你在医院陪了他三个月，远程推掉了一半的客户。你损失了收入和几个长期合同，但你不后悔——你终于明白：自由不是永远不回头，是回头的时候，有人还在。',
      },
      {
        ...
        log: '{age}岁，你没飞回去。你远程联系了最好的三甲医院、请了最贵的护工、每天视频三次。你爸恢复得不错，但每次视频你妈都欲言又止。你知道她想说什么——"你就不能回来吗？"你也想。但你算了账：飞回去就意味着丢客户、断收入，你爸后续的康复费谁出？你用金钱换了时间，也知道这是游牧人的宿命——你选择了世界，就必须承受世界离你最远的时候。',
      },
      {
        id: 'return_for_good',
        label: '飞回去，而且不走了',
        ...
        log: '{age}岁，你飞到医院，陪了你爸三个月。他出院那天你退掉了所有远程合同，在老家附近租了间房子。你妈以为你疯了——"你不是最喜欢到处跑吗？"你说"跑累了"。你没有完全放弃远程工作，但你不再追着签证和机票跑了。你花了二十年看世界，现在你想陪爸妈慢慢变老。自由是有保质期的，而有些东西过了就没了。',
      },
    ],
  },
  ...
  // 57岁：归途 —— 数字游牧民的黄昏
  {
    ...
    eventType: 'milestone',
    narrative:
      '你拖着行李箱，站在机场的到达层出口，忽然不知道要去哪。\n' +
      '这一辈子你把"家"活成了一个动词——清迈、巴厘岛、里斯本、墨西哥城。你换过几万张机票，住过几百间民宿，收藏过十几个时区的日出。你总说"哪里便宜哪里就是家"，你以此为荣。可今天，你刚落地，手机里存着三个常去城市的地址，却没有一个地方有人在等你回去。\n' +
      '你想起二十岁那年，你妈在机场送你，问你"什么时候回来"。你说"等我赚够钱就回来"。你赚够钱了，钱已经花不完了。可你忽然发现，你早就不记得"回来"到底要回到哪里了。你站在出口，风从四面八方吹过来，每一个方向都通往一个"家"，却一个都不是家。',
    options: [
      {
        id: 'nomad_legacy_settle',
        label: '回老家定居，把根重新种下',
        description: '你环游了世界，终于要回来做那个"游子回乡"的人',
        hint: '幸福+12 · 压力-10 · 信念-5',
        hintColor: 'positive',
        stateEffect: (s) => {
          s.happiness = clamp(s.happiness + 12, 0, 100);
          s.stress = clamp(s.stress - 10, 0, 100);
        ...
        log: '{age}岁，你拉着那个走遍世界的行李箱，回了老家。老房子还在，你妈前几年养老的院子也还留着过户的单据。你花了一个月把院子重新收拾好，种了你妈生前总念叨的那几棵桂花树。你开始在这里买菜、串门、和街坊邻居熟悉起来。你环游了大半个地球，最后在一方小小的院子里找到了"家"这个字的意思——不是地图上的坐标，是有人认得你、等你回来的地方。',
      },
      {
        id: 'nomad_legacy_keep',
        label: '继续漂，漂到走不动那天',
        description: '你生来就是一阵风，停在哪都是牢笼',
        hint: '信念+12 · 压力+8 · 幸福+3',
        hintColor: 'danger',
        stateEffect: (s) => {
          s.pathFaith = clamp(s.pathFaith + 12, 0, 100);
          s.stress = clamp(s.stress + 8, 0, 100);
        ...
        log: '{age}岁，你没有回头，订了下一班去南美的机票。你在飞机上打开笔记本，写下这些年走过的所有城市，又划掉了一些再也回不去的地方。你承认你不是找不到家，你是不敢停下来——停下来，那些追了你几十年的"不自由"就会追上你。你继续漂，像二十岁那样。只是现在你落地后不会再想去认识新朋友了，你会先找个地方，把老照片一张张传到一个加密的云端相册里——那是这些年，你唯一攒下的"不动产"。',
      },
      {
        id: 'nomad_legacy_write',
        label: '把游牧的一生写成一本书',
        description: '你走过的路，值得被记录下来',
        hint: '幸福+10 · 信念+8 · 存款+300000',
        hintColor: 'positive',
        ...
        log: '{age}岁，你在一座海边的城市租了间能看见灯塔的房子，开始写书。你写了那些时差里的凌晨、那些民宿老板送的热汤、那些你在异国独自跨年的夜晚、那些你终于明白"哪里都是家，哪里都不是家"的瞬间。书写完，出版社只印了一版，销量平平。但有个年轻人写信说"读你的书，我想去外面看看了"。你把这封信夹进书里。你忽然觉得，你的半生没有白跑——它成了别人出发的路牌。',
      },
    ],
  },

  // 50岁：签证与定居抉择（长期漂泊的可持续性）
  {
    id: 'nomad_late_settlement_choice',
    title: '五十岁，签证不等人',
    sceneTag: 'airport',
    pathId: 'digital_nomad',
    ageRange: [50, 50],
    ...
    narrative:
      '你五十了。这句话你自己说出来都愣了一下。\n\n' +
      '办登机牌的时候，柜员照例问你："这次打算待多久？"你照例报了个数字，心里却第一次算起了另一笔账：这几年你辗转的五六个游民基地，数字游民签证要么收紧、要么涨价、要么直接取消。你认识的老游民里，有人快五十还被卡在"最长停留90天"的循环里，拖着两个行李箱在机场过夜，像一只过了季的候鸟。\n\n' +
      '你想起二十多年前你引以为傲的那句话——"我的办公室是全世界"。现在你看着安检口黑压压的人群，忽然明白：办公室可以是全世界，但"签证"两个字，从没把你当自己人。\n\n' +
      '你今年五十了。身体的恢复能力在下降，签证的宽容度也在下降。你第一次认真地想：自由的下半场，是不是该换个玩法了？',
    options: [
      {
        id: 'settle_residency',
        label: '申请长期居留，把"路过"变成"落脚"',
        description: '在一个友好国家办养老金/投资居留，你的远程收入和存款够格',
        hint: '语言能力+8 · 跨文化+8 · 存款-50000 · 压力-10 · 健康+5 · 信念+6',
        hintColor: 'positive',
        skillGains: { languageSkill: 8, crossCulturalSkill: 8 },
        savingsChange: -50000,
        stateEffect: (s) => {
        ...
        log: '{age}岁，你把多年攒下的积蓄换成了一张长期居留卡。律师说你的远程收入和被动收入够格，只是流程要跑半年。你第一次在一个异国的官方文件上，看到自己的名字和一个固定的地址。你忽然理解了那些老游民说的"落脚"——不是投降，是终于允许自己不再把每一次入境都当成倒计时。',
        memorySet: { nomadSettledOverseas: true },
      },
      {
        id: 'return_domestic_base',
        label: '把大本营挪回国内，做"国内地理套利"',
        description: '用国际收入在国内低成本城市长住，签证烦恼清零',
        hint: '远程能力+6 · 跨文化+4 · 压力-8 · 幸福+8 · 存款+5000',
        hintColor: 'positive',
        skillGains: { remoteSkill: 6, crossCulturalSkill: 4 },
        savingsChange: 5000,
        stateEffect: (s) => {
          ensureSkills(s);
          s.stress = clamp(s.stress - 8, 0, 100);
        ...
        log: '{age}岁，你把大本营搬回了国。大理那间带院子的房子你早就看好了，国际收入够你过得体面，还能抽空陪陪日渐年迈的父母。你不再需要半夜查签证政策，不再需要为一个入境章买机票。你偶尔会想念里斯本的蛋挞和清迈的雨，但你知道：这次不是逃离，是选择。',
        isRestOption: true,
        memorySet: { nomadReturnedDomestic: true },
      },
      {
        id: 'keep_running_but_selective',
        label: '继续漂，但只去"善待游民"的地方',
        description: '筛选出对中年游民最友好的几个国家，把签证风险降到最低',
        hint: '跨文化+10 · 语言+6 · 压力+8 · 信念+8 · 存款-8000',
        hintColor: 'neutral',
        skillGains: { crossCulturalSkill: 10, languageSkill: 6 },
        savingsChange: -8000,
        stateEffect: (s) => {
        ...
        log: '{age}岁，你没停。你拉了一张表，把全球对中年游民最友好的国家列出来排了序——葡萄牙、日本、马来西亚、格鲁吉亚。你降低了对"新鲜感"的追求，提高了对"签证确定性"的要求。你承认自己老了，但你不承认自己输了。你在机场过夜的时候不再觉得浪漫，但你知道下一站的门，是开着的。',
      },
      {
        id: 'buy_golden_visa_invest',
        label: '用积蓄换一张"黄金签证"，把身份先定格',
        description: '你攒的钱够买一个投资居留——就当给这三十年漂流的自己一个交代',
        hint: '存款-80000 · 压力-12 · 幸福+10 · 跨文化+6 · 信念+5',
        hintColor: 'danger',
        prerequisites: (s) => s.branchMemory['choseEntrepreneur'],
        skillGains: { crossCulturalSkill: 6 },
        savingsChange: -80000,
        stateEffect: (s) => {
          ensureSkills(s);
        ...
        log: '{age}岁，你花一大笔钱买了一张投资居留身份。有人觉得你疯了，你却觉得这是你为自己买过最值的东西——不是房子，不是股票，是一个"你再也不用被劝返"的身份。你把它叫做"给三十年漂流的退休金"。你终于不用再回答"你打算待多久"，因为没有人能让你走。',
        memorySet: { nomadBoughtGoldenVisa: true },
      },
    ],
  },

  // 54岁：代际对话（家人的"什么时候回来"与游牧的和解）
  {
    id: 'nomad_late_generation_reconcile',
    title: '你什么时候回来',
    sceneTag: 'home',
    pathId: 'digital_nomad',
    ageRange: [54, 54],
    ...
    conditions: (s) => s.narrativeBranch !== 'unassigned' && s.isAllInPath === true,
    narrative:
      '视频电话那头，你妈问了一句老话："你什么时候回来？"\n\n' +
      '这句你从二十岁听到现在的话，这一次你认真想了想怎么回答。你爸前几年走了，你守了三个月灵，又回到了路上。你妈没有拦你，但在你要走的前一天晚上，她偷偷往你包里塞了一包家乡的茶叶，说"路上喝"。\n\n' +
      '视频那头，你弟弟家的孩子——你上次见TA还是小学，现在都上大学了——凑过来问："你一辈子都在外面跑，不累吗？你不会后悔吗？"\n\n' +
      '你被问住了。你想起这三十年：那些机场过夜的夜、那些独自跨年的酒、那些签证被拒的清晨、那些在异国急诊室独自签的字。你同时也想起那些日出、那些陌生人递来的热汤、那些你终于看懂一封外文合同时的踏实。\n\n' +
      '累吗？后悔吗？五十多岁的人，被一个二十岁的孩子问到哑口无言。你看着屏幕里一家人的脸，忽然觉得，也许这就是你该认真回答的时候了。',
    options: [
      {
        id: 'honest_no_but_price',
        label: '诚实回答：不后悔，但代价是真的',
        description: '把自由和孤独都摊开来，让年轻人自己判断',
        hint: '信念+10 · 幸福+8 · 跨文化+6 · 压力-6',
        hintColor: 'positive',
        skillGains: { crossCulturalSkill: 6 },
        stateEffect: (s) => {
          ensureSkills(s);
        ...
        log: '{age}岁，你对着镜头认真回答了那个孩子的问题。你说：不后悔，但代价是真的——你错过很多团圆，独自签过很多字，也曾在异国的深夜怀疑这条路是不是一条死路。二十岁的TA听完沉默了很久，说"原来不是网上说的那么光鲜"。你笑了。你花了三十年才敢承认：自由这件事很值得，但它真的有代价。',
        triggersRetirementCheck: true,
      },
      {
        id: 'pass_torch_to_nephew',
        label: '把游牧的经验教给下一代',
        description: '不劝TA上路，也不劝TA留下，只把路怎么走讲清楚',
        hint: '跨文化+8 · 语言+6 · 信念+10 · 幸福+10 · 被动收入+5000/年',
        hintColor: 'positive',
        skillGains: { crossCulturalSkill: 8, languageSkill: 6 },
        passiveIncomeChange: 5000,
        stateEffect: (s) => {
          ensureSkills(s);
          s.pathFaith = clamp(s.pathFaith + 10, 0, 100);
        ...
        log: '{age}岁，你第一次跟家里的孩子认真聊了聊你走过的路。你不劝TA出去，也不劝TA留下——你只是把签证、时差、客户的套路、异国的孤独，一条条讲清楚，像讲一门手艺。TA听完说"你好厉害"，你说"厉害不厉害是一回事，重要的是你自己想清楚要什么"。你忽然觉得，这些年你攒下的不是钱，是这些可以传下去的东西。',
        triggersRetirementCheck: true,
      },
      {
        id: 'admit_ready_settle',
        label: '承认吧，你累了，想回家了',
        description: '游牧三十年，你终于愿意把"回家"当成终点',
        hint: '幸福+12 · 压力-12 · 健康+6 · 信念-8',
        hintColor: 'positive',
        stateEffect: (s) => {
          ensureSkills(s);
          s.happiness = clamp(s.happiness + 12, 0, 100);
        ...
        log: '{age}岁，你对着镜头说了那句憋了三十年的话："我累了，想回家了。"你妈愣了一下，然后眼眶红了。你终于允许自己承认：自由是有保质期的，而有些东西——饭桌、团圆、脚踩在自己长大的土地上——过了三十年，还是比任何异国的夕阳都踏实。你订了回程的机票，不是"下一站"，是"回家"。',
        isRestOption: true,
        triggersRetirementCheck: true,
      },
      {
        id: 'make_family_reason_to_roam',
        label: '继续漂，但把每一次出发都连回家',
        description: '你发现漂着和牵挂家人并不冲突，你用飞行把两地缝在一起',
        hint: '跨文化+8 · 信念+8 · 压力+6 · 幸福+6 · 存款-10000',
        hintColor: 'neutral',
        prerequisites: (s) => s.branchMemory['choseEntrepreneur'],
        skillGains: { crossCulturalSkill: 8 },
        savingsChange: -10000,
        ...
        log: '{age}岁，你没停下来，但你改变了"漂"的含义。你不再是为了逃开什么出发，而是为了把世界的见闻带回家。你每年固定回去两次，老家那间房间你专门留着自己住，柜子里永远有你妈打包好的茶叶。你发现游牧和牵挂并不冲突——你只是把"家"从"一个地方"变成了"一条你反复飞过的航线"。',
        memorySet: { nomadFamilyAirline: true },
      },
    ],
  },
...
// ============================================================
// 40岁再分叉事件（nomad_midlife_rebranch）
// 参照 AI 路径：自由职业线/咨询线在中年可再选一次，创业线不重复触发
// ============================================================

const midlifeRebranchEvents: NarrativeEvent[] = [
  {
    id: 'nomad_midlife_rebranch',
    title: '四十，再选一次',
    sceneTag: 'home',
    pathId: 'digital_nomad',
    ageRange: [40, 40],
    ...
    oncePerGame: true,
    conditions: (s) =>
      s.narrativeBranch === 'nomad_freelancer' || s.narrativeBranch === 'nomad_consultant',
    narrative:
      '{age}岁这年，远程工作从人人眼红的灵活自由，进入了AI洗牌的残酷期。那些靠"会用工具"吃饭的远程岗位一个接一个被吞掉，真正活下来的反而是扎进特定领域、靠经验和判断力吃饭的人。你在这条路上走了十五年，护照贴满了签证，客户名单越来越短却越来越贵——但深夜你躺在陌生城市的酒店床上，还是会问自己同一个问题：\n' +
      '我还在过我想过的生活吗？还是只是惯性替我把路走完了？\n' +
      '这不是二十多岁那种"下一单在哪里"的焦虑，而是"我明明还有选择"的清醒。你知道自己累了，但你没认输。你只是模糊地感觉到：四十岁不是终点，是另一条路的街角。你站在这里，还能再选一次——不是从零开始，是带着这十五年捡来的所有东西，重新出发。',
    options: [
      {
        id: 'nomad_deepen_path',
        label: '不换了，把这条路走穿',
        description: '你的积累已经足够深，继续把它凿到别人够不到的地方',
        hint: '信念+12 · 幸福+8 · 压力-4 · 相关技能+8',
        hintColor: 'positive',
        memorySet: { reinforcedNomadPath: true },
        stateEffect: (s) => {
          s.pathFaith = clamp(s.pathFaith + 12, 0, 100);
          s.happiness = clamp(s.happiness + 8, 0, 100);
          s.stress = clamp(s.stress - 4, 0, 100);
          ...
          ensureSkills(s);
          if (branch === 'nomad_freelancer') {
            s.pathSkills['remoteSkill'] = Math.min(100, (s.pathSkills['remoteSkill'] || 0) + 8);
          } else if (branch === 'nomad_consultant') {
            s.pathSkills['languageSkill'] = Math.min(100, (s.pathSkills['languageSkill'] || 0) + 8);
            s.pathSkills['crossCulturalSkill'] = Math.min(100, (s.pathSkills['crossCulturalSkill'] || 0) + 8);
          }
        },
        log: '{age}岁，你没换方向。不是不敢，是你想明白了——你在这条路上攒下的技能、客户和世界经验，不是别人轻易能偷走的。你关掉那些"转行"的念头，把十五年的积累又往下凿了一层。浪退了，你才发现自己从没被冲走，你一直站在礁石上。',
      },
      {
        id: 'nomad_switch_to_entrepreneur',
        label: '下场做产品，自己搏一个全球生意',
        description: '技能/经验你都攒够了，是时候把它变成属于自己的东西',
        hint: '积蓄-50000 · 压力+15 · 信念+8 · 切换至创业线',
        hintColor: 'danger',
        savingsChange: -50000,
        branchSwitch: 'nomad_entrepreneur',
        memorySet: { switchedToEntrepreneurMid: true },
        stateEffect: (s) => {
          ensureSkills(s);
          s.stress = clamp(s.stress + 15, 0, 100);
          s.pathFaith = clamp(s.pathFaith + 8, 0, 100);
          s.happiness = clamp(s.happiness + 6, 0, 100);
          s.pathSkills['crossCulturalSkill'] = Math.min(100, (s.pathSkills['crossCulturalSkill'] || 0) + 6);
        },
        log: '{age}岁，你决定自己下场。过去你帮别人做项目、替别人搭桥，现在轮到你了。你注册了公司，把攒了十几年的认知和资源全押进去。办公室就是你的行李箱，你在机场候机厅开了第一场产品会。你比25岁那次更平静——那一次是赌，这一次是算。',
      },
      {
        id: 'nomad_switch_to_freelancer',
        label: '收回锋芒，把技能扎得更深',
        description: '台前谈得累了，你想回到那个"一单一单做扎实"的幕后',
        hint: '远程能力+8 · 压力+8 · 信念+6 · 切换至自由职业线',
        hintColor: 'neutral',
        skillGains: { remoteSkill: 8 },
        branchSwitch: 'nomad_freelancer',
        memorySet: { switchedToFreelancerMid: true },
        stateEffect: (s) => {
          ensureSkills(s);
          s.stress = clamp(s.stress + 8, 0, 100);
          s.pathFaith = clamp(s.pathFaith + 6, 0, 100);
        },
        log: '{age}岁，你收回了聚光灯下的锋芒，决定回到那个一单一单做扎实的幕后。那些年你谈了太多客户、飞了太多城市，忽然想沉下心，把一件事做到别人啃不动为止。你开始啃那些真正难啃的特性——不是因为你怕被淘汰，是你终于想通：临时的案子和谈下来的生意都会过时，但扎进骨头里的手艺不会。',
      },
      {
        id: 'nomad_switch_to_consultant',
        label: '把积累变成高客单价的桥梁',
        description: '你比多数人更懂跨国生意，也更能讲清楚——那就让更多人听你讲',
        hint: '语言+10 · 跨文化+8 · 被动收入+6000/年 · 压力+6 · 切换至咨询线',
        hintColor: 'positive',
        skillGains: { languageSkill: 10, crossCulturalSkill: 8 },
        passiveIncomeChange: 6000,
        branchSwitch: 'nomad_consultant',
        memorySet: { switchedToConsultantMid: true },
        stateEffect: (s) => {
          ensureSkills(s);
          s.stress = clamp(s.stress + 6, 0, 100);
          s.pathFaith = clamp(s.pathFaith + 8, 0, 100);
        },
        log: '{age}岁，你决定不再只做那个"干活的人"，而要成为那个"让跨国生意更顺畅的人"。你开始系统性地输出——不是二十多岁那种掏经验的分享，是带着十五年踩过的坑写出来的东西。报价比那时高了三倍，但每一单都有人排着队等。你发现当你的判断有了分量，钱和影响力会自己找上门。',
      },
    ],
  },
];
...
// ============================================================
// 分支记忆回声事件（nomad 42-44岁，后期"翻旧账"，形成叙事闭环）
// ============================================================

const nomadEchoEvents: NarrativeEvent[] = [

  // 42岁：当年一起出发的游民伙伴
  {
    id: 'nomad_echo_old_nomad',
    title: '老驴友',
    sceneTag: 'home',
    pathId: 'digital_nomad',
    ageRange: [42, 42],
    priority: 6,
    oncePerGame: true,
    memoryAnyOf: ['choseFreelancer', 'choseEntrepreneur', 'choseConsultant'],
    narrative:
      '你刷到一条动态：当年那个在清迈和你一起住青年旅舍、共用一台电脑抢单的"老驴友"，现在定居在了里斯本，做起了远程团队教练。照片里他还是那副随时要出发的样子，但鬓角白了，身后多了两个小孩。\n' +
      '你们已经很久没联系了。你盯着那张照片，忽然想起：当年如果不是他拉你进那个游民社群，你可能现在还困在格子间里。你打开聊天框，光标闪了很久。',
    options: [
      {
        id: 'nomad_reach_out_old_nomad',
        label: '发条消息，约个线上咖啡',
        description: '有些过命的交情，不该只活在朋友圈里',
        hint: '幸福+8 · 压力-5 · 存款-1000',
        hintColor: 'positive',
        savingsChange: -1000,
        stateEffect: (s) => {
          s.happiness = clamp(s.happiness + 8, 0, 100);
        ...
        log: '你给他发了条消息，他秒回："我还以为你把我忘了。"你们约了线上咖啡，跨着时差，他那边是清晨，你这边是深夜。聊到他那边的太阳升起，他问你当年要是没一起出发会怎样，你笑着说"那我可能还在那间格子间里"。他举杯："那你就错过了整个世界。"两个不再年轻的人，在屏幕两端笑得跟二十年前一样。',
      },
      {
        id: 'nomad_watch_quietly',
        label: '看看就好，不打扰',
        ...
        log: '你点了个赞，关掉了动态。你们已经很久没联系了，但你知道他过得很好，他也知道你在自己的路上走得不错。成年人的友谊有时候就是这样——不打扰，但心里一直有那个位置。你把手机放进口袋，继续整理下一程的行李。',
      },
    ],
  },
  ...
  // 43岁：那扇没推开的门
  {
    ...
    memoryAnyOf: ['choseFreelancer', 'choseEntrepreneur', 'choseConsultant'],
    narrative:
      '深夜在陌生城市的机场转机，你买了一本杂志，封面是某个你研究了很久、最后没做的市场。你翻到那篇报道，里面的机会，和你十五年前评估过的一模一样——只是现在，它已经被人做成了。\n' +
      '你盯着那页纸看了很久。十五年前你面前有过这么一扇门，你犹豫过，最后没推开。你从不后悔自己的选择——你现在的路也很好。只是偶尔，在这样安静的深夜，你会好奇门后面的那条路，会把你带到哪里。你合上杂志，不是留恋，是想知道，那个平行的自己，过得好不好。',
    options: [
      {
        id: 'nomad_close_forever',
        label: '合上杂志，回到自己的路',
        ...
        log: '你把杂志放回座位，望向机舱外的夜空。这扇门你已经看了十五年，该合上了。飞机平稳前行，你打开自己的笔记本，那里有你的客户、你的路线、你亲手选的人生。你不再回望——不是不想，是终于明白，每条路都有它独一无二的风景。',
      },
      {
        id: 'nomad_open_again',
        label: '顺着记忆，重新研究那个市场',
        ...
        log: '你花了一个月把当年那个市场重新研究了一遍。它已经不再是当年的样子了——但你的判断力也不再是十五年前的样子。你买了去那个国家的机票。你四十多岁了，本该求稳，可你发现，当你真的想推开一扇门的时候，你依然会心跳加速。你决定去看看——不是逃回过去，是带着这半生的重量，去补一个当年没舍得做的梦。',
      },
    ],
  },
  ...
  // 44岁：换过航向的人
  {
    ...
    narrative:
      '整理旧云盘时，你翻到一份十五年前的提案。那是你刚入行时给一个客户写的，措辞生涩、报价保守，满是没经历过世界的人才有的谨慎。你忽然想起自己换过多少次方向——从一单一单的自由职业，到下场创业，再到转身做咨询，又或者反着来。\n' +
      '外人看你，是一个"一直在路上"的人。只有你知道，你其实一直在换路，只是一次比一次更笃定。那些曾让你彻夜难眠的"错误选择"，回头看都成了下一个路口的路标。你保存好那份旧提案，像保存一枚旧徽章。不是遗憾，是纪念——纪念那个愿意一次次重新出发的自己。',
    options: [
      {
        id: 'nomad_accept_own_path',
        label: '坦然接受，这就是我的人生',
        ...
        log: '你关掉旧提案，给自己倒了杯茶。窗外是某个城市的黄昏，你就着夕阳想：你换过路，绕过远，走过别人觉得"浪费"的弯路——但正是那些弯路，让你在四十岁的时候，比那些从未出过门的人，更清楚自己想去哪。你吹了吹茶上的热气。这条路是你自己绕出来的，每一段都算数。',
      },
      {
        id: 'nomad_share_winding_path',
        label: '把换路的经验讲给年轻游民听',
        description: '你的弯路，是别人最好的路灯',
        hint: '幸福+8 · 跨文化+4 · 被动收入+4000/年 · 压力+3',
        hintColor: 'positive',
        skillGains: { crossCulturalSkill: 4 },
        passiveIncomeChange: 4000,
        stateEffect: (s) => {
        ...
        log: '你受邀在一个游民社群里分享自己换路的心路。你讲了那些绕过的弯、吃过的亏、推翻重来的决定。讲完弹幕刷了满满一屏。散场后一个刚出国的年轻人红着眼眶说："谢谢你，我正纠结要不要辞职。"你拍拍他的肩："换不换都对，只要别骗自己。"你忽然觉得，你这半生的蜿蜒，原来也可以成为别人的坦途。',
      },
    ],
  },
];
