...
export const STORYBOARD_SCENES: StoryboardScene[] = [
  ...
  { id: 'buy-house', category: 'family', name: '买房', keywords: ['交房','装修','搬进新家','房产证','买房了','签完那叠厚厚的贷款合同','钥匙冰凉','自己的几十平米','有你一盏灯','房贷合同','贷款合同','买了房','买一套房','买了一套','还房贷','交房贷','房贷月供','二套房','第二套房','买了第二套房','买商铺','自己的房子','自己的阳台','签了一套小户型','总价50万','交了首付','付了首付','首付交了','首付付了','背上房贷','房贷压力'], palette: FAMILY_PALETTE, frames: sceneBuyHouse(), frameDelay: 200, animIn: 'fade', priority: 10 },
  ...
  { id: 'parent-sick', category: 'family', name: '父母生病', keywords: ['父母生病','父亲生病','母亲生病','爸妈住院','家人重病','陪床','爸住院','妈住院','父亲住院','母亲住院','陪床守夜','医院走廊','父亲走了','母亲走了','爸走了','妈走了','病逝','病危','心梗','离世','120','带爸妈去医院','你爸突然','你妈突然','你爸躺在病床上','你妈躺在病床上','父母背影','爸拍照手抖','妈笑得像个孩子','血压计','买了新的血压计','葬礼','子欲养','护理床','换胃管','翻身拍背','没能留住','父亲接回了家','守着他','电话那头传来父亲住院','连夜赶回','病床上缩小的身影','李爷爷','陈爷爷','张奶奶','照顾老人','卧床','康复操','端碗','康复训练','护理手册','操作规范','鼻饲','胰腺癌晚期','疼得整夜','走的时候很安静','睡梦中走的','没受罪','白头发不少了','老年','临终关怀','安宁疗护','永远失去了','至亲','不再温暖的手','走廊里的白光','握着那双','喉咙像被堵住','ICU外的长椅','爸查出','妈查出','你爸住院','你妈住院'], palette: FAMILY_PALETTE, frames: sceneParentSick(), frameDelay: 400, animIn: 'fade', priority: 9 },
  ...
  { id: 'sick', category: 'life', name: '生病', keywords: ['生病','发烧','感冒','卧病在床','病倒','请病假','生病卧床','医药费','生病住院','吃药','膏药','降压药','膝盖疼','眼药水','挂号','药店','咳嗽','胃疼','头疼','腰酸','背痛','肩膀疼','手腕疼','干眼症','关节痛','酸痛','腰疼','扭伤','腰酸背痛','不舒服','食物中毒','打点滴','躺在病床上','上吐下泻','腰椎间盘','腰突','理疗','天旋地转','眼前一黑','救护车','脑梗','病床上','躺在异国','偏头痛','心悸','挂了急诊','过度刺激','诊断书','自费部分','营养费','误工费','感冒把你按在床上','医药费像水','保费','保险','退保','交保费','重疾险','身体发出警告','心脏检查异常','心肌梗死','追悼会','去世','享年','离开了','颈椎病犯了','脱发严重','血压高','血脂高','脂肪肝','膝盖受伤','腰疼得'], palette: LIFE_PALETTE, frames: sceneSick(), frameDelay: 400, animIn: 'fade', priority: 8 },
  // ===== 路径专属场景（priority: 6-9）=====
  ...
  { id: 'research', category: 'career', name: '科研实验', keywords: ['实验室','做实验','实验数据','N=1实验','自体实验','临床试验','一期临床','二期临床','三期临床','双盲试验','安慰剂','分析数据','血检','抽血','送检','检测','指标','炎症因子','自噬','端粒','表观遗传','线粒体','干细胞','衰老细胞','雷帕霉素','NMN','NAD+','白藜芦醇','达沙替尼','非瑟酮','槲皮素','多肽','基因疗法','基因重编程','CGM','心率变异性','生物标记','生理年龄','生物黑客','生物科技','长寿研究','衰老研究','课题组PI','课题组','组会','论文发表','作者列表','ORCID','学术','科研','科学家','研究者','研究团队','协作网络','国际协作','样本','质控','预印本','文献','读文献','查文献','ELISA','质谱','p值','效应量','小鼠实验','动物实验','细胞','基因','蛋白质','临床数据','受试者','剂量','药物','补剂分装','药盒','药瓶','药片','服用补剂','监测','抽血的日子','日历上标满了抽血','公开文档','N=1','数据清洗','数据分析','统计','显著性','对照组','科研实验','生物研究','实验室里','做实验'], palette: CAREER_PALETTE, frames: sceneWork(), frameDelay: 350, animIn: 'fade', priority: 6 },
  { id: 'coding', category: 'career', name: '编程开发', keywords: ['编程','写代码','敲代码','coding','debug','调试','代码重构','重构了','技术栈','部署','产品上线','服务器','后端','前端','AI模型','大模型','LLM','GPT','Transformer','微调','fine-tune','prompt工程','提示词','量化','INT8','推理加速','延迟','P99','缓存','框架','开源社区','开源项目','开源了','GitHub','GitHub star','star冲到','PR','commit','代码审查','代码审核','code review','技术周会','技术分享','技术方案','系统设计','写测试','测试代码','单元测试','集成测试','智能合约','Solidity','合约部署','合约审计','漏洞赏金','黑客松','MVP','产品迭代','v1','v2','v3','用户增长','留存率','付费墙','转化率','裂变','SOP','自动化工具','AI自动化','AI工具','AI代码审查工具','技术博客','技术教程','AI教程','量化模型','模型优化','工程优化','绞杀者模式','旧系统替换','技术管理','Individual Contributor','带团队','CTO','技术顾问','股份','顾问费','架构师','资深工程师','代码把键盘','脸印着按键','趴在键盘上','逐行拆解','画流程图','开源了一个自己写的','技术直觉','系统一块一块地替换','加了一层缓存','把模型量化','引入了推理加速框架','把文案生成质量做到了','微调+prompt工程','系统架构','技术架构','架构设计','写什么代码','AI产品','跑着你的AI产品','写代码到凌晨','业余时间投入开源','贡献者变成owner'], palette: CAREER_PALETTE, frames: sceneWork(), frameDelay: 250, animIn: 'fade', priority: 7, requires: { employed: true } },
  ...
  { id: 'work', category: 'career', name: '工作', keywords: ['上班','搬砖','打工','开干','干活','到公司','工位','在办公室','办公室里','工牌','下班','打卡','社畜','周报','KPI','赶需求','改bug','商务对接','汇报工作','工位上','办公桌','远程工作','在公司','会议室','自由职业','接一些小活','接单','处理邮件','回邮件','搞AI','AI工具','晚上搞副业','朝九晚五','写脚本','拍视频','剪视频','商务合作','续约','完播率','互动率','写提案','做顾问','共享空间','在任何地方都能做','和AI共舞','提示词方法论','交付周期','SaaS','订阅收入','MRR突破','ARR','独立开发者','出海','跨境咨询','地理套利','Notion','Zapier','异步沟通','远程助理','雇人','公司运营','签合同','项目报价','商务报价','proposal','交付物','咨询公司','德勤','排他协议','限时排他','差异化定位','商业咨询','知识变现','独立产品','一人公司','小而美','盈亏平衡','月流水','上班第一天','新工作','入职'], palette: CAREER_PALETTE, frames: sceneWork(), frameDelay: 300, animIn: 'fade', priority: 4, requires: { employed: true } },
  ...
  { id: 'read', category: 'life', name: '看书', keywords: ['看书','读书','阅读','翻书','书架','图书馆','借书','每天花两小时看书','下午看书','公交上看书','学画画','学弹琴','学烘焙','学泰语','学语言','读了三十多份白皮书','花一周研究到通透','衰老科学公开课','研究透','椭圆曲线加密','零知识证明','共识机制','状态通道','看书看了一下午','坐在沙发看书','窝在沙发看书','看书看到','翻开书','合上书','读书笔记','读到一本','在看书'], palette: LIFE_PALETTE, frames: sceneRead(), frameDelay: 400, animIn: 'fade', priority: 3 },
  ...
  { id: 'eat', category: 'family', name: '吃饭', keywords: ['吃饭','吃晚饭','吃饭了','用餐','晚饭','吃火锅','早餐','午饭','点外卖','送外卖','吃外卖','聚餐','饭局','一个人吃饭','下馆子','宵夜','吃米线','吃东西','一起吃','吃了一碗面','筷子没停过','喝了两杯酒','出来吃挺好','做了顿','煮了碗面','方便面','吃到第15天','吃夜宵','食堂吃饭'], palette: FAMILY_PALETTE, frames: sceneEat(), frameDelay: 300, animIn: 'fade', priority: 3 },
