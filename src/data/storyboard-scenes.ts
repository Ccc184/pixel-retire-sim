...
export const STORYBOARD_SCENES: StoryboardScene[] = [
  // ===== 里程碑事件（priority: 10）=====
  { id: 'retire', category: 'career', name: '退休', keywords: ['真的退休了','决定退休','正式退休了','你决定退休了','告别职场','退休手续','清理办公桌','荣休','你要退休。这笔钱够你','退休了。不是因为你做完了','不工作活一辈子','提前退休手续','办退休','退休手续办好了','彻底退休','享受退休','你退休了','你正式退休了','光荣退休'], palette: CAREER_PALETTE, frames: sceneRetire(), frameDelay: 200, animIn: 'pop', priority: 10, requires: { minAge: 40 } },
  ...
  { id: 'marry', category: 'family', name: '结婚', keywords: ['求婚','领证','领了证','娶','嫁','我们结婚了','订婚','办婚礼','娶了','嫁了','结婚了','婚礼上','两个人的日子','单膝跪地','嫁给我吧','准备了戒指','掏出了戒指','我愿意','你怎么才问','第一次约会的地方','结婚纪念日','跨年夜烟花','看日出','结婚证','登记','拍登记照','彩礼','婚礼上你看着','你和TA结婚了','你们结婚了','娶你','嫁给你','结婚吧'], palette: FAMILY_PALETTE, frames: sceneWedding(), frameDelay: 200, animIn: 'pop', priority: 10, requires: { dating: true, married: false } },
  ...
  { id: 'buy-car', category: 'life', name: '买车', keywords: ['买车','提车','新车','第一辆车','喜提','提回一辆','开回一辆','提了一辆','轿车落地','代步车','买了经济代步车','买了中级轿车','买了豪车','开走B级车','买车了','第一次开车','自己开车','关上车门','4S店','二手车','把车卖了','卖了车','手里多了一笔现金','试驾','订车'], palette: LIFE_PALETTE, frames: sceneBuyCar(), frameDelay: 200, animIn: 'slide', priority: 10 },
  { id: 'promotion', category: 'career', name: '升职加薪', keywords: ['升职','加薪','晋升','提拔','升值','涨薪','涨工资','带项目','项目你来带','升职了','加了薪','推广给全部门','X总','给护理员涨工资','主动提出续约','提拔你','升你为主管','成为部门负责人','升了职','提拔为','晋升为'], palette: CAREER_PALETTE, frames: scenePromotion(), frameDelay: 180, animIn: 'bounce', priority: 10, requires: { employed: true } },
  ...
  { id: 'sunset', category: 'life', name: '夕阳晚年', keywords: ['晚年','白头偕老','一起变老','黄昏恋','暮年','白发苍苍','老花镜','上了年纪','爬楼喘气','含饴弄孙','颐养天年','敬老院','养老院','养老站','陪老人聊天','做义工','张奶奶','老年生活','像退休老头','像退休老太太','活得像退休','老年活动','快乐不分年龄','公办养老院','回头看这半生','与生活和解','负重下呼吸','承认自己的普通','还站在这里','剩下的路','慢慢走','写回忆录','翻到二十岁写的日记','那个二十岁的你','旧日记','写信给自己','给22岁的自己','回一封信','不惑','知天命','耳顺','六十岁','古来稀','白发越来越多','看我这辈子最对的决定'], palette: LIFE_PALETTE, frames: sceneSunset(), frameDelay: 500, animIn: 'fade', priority: 7, requires: { minAge: 50 } },
