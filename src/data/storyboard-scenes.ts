...
export const STORYBOARD_SCENES: StoryboardScene[] = [
  ...
  { id: 'marry', category: 'family', name: '结婚', keywords: ['结婚','婚礼','求婚','领证','领了证','娶','嫁','我们结婚了','订婚','办婚礼','娶了','嫁了','结婚了','去参加婚礼','包了红包','随了红包','婚礼上','两个人的日子','单膝跪地','嫁给我吧','准备了戒指','掏出了戒指','我愿意','你怎么才问','第一次约会的地方','结婚纪念日','跨年夜烟花','看日出','结婚证','登记','拍登记照','彩礼'], palette: FAMILY_PALETTE, frames: sceneWedding(), frameDelay: 200, animIn: 'pop', priority: 10, requires: { dating: true } },
  ...
  { id: 'buy-house', category: 'family', name: '买房', keywords: ['买房','交房','装修','搬进新家','房产证','买房了','签完那叠厚厚的贷款合同','钥匙冰凉','自己的几十平米','有你一盏灯','房贷合同','贷款合同','买了房','买一套房','买了一套','房贷','月供','还房贷','交房贷','房贷月供','二套房','第二套房','买了第二套房','商铺','买商铺','自己的房子','自己的阳台','买房前','房价跌了','小区的挂牌价','签了一套小户型','总价50万','首付'], palette: FAMILY_PALETTE, frames: sceneBuyHouse(), frameDelay: 200, animIn: 'fade', priority: 10 },
  { id: 'buy-car', category: 'life', name: '买车', keywords: ['买车','提车','新车','第一辆车','喜提','提回一辆','开回一辆','提了一辆','轿车落地','代步车','买了经济代步车','买了中级轿车','买了豪车','开走B级车','买车了','修车','停车费','车被蹭','划痕','开车上班','第一次开车','自己开车','关上车门','4S店','挡风玻璃','二手车','油钱','保险','保养','车停','开车带','车的本分','高架桥','把车开上','有车真好','把车卖了','卖了车','手里多了一笔现金'], palette: LIFE_PALETTE, frames: sceneBuyCar(), frameDelay: 200, animIn: 'slide', priority: 10 },
  ...
  { id: 'date', category: 'family', name: '约会', keywords: ['约会','恋爱','表白','第一次约会','在一起','烛光晚餐','找对象','对象','伴侣','脱单','谈恋爱','女朋友','男朋友','鼓起勇气表白','表白了','我也是','只把你当朋友','让我再想想','精心准备的惊喜','礼物','微醺','哼着歌','认识了一个人','缘分','社交软件','认识了一些有趣的人','加了几个社交软件','一起健身','一起吃饭','一起骂','TA说','TA没说话','回家的时候你微醺','准备了惊喜','给TA准备','TA笑了','那个笑容','新朋友','聚会上认识','新来的同事','对视','聊了一整晚','心跳漏了一拍','交换了联系方式','正式约会','暧昧','正式在一起了','见了父母','见家长','带你见了ta的父母','见了ta的父母','手心全是汗','紧紧握着你的手','我表现怎么样','加个社交软件','撑伞送你','故意选了同一个时间','聊了整整','你发现自己在笑','心跳','脸红','心动','约会了','一起看电影','约你周末','想和这个人过一辈子','介绍给了ta所有的朋友','第一次一起旅行'], palette: FAMILY_PALETTE, frames: sceneDate(), frameDelay: 300, animIn: 'fade', priority: 8 },
  ...
  { id: 'work', category: 'career', name: '工作', keywords: ['上班','搬砖','打工','开干','干活','到公司','工位','办公室','工牌','领导','老板','同事','下班','打卡','开会','项目','需求','社畜','周报','KPI','赶需求','改bug','写代码','对接','汇报','工位上','办公桌','副业收入','远程工作','产品发布','服务器','在公司','主管','主管说','会议室','新人','带新人','自由职业','数字游民','远程收入','接一些小活','接单','客户','档期','处理邮件','回邮件','产品被','科技自媒体','报道','创始人','搞AI','AI工具','副业','搞副业','晚上搞副业','摆摊','卖烤肠','朝九晚五','不用担惊受怕','考公','公务员','写脚本','拍视频','剪视频','商务','合作','续约','品牌方','自媒体','涨粉','掉粉','粉丝','内容','算法','流量','IP','社群','网暴','完播率','互动率','平台','创作者','博主','up主','写提案','区政府开会','提案通过','做顾问','咨询费','共享空间','在任何地方都能做','AI模型','提示词','指令遵循','和AI共舞','AI提效大赛','提示词方法论','交付周期','开源项目','远程工作','自由职业','咨询','SaaS','订阅收入','MRR','ARR','产品','用户','增长','变现','独立开发者','出海','跨境','地理套利','Notion','Zapier','异步沟通','远程助理','雇人','团队','管理','SOP','公司运营','签合同','报价','时薪','proposal','交付物','咨询公司','德勤','背书','排他协议','限时排他','差异化定位','商业咨询','知识变现','独立产品','一人公司','小而美','盈亏平衡','月流水','付费墙','转化率','裂变'], palette: CAREER_PALETTE, frames: sceneWork(), frameDelay: 300, animIn: 'fade', priority: 7, requires: { employed: true } },
  ...
  { id: 'sunset', category: 'life', name: '夕阳晚年', keywords: ['夕阳','晚年','老了','白头偕老','一起变老','黄昏恋','暮年','白发苍苍','老花镜','上了年纪','老头','老太太','爬楼喘气','含饴弄孙','颐养天年','养老','敬老院','看日落','养老院','养老站','陪老人聊天','做义工','义工','张奶奶','护理员','老人','爷爷奶奶','老年生活','养生','打太极','返聘','退休后反而','陪老人','像我孙子','老年活动','快乐不分年龄','公办养老院','三十岁','四十岁','五十岁','三十岁了','四十岁了','五十岁了','反思','回顾','回头看','与生活和解','负重下呼吸','承认自己','还站在这里','剩下的路','不再追了','不再等了','慢慢走','写回忆录','翻到二十岁写的日记','那个二十岁的你','旧日记','写信给自己','给22岁的自己','回一封信','人生节点','里程碑','不惑','知天命'], palette: LIFE_PALETTE, frames: sceneSunset(), frameDelay: 500, animIn: 'fade', priority: 7, requires: { minAge: 50 } },
