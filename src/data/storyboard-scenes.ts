...
export const STORYBOARD_SCENES: StoryboardScene[] = [
  ...
  { id: 'marry', category: 'family', name: '结婚', keywords: ['结婚','婚礼','求婚','领证','领了证','娶','嫁','我们结婚了','订婚','办婚礼','娶了','嫁了','结婚了','去参加婚礼','包了红包','随了红包','婚礼上','两个人的日子'], palette: FAMILY_PALETTE, frames: sceneWedding(), frameDelay: 200, animIn: 'pop', priority: 10, requires: { dating: true } },
