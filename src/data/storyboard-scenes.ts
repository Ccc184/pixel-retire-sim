...
export const STORYBOARD_SCENES: StoryboardScene[] = [
  ...
  { id: 'marry', category: 'family', name: '结婚', keywords: ['求婚','领证','领了证','娶','嫁','我们结婚了','订婚','办婚礼','娶了','嫁了','两个人的日子','单膝跪地','嫁给我吧','准备了戒指','掏出了戒指','我愿意','你怎么才问','第一次约会的地方','跨年夜烟花','看日出','结婚证','登记','拍登记照','彩礼','婚礼上你看着','你和TA结婚了','你们结婚了','娶你','嫁给你','结婚吧','你结婚了','就结婚了'], palette: FAMILY_PALETTE, frames: sceneWedding(), frameDelay: 200, animIn: 'pop', priority: 10, requires: { dating: true, married: false } },
