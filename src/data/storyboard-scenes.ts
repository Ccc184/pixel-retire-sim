...
export const STORYBOARD_SCENES: StoryboardScene[] = [
  // ===== 里程碑事件（priority: 10）=====
  { id: 'retire', category: 'career', name: '退休', keywords: ['退休','荣休','退休金','退休生活','告别职场','退休手续','退休倒计时','清理办公桌','退休计划','养老金','返聘','退休规划','退休规划师','退休后','真的退休了'], palette: CAREER_PALETTE, frames: sceneRetire(), frameDelay: 200, animIn: 'pop', priority: 10, requires: { minAge: 40 } },
  { id: 'graduate', category: 'life', name: '毕业', keywords: ['毕业','大学毕业','毕业典礼','毕业证','学位','MBA','学位证','硕士','毕业证拿到','拿到学位证'], palette: LIFE_PALETTE, frames: sceneGraduate(), frameDelay: 200, animIn: 'bounce', priority: 10, requires: { maxAge: 30 } },
  { id: 'first-job', category: 'career', name: '入职', keywords: ['入职','第一天上班','新工作','报到','初入职场','入职第一天','崭新的工牌','职业生涯','正式开局','正式入职','走进写字楼','成为自由职业者','成为全职骑手','开始摆摊','考公考上了','公示名单','朝九晚五'], palette: CAREER_PALETTE, frames: sceneFirstJob(), frameDelay: 300, animIn: 'fade', priority: 10 },
  { id: 'first-salary', category: 'career', name: '第一笔工资', keywords: ['第一笔工资','第一份薪水','发工资','领到工资','工资到账','工资条','固定工资','工资入账','月薪'], palette: CAREER_PALETTE, frames: sceneFirstSalary(), frameDelay: 180, animIn: 'bounce', priority: 10 },
  { id: 'marry', category: 'family', name: '结婚', keywords: ['结婚','婚礼','求婚','领证','娶','嫁','我们结婚了','订婚','办婚礼','娶了','嫁了','结婚了','去参加婚礼','包了红包','随了红包','婚礼上'], palette: FAMILY_PALETTE, frames: sceneWedding(), frameDelay: 200, animIn: 'pop', priority: 10, requires: { dating: true } },
  { id: 'baby', category: 'family', name: '生子', keywords: ['宝宝出生','生孩子','当爸','当妈','新生儿','婴儿','出生','怀孕','二胎','当爸爸','当妈妈','孩子出生','喜得贵子','喜得千金','第一次叫出','叫爸爸','叫妈妈','孩子第一次叫','一声啼哭'], palette: FAMILY_PALETTE, frames: sceneBaby(), frameDelay: 200, animIn: 'bounce', priority: 10, requires: { married: true } },
  { id: 'buy-house', category: 'family', name: '买房', keywords: ['买房','交房','装修','搬进新家','房产证','买房了','签完那叠厚厚的贷款合同','钥匙冰凉','自己的几十平米','有你一盏灯','房贷合同','贷款合同','买了房','买一套房','房贷','月供','还房贷','交房贷','房贷月供','二套房','第二套房','买了第二套房','商铺','买商铺','自己的房子','自己的阳台','买房前','房价跌了','小区的挂牌价','签了一套小户型','总价50万','首付'], palette: FAMILY_PALETTE, frames: sceneBuyHouse(), frameDelay: 200, animIn: 'fade', priority: 10 },
  { id: 'buy-car', category: 'life', name: '买车', keywords: ['买车','提车','新车','第一辆车','喜提','提回一辆','开回一辆','提了一辆','轿车落地','代步车','买了经济代步车','买了中级轿车','买了豪车','开走B级车','买车了','修车','停车费','车被蹭','划痕','开车上班','第一次开车','自己开车','关上车门','4S店','挡风玻璃','二手车','油钱','保险','保养','车停','开车带','车的本分','高架桥','把车开上','有车真好'], palette: LIFE_PALETTE, frames: sceneBuyCar(), frameDelay: 200, animIn: 'slide', priority: 10 },
  { id: 'promotion', category: 'career', name: '升职加薪', keywords: ['升职','加薪','晋升','提拔','升值','涨薪','涨工资','带项目','项目你来带','薪资','工资条','薪资比之前高','拿到融资','天使轮','登顶榜单','掌声雷动','十万关注','升职了','加了薪','推广给全部门','X总','涨工资','给护理员涨工资','主动提出续约'], palette: CAREER_PALETTE, frames: scenePromotion(), frameDelay: 180, animIn: 'bounce', priority: 10, requires: { employed: true } },
  ...
  { id: 'startup', category: 'career', name: '创业', keywords: ['创业','开公司','下海','合伙创业','创业项目','创业了','创业公司','拉你入伙','合伙人','风投','All In','辞职全力','递了辞职信','全职投入','买那张单程票','递交了辞职信','共享办公室','MRR','被并购','公司被收购','分到了八百万','自己当老板','庆功宴','公司被收购','拿到八十万','创业很苦','活了下来','小股东','投了一万块','没辞职','庆功宴上'], palette: CAREER_PALETTE, frames: sceneStartup(), frameDelay: 250, animIn: 'fade', priority: 10 },
  ...
  { id: 'fire', category: 'life', name: '财务自由', keywords: ['FIRE','财务自由','提前退休','财务独立','Fire运动','财务自由帖','被动收入','现金流','财富自由','财富自由的感觉','被动收入的感觉','迈出了财务自由'], palette: LIFE_PALETTE, frames: sceneFIRE(), frameDelay: 300, animIn: 'fade', priority: 10 },
  { id: 'lottery-win', category: 'life', name: '中奖', keywords: ['中奖','中奖了','头奖','五百万','彩票中奖','彩票','买了张彩票','中彩票','开奖日','中了一等奖','兑奖','末等奖','彩票中奖','开奖','彩票店','彩票站','买了几注','机选','没中的彩票','中了头奖','路过彩票店','随手买了一注'], palette: LIFE_PALETTE, frames: sceneLottery(), frameDelay: 180, animIn: 'bounce', priority: 10 },
  // ===== 负面事件（priority: 9）=====
  { id: 'fired', category: 'career', name: '被裁', keywords: ['被裁','被公司裁员','被开除','被辞退','丢工作','被炒鱿鱼','收拾纸箱','失业','公司倒闭','HR找你谈','失业了','失业的日子','找朋友帮忙介绍工作','投简历','简历','被优化','毕业即失业','通讯录'], palette: CAREER_PALETTE, frames: sceneFired(), frameDelay: 400, animIn: 'shake', priority: 9, requires: { employed: true } },
  { id: 'divorce', category: 'family', name: '离婚', keywords: ['离婚','离婚了','分开','离婚协议','婚姻破裂','财产分割','闹离婚'], palette: FAMILY_PALETTE, frames: sceneDivorce(), frameDelay: 400, animIn: 'shake', priority: 9, requires: { married: true } },
  { id: 'breakup', category: 'family', name: '分手', keywords: ['分手','失恋','被甩','感情破裂','我们分手吧','你们分手了','分手了'], palette: FAMILY_PALETTE, frames: sceneBreakup(), frameDelay: 400, animIn: 'fade', priority: 9, requires: { dating: true } },
  ...
  { id: 'parent-sick', category: 'family', name: '父母生病', keywords: ['父母生病','父亲生病','母亲生病','爸妈住院','家人重病','陪床','爸住院','妈住院','父亲住院','母亲住院','陪床守夜','医院走廊','父亲走了','母亲走了','爸走了','妈走了','病逝','病危','心梗','离世','120','你爸','你妈','带爸妈去','父母背影','爸拍照','妈笑得','不跟你说话','血压计','买了新的血压计','葬礼','子欲养','护理床','换胃管','翻身拍背','没能留住','父亲接回了家','守着他','电话那头传来父亲住院','连夜赶回','病床上缩小的身影'], palette: FAMILY_PALETTE, frames: sceneParentSick(), frameDelay: 400, animIn: 'fade', priority: 9 },
  { id: 'surgery', category: 'life', name: '手术', keywords: ['手术','动手术','进手术室','开刀','外科手术','住院手术','重大手术','做手术','住院做手术','手术同意书','手术很成功','最贵的治疗方案'], palette: LIFE_PALETTE, frames: sceneSurgery(), frameDelay: 400, animIn: 'fade', priority: 9 },
  ...
  { id: 'burnout', category: 'career', name: '倦怠', keywords: ['倦怠','躺平','裸辞','厌班','抑郁','情绪崩溃','不想上班','心理阴影','心理咨询','心理咨询室','心理医生','咨询室','约咨询','咨询师','情绪低落','焦虑','喘不过气','心理','压力','心理医生','走进心理咨询室'], palette: CAREER_PALETTE, frames: sceneBurnout(), frameDelay: 500, animIn: 'fade', priority: 9, requires: { employed: true } },
  { id: 'sick', category: 'life', name: '生病', keywords: ['生病','发烧','感冒','卧病在床','病倒','请病假','生病卧床','医药费','住院','体检','复查','血压','血脂','脂肪肝','颈椎病','脱发','吃药','膏药','降压药','膝盖疼','眼药水','急诊','挂号','药店','咳嗽','胃疼','头疼','腰椎','腰酸','背痛','肩膀疼','手腕疼','干眼症','关节痛','酸痛','腰疼','扭伤','腰酸背痛','不舒服','卧床','食物中毒','打点滴','躺在病床上','上吐下泻','腰椎间盘','腰突','理疗','天旋地转','眼前一黑','救护车','脑梗','病床上','躺在异国','偏头痛','心悸','挂了急诊','过度刺激','补剂','健康','诊断书','自费部分','营养费','误工费','感冒把你按在床上','医药费像水','生病住院','保费','保险','退保','交保费','重疾险','保险合约','临床试验','双盲试验','受试者','生物年龄','长寿研究','抗衰','抗衰老','基因检测','走出医院','阳光照在脸上'], palette: LIFE_PALETTE, frames: sceneSick(), frameDelay: 400, animIn: 'fade', priority: 8 },
  // ===== 路径/重要生活事件（priority: 8）=====
  { id: 'date', category: 'family', name: '约会', keywords: ['约会','恋爱','表白','第一次约会','在一起','烛光晚餐','找对象','对象','伴侣','脱单','谈恋爱','女朋友','男朋友','鼓起勇气表白','表白了','我也是','只把你当朋友','让我再想想','精心准备的惊喜','礼物','微醺','哼着歌','认识了一个人','缘分','社交软件','认识了一些有趣的人','加了几个社交软件','一起健身','一起吃饭','一起骂','TA说','TA没说话','回家的时候你微醺'], palette: FAMILY_PALETTE, frames: sceneDate(), frameDelay: 300, animIn: 'fade', priority: 8 },
  ...
  { id: 'parent-visit', category: 'family', name: '父母探望', keywords: ['父母来看我','爸妈从老家来','父母过来探望','父母到访','爸妈来看我','父母登门看望','回老家','过年回家','妈妈打电话','爸妈打电话','视频电话','和爸妈视频','教爸妈用','妈在家族群','带父母去','带爸妈去','你妈在电话里哭了','爸拍照的时候手抖','妈笑得像个孩子','给你做饭','我爸','我妈','不跟你说话','回老家整理旧物','翻出'], palette: FAMILY_PALETTE, frames: sceneParentVisit(), frameDelay: 300, animIn: 'fade', priority: 7 },
  ...
  { id: 'work', category: 'career', name: '工作', keywords: ['上班','搬砖','打工','开干','干活','到公司','工位','办公室','工牌','领导','老板','同事','下班','打卡','开会','项目','需求','社畜','周报','KPI','赶需求','改bug','写代码','对接','汇报','工位上','办公桌','副业收入','远程工作','产品发布','服务器','在公司','主管','主管说','会议室','新人','带新人','自由职业','数字游民','远程收入','接一些小活','接单','客户','档期','处理邮件','回邮件','产品被','科技自媒体','报道','创始人','搞AI','AI工具','副业','搞副业','晚上搞副业','摆摊','卖烤肠','朝九晚五','不用担惊受怕','考公','公务员','写脚本','拍视频','剪视频','商务','合作','续约','品牌方','自媒体','涨粉','掉粉','粉丝','内容','算法','流量','IP','社群','网暴','完播率','互动率','平台','创作者','博主','up主','写提案','区政府开会','提案通过','做顾问','咨询费','共享空间','在任何地方都能做','AI模型','提示词','指令遵循','和AI共舞','AI提效大赛','提示词方法论','交付周期','开源项目'], palette: CAREER_PALETTE, frames: sceneWork(), frameDelay: 300, animIn: 'fade', priority: 7, requires: { employed: true } },
  ...
  { id: 'travel', category: 'life', name: '旅行', keywords: ['旅游','旅行','出去玩','度假','出游','出国','去旅行','海边度假','碧海蓝天','风景照','打卡景点','一个人旅行','旅行回来','旅行的照片','翻照片','长途旅行','去了郊外','清迈','里斯本','大理','洱海','越南','夜市','海边','带爸妈去了','带父母去了','路上遇到了一个人','一起看了长城','星空下跳舞','机场告别','拥抱告别','陌生的机场','办电话卡','找公寓','试新餐馆','又一次降落','在路上','游牧路上'], palette: LIFE_PALETTE, frames: sceneTravel(), frameDelay: 250, animIn: 'slide', priority: 7 },
  ...
  { id: 'sunset', category: 'life', name: '夕阳晚年', keywords: ['夕阳','晚年','老了','白头偕老','一起变老','黄昏恋','暮年','白发苍苍','老花镜','上了年纪','老头','老太太','爬楼喘气','含饴弄孙','颐养天年','养老','敬老院','看日落','养老院','养老站','陪老人聊天','做义工','义工','张奶奶','护理员','老人','爷爷奶奶','老年生活','养生','打太极','返聘','退休后反而','陪老人','像我孙子','老年活动','快乐不分年龄','公办养老院'], palette: LIFE_PALETTE, frames: sceneSunset(), frameDelay: 500, animIn: 'fade', priority: 7, requires: { minAge: 50 } },
  { id: 'move', category: 'life', name: '搬家', keywords: ['搬家','搬去','移居','迁徙','搬迁','北漂','沪漂','深漂','去外地','房租上涨','涨房租','房东','新租的房子','租的房子','准备搬家','要搬家','卖掉了大部分家当','清空了半个家'], palette: LIFE_PALETTE, frames: sceneMove(), frameDelay: 250, animIn: 'slide', priority: 7 },
  ...
  { id: 'friend-drink', category: 'life', name: '朋友聚会', keywords: ['朋友聚会','和朋友聚餐','兄弟喝酒','闺蜜聚会','喝酒撸串','饭局举杯','老友重逢','酒吧喝酒','同事喝酒','拼酒','同学聚会','份子钱','结婚请柬','聚餐','干杯','撸串','烧烤','喝啤酒','白酒','喝了一晚上啤酒','喝了两杯酒','默默喝了两杯','喝了很多','醉得不省人事','Chang啤酒','喝着','路边摊','吃了一碗面','和朋友','和巴西人','约你聚会','请几个朋友吃了饭','朋友约你'], palette: LIFE_PALETTE, frames: sceneFriendDrink(), frameDelay: 300, animIn: 'fade', priority: 6 },
  ...
  { id: 'shopping', category: 'life', name: '购物', keywords: ['购物','逛街','血拼','买买买','商场购物','超市采购','剁手','扫货','逛商场','快递','拆包裹','快递到了','网购','下单','取快递','购物车','电商平台','报复性消费','省下来的','超市','价签','纸币','拆包装','多巴胺分泌','快乐消退','买了XX','新手机','换了新手机','买了新手机','分期付款','大几千块','记账','省钱','拿铁因子','隐形消费','记账的习惯','每月只花1000块','省钱挑战','方便面吃到'], palette: LIFE_PALETTE, frames: sceneShopping(), frameDelay: 250, animIn: 'slide', priority: 4 },
  { id: 'phone', category: 'life', name: '刷手机', keywords: ['刷手机','刷短视频','刷抖音','刷朋友圈','手机不离手','刷剧','窝沙发刷手机','躺着刷','刷动态圈','小红书','手机没电','截图','发动态圈','设闹钟','刷微博','刷B站','刷手机到深夜','玩手机','打开手机','打开银行App','打开贝壳','打开APP','打开后台','看MRR曲线','打开电商','打开机票App','翻看相册','手机撑不住','电池一天要充三次','打开APP要等十秒','旧手机','新手机','拿起手机','手机屏幕','AI助手弹出','弹出一条消息','翻了翻通讯录','打开招聘App','打开二手平台','刷到','小红书上刷到','放下手机','手机塞进抽屉','关掉手机','退出了所有','群聊','你死死盯着屏幕'], palette: LIFE_PALETTE, frames: scenePhone(), frameDelay: 300, animIn: 'fade', priority: 4 },
  ...
  { id: 'exercise', category: 'life', name: '锻炼', keywords: ['锻炼','跑步','健身','运动','晨跑','晨练','健身房','太极','米字操','颈椎操','走路上班','瑜伽','游泳','打球','篮球','羽毛球','马拉松','撸铁','骑行','骑车','动感单车','跑步机','普拉提','练瑜伽','坚持健身','看到腹肌','五公里','跑步成为解压方式','公园跑步','去公园跑步','腹肌','两块半','镜子里','健身房镜子前','自拍','跑步成了','解压方式'], palette: LIFE_PALETTE, frames: sceneExercise(), frameDelay: 200, animIn: 'pop', priority: 5 },
  ...
  { id: 'read', category: 'life', name: '看书', keywords: ['看书','读书','阅读','翻书','书店','学习新技能','教学视频','收藏夹','论文','备考','考研','考证','书架','图书馆','借书','写东西','在网上写','写的东西','写了一篇','文章','发表了','阅读量','出书','出版社','出版社编辑','写作','继续写下去','记录本身','每天花两小时看书','下午看书','公交上看书','学的东西','兴趣班','学画画','学弹琴','烘焙','新技能','学做饭','周末都有了一件值得期待的事'], palette: LIFE_PALETTE, frames: sceneRead(), frameDelay: 400, animIn: 'fade', priority: 3 },
