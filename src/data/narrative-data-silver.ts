...
const branchSelectEvent: NarrativeEvent[] = [

  {
    ...
    narrative:
      '三年了。你白天还在街道办上班，但所有人都知道你周末"有别的安排"。你的周末照护从一个人跑变成了带着秀兰一起跑，七八个固定客户，镇上开始有人叫你"那个搞养老的小伙子"。但你心里清楚，这只是个开始——周末两天的时间是有上限的，靠"多接一单"的增长模式走不远。25岁这年，你必须想清楚：如果有一天要辞职全力做这件事，它到底要长成什么样。\n\n' +
...
const techEvents: NarrativeEvent[] = [
  ...
  // 41岁：AI辅助健康预警的成熟
  {
    ...
    narrative:
      ...
      '那天系统给一个老人标了红色预警：连续三天深睡眠下降40%、静息心率升高8次/分、凌晨三点有异常体动。护理员坚持送医，查出早期心衰——如果再晚一个月，后果不堪设想。你站在大屏前想：你22岁回老家时什么都没有，如今一台服务器守护着八千个人的晚年。技术不冷，冷的是不用它的人。',
    options: [
      {
...
const crossBranchEvents: NarrativeEvent[] = [
  ...
  // 31岁：张奶奶走了（跨分支版本——非护理线也能经历这个情感节点）
  {
    ...
    narrative:
      '张奶奶走了。你认识她九年了。从22岁那年你推着轮椅走进老人家的门，到现在你的养老站/智慧平台/社区中心已经服务了几百个老人——张奶奶始终是那个最开始的人。她女儿打电话来的时候声音很平静："妈走的时候没受罪。这些年谢谢你。"你挂了电话，在办公室坐了很久。\n' +
...
const techAchievements: NarrativeAchievement[] = [
  ...
  // 终极：智慧养老基础设施
  {
    ...
    title: '智慧养老基础设施',
    narrative: `你的AI健康预警系统成了全省养老行业的基础设施——八千多位老人的数据在你的服务器上跳动，每个月提前预警上百例健康风险。\n\n省领导来视察时指着大屏说"这就是智慧养老的样子"。你站在旁边，却在想那个凌晨两点变红的绿点——赵爷爷摔在卫生间地上，手环亮了，你冲过去救回一条命。现在你有八千多个绿点了，每天打开后台，看着它们整整齐齐地闪烁，像一片由心跳组成的星海。你想：你22岁回老家时什么都没有，如今一台服务器守护着八千个人的晚年。技术不冷，冷的是不用它的人。`,
    pathId: 'silver_economy',
    branch: 'silver_tech',
    level: 3,
