...
const commonEvents: NarrativeEvent[] = [
  ...
  // 22岁：开启延寿计划，第一瓶NMN
  {
    ...
    narrative:
      ...
      '室友探头看了一眼："你这是要开药店？"你笑了笑，没解释。你读完了David Sinclair那本《Lifespan》，又翻了几十篇关于NAD+（细胞能量货币，就像手机电池，年纪越大电量越少）前体的论文。你相信，衰老不是命运，而是一种可以治疗的疾病。\n' +
    ...
    options: [
      ...
      },
      {
        ...
        log: '22岁，你没急着当"药罐子"。你先戒了熬夜，每天十一点准时关灯，早晨七点起来跑步。两周后你发现自己白天不再犯困，皮肤也好了。你把那瓶NMN收进抽屉——药片先放着，觉先睡够再说。',
      },
      {
        id: 'study_first',
        label: '先把论文读透，再决定吃什么',
  ...
  // 23岁：社交摩擦——拒绝喝酒和垃圾食品
  {
    ...
    options: [
      ...
      },
      {
        ...
        log: '23岁，你组了一个"午休散步群"，每天拉着三四个同事绕写字楼走半小时。你给他们科普血糖曲线和深度睡眠，有人觉得你烦，但也有人开始跟着你吃轻食。你发现：怪人凑成一群，"怪"字就慢慢被人读成了"潮"。',
      },
    ],
  },
  ...
  // 23-24岁：第一次生物标志物检测结果
  {
    ...
    narrative:
      ...
      '你把数据录入一个表格，和同龄人的平均值对比。有些指标你更好，有些更差。你忽然感到：身体不再是模糊的感觉，而是一组可以追踪、可以优化的数字。这种感觉既让人安心，又让人上瘾。',
    options: [
      {
      ...
      },
      {
        ...
        log: '23岁，你的手机里多了一个血糖曲线APP。你发现吃白米饭血糖飙到9.5，换成糙米只到7.2。你开始对每一顿饭精打细算，吃饭前先在脑子里算升糖负荷。朋友说你"活得像个体外实验"，你没反驳，低头又记了一笔数据。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '24岁，你的补剂方案从"别人吃什么我吃什么"变成了"我的基因要我吃什么"。你换了甲基化叶酸，把咖啡减到每天一杯，碳水压到总热量30%。嘴里有了点"工程学"的味道——养生原来可以这样拆着算。',
      },
      {
      ...
      },
      {
        ...
        log: '24岁，你合上报告，决定不被一串字母绑架。APOE4携带者里也有活到九十的，FTO变异的人里也有瘦的——基因递给你的是概率，不是判决书。你继续跑步、继续断食，但不再每隔五分钟查一次自己的风险等级。你学会了一个词：洒脱。',
      },
    ],
  },
];
...
const branchSelectEvent: NarrativeEvent[] = [

  {
    ...
    narrative:
      '三年了。你从那个吞下第一粒NMN的年轻人，变成了动态圈里"最懂养生"也"最不像二十五岁"的人。你的体检报告比同龄人好看一截，你的补剂柜比药店的货架还齐全，你的手机里存了几百篇衰老相关的论文。\n\n' +
    ...
    options: [
      ...
      },
      {
        ...
        log: '25岁，你注册成了一个衰老研究项目的志愿者，又报名了一个生物信息学的在线课程。这回你的赌注换了——不再押哪只票、哪粒药，押的是"懂行"两个字。你把课程笔记存进文件夹，标了星。在这个圈子里，钱是最不值钱的筹码，判断力才是——而判断力，得一笔一笔攒出来。',
      },
    ],
  },
];
...
const investorEvents: NarrativeEvent[] = [
  ...
  // 26岁：买入第一只生物科技股
  {
    ...
    oncePerGame: true,
    narrative:
      '你盯着券商APP，手指悬在"买入"键上方。这是一家做NAD+（能量货币）前体人体临床试验的公司，Phase II数据下个月公布。你读了它的管线、看了管理层的背景、算了现金流——所有指标都指向"值得赌"。\n' +
      '但你清楚，生物科技股的波动比过山车还猛。一期临床的成功率不到10%，三期也只有30%多。你按下去的这一下，可能让本金翻三倍，也可能归零。\n' +
      '你深吸一口气，按下了买入。仓位不算大，但那是你头一回用真金白银为"抗衰"投票。成交提示音响起时，你的心跳比做完一组深蹲还快。从这一刻起，你不只是在吃补剂，你是在用钱押注人类的未来——以及你自己的。',
    options: [
      {
        id: 'concentrated_bet',
        label: '集中仓位，重押这一只',
        ...
        log: '26岁，你把组合里四成的仓位压在了那只NAD+公司上。同事说你疯了，你说"看懂了就不叫赌"。下个月数据公布，你紧张得三天没睡好。结果还行——股价涨了四成。你卖出了一半落袋，剩下的留着赌三期。"研究变现"这四个字，你总算亲口尝到了甜。',
      ...
      },
      {
        ...
        log: '26岁，你没有把鸡蛋放一个篮子。你挑了三只不同方向的抗衰股：一个做NAD+，一个做衰老细胞清除，一个做表观遗传重编程。其中一只跌了，一只涨了，一只平。组合的意义，你这一回才算摸到一点门道——赌对一只靠运气，让概率站在你这边才靠本事。',
      },
      {
        ...
        log: '26岁，你买了只长寿主题ETF，一篮子装了二十多家抗衰公司。你不用每天盯盘，只需相信一个判断：人类对延寿的渴望不会消失。一年后涨了一成，不多，但你睡得很安稳。你把APP推送关了，手机扣在桌上，泡了杯茶。',
      },
    ],
  },
  ...
  // 28岁：临床试验结果——赢
  {
    ...
    oncePerGame: true,
    narrative:
      '凌晨三点，你的手机疯狂震动。你重仓的那家做衰老细胞清除的公司——senolytics（衰老细胞清除剂，像给身体做大扫除，把那些停止分裂却赖着不走的"僵尸细胞"清出去），刚公布了二期临床数据：主要终点达成，安全性良好，效果比预期还好。\n' +
      '盘前股价跳空高开80%。你盯着那条K线，手在发抖——狂喜压过了害怕。你的组合一夜之间涨了十几万。你想起两年前那个犹豫着按"买入"的夜晚，那时候你觉得自己在赌博，现在你觉得自己是先知。\n' +
    ...
    options: [
      ...
      },
      {
        ...
        log: '28岁，你没止盈，反而加了仓。你觉得二期都过了，三期还会远吗？你的组合市值冲到了三十多万。你给自己倒了一杯红酒——白藜芦醇嘛，你笑着说。但你心里清楚：三期临床的成功率只有三成，你现在的每一分浮盈，都悬在三期结果的那一根线上。',
      },
      {
        id: 'study_the_data',
  ...
  // 30岁：结识长寿创业者
  {
    ...
    narrative:
      ...
      '你们聊了两个小时。他讲他的愿景——让人活得更年轻，而不只是更老；多出来的年限得是健康的，才算赚到。他的激情像火焰，你几乎要被点燃。但你也注意到，他回避了关于现金流的提问，对监管风险轻描淡写。先知还是骗子？有时候连他们自己都分不清。',
    options: [
      {
        ...
        log: '30岁，你把五万块投进了他的天使轮，拿到0.5%的股权。没尽调、没对赌、没退出条款——你赌的是这个人。签完字那天你在动态圈发了一句"all in 人类未来"，然后默默设了个提醒：三年后回头看，这是个先知，还是个故事。',
      },
      {
        ...
        log: '30岁，你成了他的"外部科学顾问"，每月开一次会，帮他看数据、理管线。你没投一分钱，但你拿到了行业内幕的第一手信息。通讯录里多了几十个名字，你把其中几个标了星——先混进去，下不下注，以后再说。',
      },
      {
        id: 'stay_skeptical',
        ...
        log: '30岁，你和他加了社交软件，但没投钱。回去后你查了他的上一家公司——倒闭了，投资人血本无归。你倒吸一口凉气。你给他发了条"再观察观察"，他再没回过你。你把他发来的那份BP删了，清空了回收站。屏幕暗下来，映出你自己的脸。',
      },
    ],
  },
  ...
  // 33岁：生物科技泡沫
  {
    ...
    options: [
      ...
      },
      {
        ...
        log: '33岁，你没逃，而是换仓。你卖掉了那些PPT公司，把钱集中到三四家有真实管线、有现金流、有FDA孤儿药资格的龙头上。泡沫破裂时它们也跌，但跌得少、回得快。两年后你的组合创新高。你关掉行情软件，泡了杯茶。窗外有人在放风筝，线很细，但你看得见它一直在那。',
      },
      {
        id: 'ride_the_wave',
        label: '顺势加仓，泡沫里也能赚钱',
    ...
    options: [
      {
        ...
        log: '37岁，你签了基石协议，把五万锁进了半年不能动的仓位。上市首日涨了三成，你在禁售期里每天盯着那条曲线，既期待又煎熬。半年解禁那天，你赚了十多万。你把那张基石协议的电子合同存进了网盘的"里程碑"文件夹——财富的跃迁，有时就靠几张盖了章的入场券。',
      },
      {
        id: 'buy_after_ipo',
        label: '放弃基石，上市后二级市场买',
  ...
  // 39岁：加入/组建长寿基金
  {
    ...
    options: [
      ...
      },
      {
        ...
        log: '39岁，你没出来创业，而是把五十万投进了那支长寿基金做LP。你享受赛道收益，但不用操心尽调、路演、LP关系。你继续写你的专栏，继续管自己的组合。LP的份额确认邮件躺在收件箱里，你回了句"合作愉快"，关上电脑去遛了圈狗。当不了将军也没关系，做将军背后那个递子弹的人，也挺好。',
      },
      {
        id: 'stay_independent',
        label: '保持独立，只管自己的钱',
        ...
        log: '39岁，你拒绝了那个offer。你想起一句话："管别人的钱，你就不再自由。"你继续用自己研究、自己下注、自己承担。赚的不如基金经理多，但你看盘的时候不用想"LP会怎么想"。收盘后你关掉软件，下楼跑了五公里——少赚的那部分，换来的是晚上能睡整觉。',
      },
    ],
  },
  ...
  // 41岁：AI制药浪潮
  {
    ...
    narrative:
      ...
      '你意识到，你赌了十几年的"抗衰技术会突破"，可能等不到慢慢来了——它会被AI一把引爆。原本你预估突破要等到你五十岁，现在可能四十多岁就能看到曙光。\n' +
    ...
    options: [
      ...
      },
      {
        ...
        log: '41岁，你没赌谁能做出药，而是投了一家给所有药企提供AI靶点筛选平台的公司。你没急着数钱，先把它写进了专栏：淘金热里最稳的，是卖铲子的。两年后它的客户从五家涨到五十家，你的仓位稳步上涨。你把"卖铲子"三个字设成了文章的标签——在不确定里找确定，这招比挖金子靠谱。',
      },
      {
        id: 'wait_for_clarity',
  ...
  // 43岁：突破性疗法获批
  {
    ...
    eventType: 'milestone',
    narrative:
      'FDA批准了第一个真正意义上的"抗衰老"疗法——它瞄准的是衰老机制本身，清除衰老细胞，用于延缓与年龄相关的功能衰退。\n' +
      '虽然不是你重仓的那家，但你比谁都兴奋——因为这意味着路是通的。整个板块沸腾了，你的组合一天涨了六成。你十几年的赌注，正在被兑现。\n' +
      '你打开窗户，深吸一口气。窗外的霓虹模糊了一瞬间，你似乎看见多年前那个对着论文摘要皱眉头的年轻人，在出租屋的台灯下点了点头。那时候"抗衰"还只是假设，现在它变成了FDA盖章的现实。你赌的不是某只股票，你赌的是人类不会向衰老投降。你赌对了。',
    options: [
      {
        id: 'realize_gains',
      ...
      },
      {
        ...
        log: '43岁，你没止盈，而是换仓。你卖掉已经兑现的，把资金投进了做表观遗传重编程、线粒体疗法、器官再生的新一批公司。你把新标的逐个加入自选，敲下回车。第一个获批证明路通了，接下来是一整条高速公路——你不图一辆车的票价，图的是整条公路的过路费。',
      },
      {
        id: 'become_advocate',
        label: '用投资人的身份推动抗衰普及',
        ...
        log: '43岁，你开始用你的影响力做另一件事——推动抗衰疗法的可及性。你写了篇长文，呼吁把抗衰纳入医保讨论，又捐了一笔钱给做衰老科普的机构。文章发出后转发涨得很快，你刷新了几次，关掉页面。这项技术若只属于富人，赢的也只是少数人——你押的从来是更多的人能多活几年。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '45岁，你把大部分仓位变现，只留了两只最看好的长期持有。你不再每天盯盘，而是把时间还给了运动、睡眠、家人和那本一直想写的书。书的开头你写得很慢，但每天写一点。剩下的那两只仓位没动，就当给"活到一百二"留的期权费。',
      },
      {
        ...
        log: '45岁，你清了仓。二十多年的赌局，到此为止。你把钱分成了三份：一份生活，一份健康，一份留给未来可能的抗衰疗法。你约了个体检，又订了去冰岛的机票——赌了半辈子"活得更久"，现在该去看看极光了，趁还看得见。',
      },
      {
        id: 'keep_going',
        label: '不退休，这场赌局还没结束',
        ...
        log: '45岁，你没退休。你跟自己说：第一个抗衰疗法获批只是开了个头，后面的二十年才是正戏。你继续研究、继续下注、继续写专栏。有些人退休是为了停，你"不退休"是为了不停——赌徒最怕的不是输，是没得赌了。',
      },
    ],
  },
];
...
const experimenterEvents: NarrativeEvent[] = [
  ...
  // 26岁：第一次系统自体实验
  {
    ...
    options: [
      ...
      },
      {
        ...
        log: '26岁，你没急着给药，而是花了一个月学采血、学检测、学统计。你发现自己之前的采血手法会导致溶血，数据根本不能用。你重新做了基线，这回的数据干净多了。吃补剂容易，对着自己跑出来的烂数据说"这不能用"，才真难。',
      },
      {
        id: 'join_n_of_many',
        ...
        log: '26岁，你加入了一个"N=many"的自体实验社区。你们共享方案、共享数据、互相复核。你的雷帕霉素实验和另外十二个人的数据合并后，趋势变得清晰了。十二条曲线叠在一起，噪声被压平——一个人的实验是故事，叠成一摞，才像点科学的样子。',
      },
    ],
  },
  ...
  // 28岁：补剂堆栈优化
  {
    ...
    narrative:
      ...
      '上周体检报告出来了——ALT偏高。肝功能异常。医生说"可能跟补剂有关，停几种看看"。你停了三天，身体感觉轻了一些。但第三天晚上你焦虑得睡不着——万一停掉的那几种是有效的呢？你又加回来了。ALT还是高，但你不去复查。\n' +
      '你盯着那一排瓶子，忽然分不清自己到底是在优化身体，还是在用补剂管理焦虑。也许有一半是安慰剂，但你不敢停——万一停了那一个是有效的呢？',
    options: [
      {
        id: 'streamline_stack',
        label: '精简到有证据的核心几样',
        ...
        log: '28岁，你把补剂从二十几种砍到了六种：NMN、维D、Omega-3、镁、二甲双胍、雷帕霉素。停掉那些的瞬间你有点慌，但两个月后复查，指标没变差，反而肝肾负担轻了。你把那十几瓶排成一排，挑出六瓶，其余扔进了垃圾桶。玻璃碰撞的声音很脆。',
      },
      {
        ...
        log: '28岁，你花了一年做"加减法实验"。你发现停掉白藜芦醇后炎症反而降了，加上非瑟酮后关节舒服了。你画出了一张"补剂效果地图"，标注了每种对你个人的真实影响。精准比堆量重要得多——你把地图贴在冰箱上，每天看一眼。',
      },
      {
  ...
  // 30岁：冷暴露与桑拿等极端方案
  {
    ...
    options: [
      ...
      },
      {
        ...
        log: '30岁，你没买冰块，而是把淋浴最后两分钟调成冷水。桑拿也换成了温和的远红外。效果没有极限版那么"猛"，但你坚持得下来，也不至于半夜冻醒。你把"坚持"两个字写在浴室镜子上，水汽一蒸，第二天又得重写。',
      },
      {
        ...
        log: '30岁，你查了文献，发现冷暴露的人体抗衰证据几乎为零——大部分是小鼠和机制推测。你停了冰水浴，改成了规律的快走和阻力训练——这些有人体证据。冰桶送了人，跑步机留下了。你跟自己说，你反的从来不是传统，是"没证据的传统"。无聊的方案，反倒最靠得住。',
      },
    ],
  },
  ...
  // 32岁：延长断食
  {
    ...
    options: [
      ...
      },
      {
        ...
        log: '32岁，你没硬撑清水断食，而是用了FMD——五天低热量、低蛋白、植物为主的饮食。没那么"纯"，但能坚持，肌肉也没掉那么多。你把Longo那本书翻到折角的那页又看了一遍——他设计这个方案，图的就是让人能坚持下来。能坚持的科学，才叫科学。',
      },
      {
        ...
        log: '32岁，你试了一次五天断食，瘦了四斤，回来花了两个月才恢复肌肉。你决定不再做极端断食，只保持16:8。镜子里的自己瘦了一圈，但力量掉了。自噬是好事，可身体到底不是培养皿——你宁可慢一点、稳一点，也不拿透支换指标。',
      },
    ],
  },
  ...
  // 34岁：副作用
  {
    ...
    options: [
      ...
      },
      {
        ...
        log: '34岁，你没停雷帕霉素，但把频率从每周一次改成了每两周一次，剂量减半。你加了免疫监测，每个月查一次。日历上标满了抽血的日子，红点排成一串。药物没有绝对的安全，你要做的，是在收益和风险之间，把那根钢丝走稳。',
      },
      {
        id: 'consult_expert',
        label: '去找真正的抗衰医生咨询',
        ...
        log: '34岁，你飞去见了一位做抗衰临床的医生。他看了你的方案，摇头说："你把自己当成了试验田，但没有试验田是没人照看的。"他帮你重新设计了方案，停掉了雷帕霉素，加了规律的运动和睡眠优先。走出诊室那天，你肩膀松了下来——承认自己不是专家，也许是这十二年最重要的一课。',
      },
    ],
  },
  ...
  // 36岁：生物黑客社群
  {
    ...
    narrative:
      ...
      '群里有个头像是实验室白大褂的人，ID叫"陈医生"，自我介绍是某三甲医院再生医学中心的副研究员。他从不晒自己的注射记录，但每当有人想试某种新东西，他会冷不丁贴一段内部数据——"这个载体在小鼠身上致瘤率12%，建议等"，或者"三期临床叫停了，别碰"。他说的话经常被骂"扫兴"，但后来证明他是对的。\n' +
      '你在群里看到有人晒自己的"年轻血浆"输注视频，血液从一个二十岁志愿者的手臂流进他的。评论区有人叫好，陈医生只发了一个"🙄"。你感到一种复杂的情绪：兴奋、恐惧、还有一丝被"同类"接纳的温暖。\n' +
      '你终于找到你的部落了。但你也清楚，部落有部落的疯狂——当一群人都相信同一件事，理性的边界就会被推得更远。你需要在归属感和判断力之间，找到一条线。你给陈医生发了一条私信："你为什么在这个群里？"他回了五个字："看着你们死。"',
    options: [
      {
        id: 'try_peptides',
        ...
        log: '36岁，你从群里的渠道买了一些BPC-157，自己皮下注射。关节确实舒服了些，但你不知道是心理作用还是真的。你也没敢告诉任何人——因为这些东西没有监管，没有标准，你注射进身体的，是信任。针管收进盒子那天，你盯着它看了很久。自由和风险，原来共用同一枚硬币。',
      },
      {
        id: 'share_data_only',
        label: '只分享数据，不碰激进方案',
        ...
        log: '36岁，你成了群里那个"泼冷水"的人。有人想试年轻血浆，你贴出风险研究；有人推荐新型多肽，你问"人体数据在哪"。有人嫌你扫兴，但也有人私信谢你"救了他一命"。渐渐地有人主动付费请你评估他们的补剂方案，一年下来零零散散也收了10000块。群里又有人喊"冲"，你敲了两个字"等一下"，然后删掉，改成"先看数据"。',
      },
      {
        id: 'leave_community',
        label: '退群，回归主流医学',
        ...
        log: '36岁，你退了群。你看着群里越来越激进的实验，觉得背脊发凉——这帮人已经不是在做科学了。你回归了有循证基础的方案——运动、睡眠、营养、有证据的补剂。你觉得无聊了些，但也安心了些。长寿这件事，急不得，得像跑马拉松一样磨。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '38岁，生物年龄31.8。你拿着报告，像拿着一张奖状。你决定加大投入：更严格的断食、更精细的补剂、更密集的监测。你要在下一次检测时，把这个数字压到30以下。报告被你贴在了冰箱上，旁边是下一轮检测的倒计时。',
      },
      {
        id: 'maintain_balance',
        label: '保持现状，享受这个成果',
        ...
        log: '38岁，生物年龄31.8。你没加码，而是长舒一口气。你保持现在的节奏，把省下的精力还给生活——多陪家人，多看几场日落。那个数字你锁进了抽屉，没再贴出来。延长寿命是为了更好地活，不是为了更累地活。',
      },
      {
        ...
        log: '38岁，生物年龄31.8。你高兴了十分钟，然后开始查这个时钟的局限性：不同组织结果不同，检测有技术误差，甲基化和真实健康的关系还没完全搞清。你把这个数字当成"参考"而不是"判决"。你关掉报告，做了二十个俯卧撑，喘得比去年慢了一点。',
      },
    ],
  },
  ...
  // 40岁：衰老细胞清除等极端方案
  {
    ...
    oncePerGame: true,
    narrative:
      '衰老细胞——那些停止分裂却不死的"僵尸细胞"，被认为是衰老的核心驱动力之一。清除它们的药物叫senolytics（清理剂），最经典的是达沙替尼+槲皮素的组合。\n' +
    ...
    options: [
      {
        ...
        log: '40岁，你吞下了那三天的senolytic组合。第二天你全身酸痛、低烧，像得了一场重感冒——据说这是衰老细胞死亡释放的炎症反应。三天后你恢复了，一个月后复查，炎症标志物降了一截，关节也轻快了。你不知道这是不是安慰剂，但报告上的箭头确实少了一个。清道夫进场了，垃圾总会少一些。',
      },
      {
        ...
        log: '40岁，你没碰达沙替尼，只用了非瑟酮和槲皮素——草莓和苹果里的天然成分。效果温和得多，但你睡得着觉。药盒搁在床头，你摸了摸，没打开。你不是病人，没必要用治病的药来"防病"。温和的清道夫清扫得慢，但不会把地板砸坏。',
      },
      {
        ...
        log: '40岁，你把药收了起来，决定等三年后的三期临床结果。你想起二十岁出头时，什么新东西都敢往嘴里塞；现在你学会了等。能等的人，才能活得久——你把药瓶放进抽屉最里面，关上的时候手指停了一下，然后松开了。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '42岁，你把二十年的自体实验整理成了一份公开文档：哪些有效、哪些没用、哪些有风险。你没有贩卖方案，只是诚实记录。文档被转了几万次，有人照着做，有人骂你"伪科学"。文档的评论区你只置顶了一条："这是我的N=1，不是真理——但二十年的真实数据，总比空谈强。"',
      },
      {
        id: 'push_to_extreme',
        label: '冲击生物年龄30岁以下',
        ...
        log: '42岁，生物年龄33.6。你没满足，而是向30发起冲击。你加了高压训练、加了更密集的监测、把方案调到极致。半年后你到了31.4。你盯着那个数字，既骄傲又疲惫。训练日志越写越厚，可你也发现：时间不需要睡觉，你需要。',
      },
      {
        id: 'pivot_to_quality',
        ...
        log: '42岁，你决定不再追求"更年轻"，而是追求"更完整"。你把一部分训练时间换成了徒步、冥想、和伴侣做饭。数字没再降，但你更快乐了。早上睁开眼的时候，你会在床上多躺十秒，感受身体还没醒来的那种松弛。今天值得过——这感觉比任何指标都诚实。',
      },
    ],
  },
  ...
  // 44岁：你的身体成了最好的广告
  {
    ...
    eventType: 'milestone',
    narrative:
      '你44岁了。大学同学聚会上，你发现自己是唯一一个没有啤酒肚、没有白发、不需要扶着膝盖站起来的人。有人问你"是不是整容了"，有人问你"吃的什么仙丹"。\n' +
      '你的体检报告全是绿箭头。医生反复看了两遍片子，问你"平时做什么运动"。你说"我已经坚持优化自己的身体二十二年了"。医生以为你在开玩笑。\n' +
    ...
    options: [
      {
        ...
        log: '44岁，你开了一间小工作室，不叫"抗衰中心"，叫"健康优化实验室"。你不卖药，不卖方案，只做评估和指导。第一批客户是你的朋友和朋友的朋友。看着他们体检报告上的箭头一个个变绿，你把那些报告复印了一份，钉成了册——这就是你赌了二十二年想看到的东西。',
      },
      {
        id: 'stay_private',
        label: '保持低调，继续自己的节奏',
        ...
        log: '44岁，你婉拒了所有采访和合作邀约。你对自己说：我优化身体是为了自己，当榜样只是顺带的。你继续清晨跑步、按时睡觉、定期检测。你不再是22岁那个急着证明自己对的年轻人了。你不需要证明。你每天醒来感觉很好，这就够了。',
      },
      {
        ...
        log: '44岁，你成了一只长寿基金的科学顾问。你不做投资决策，只做一件事：哪些项目在生理学上说得通，哪些是忽悠。你用自己二十二年的N=1数据当标尺，帮基金避开了好几个"看起来很美"的坑。尽调会上你投了反对票的那一栏，后来果然爆了雷。从自体实验者到守门人，这条路你走对了。',
      },
    ],
  },
  ...
  // 45岁：人生的下半场
  {
    ...
    eventType: 'milestone',
    narrative:
      '45岁生日那天，你跑完了今年的第二个半马。冲过终点线时你看了一眼手表：比去年快了两分钟。\n' +
      '你的生物年龄是31岁。你的存款、被动收入、健康状态，都允许你不再为钱工作。你站在人生的中点——如果你的抗衰方案有效，你可能还有五十年甚至更久。\n' +
      '你看着手背上淡得几乎看不见的青筋，想起第一粒胶囊滑过喉咙时那种微微的草木味。当年赌的是"我能活得更久"，现在你知道赌对了，但问题变成了：多出来的时间，你要用来做什么？时间是礼物，但也是一张空白试卷。',
    options: [
      {
        id: 'retire_early',
        ...
        log: '45岁，你正式退休了。你没有搬到什么热带岛屿，只是把工作时间砍到了每周一天——偶尔去工作室看看，偶尔给基金写点建议。其余时间你跑步、读书、做饭、旅行。22岁那年你赌"我能活得更久"，二十三年过去，答案写在每天的清晨里——你不仅活了更久，你活得更好。',
      ...
      },
      {
        ...
        log: '45岁，你没有退休。你开始尝试新的方案——高压氧舱、基因表达分析、AI定制营养。你的朋友们说你"停不下来"，你笑着说"前面的路太有意思了，停什么"。你知道你可能永远达不到"永生"，但每往前走一步，人类就离那个目标近一寸。',
        triggersRetirementCheck: true,
      },
      {
        ...
        log: '45岁，你开始带徒弟。每年收三四个真心想学习健康优化的人，手把手教，比课堂上那种实在多了。你把二十二年的笔记整理成了一本手册，免费公开。你一个人多活二十年是二十年，但如果你教会一百个人各自多活十年，那就是一千年。',
        triggersRetirementCheck: true,
      },
    ],
  },
...
const researcherEvents: NarrativeEvent[] = [
  ...
  // 26岁：加入一项衰老研究
  {
    ...
    narrative:
      ...
      '第一次去实验室，你看着那些穿着白大褂的研究生，心想：这就是科学的现场。你不再是旁观者，你成了数据点，成了这条知识链条上的一环。\n' +
    ...
    options: [
      {
        ...
        log: '26岁，你成了那个实验室最靠谱的受试者。三年里你没缺席过一次随访，数据完整得让研究生感动。PI在论文致谢里写上了你的编号。你把那行致谢截图存了下来——当不成科学家没关系，你做的那块拼图，缺了不行。',
      },
      {
        id: 'ask_questions',
        label: '不断提问，趁机学方法学',
        ...
        log: '26岁，你把每次去实验室变成了上课。你问为什么用ELISA而不是质谱，问为什么控制这个变量不控制那个，问p值和效应量哪个更重要。研究生开始躲你，但PI喜欢你，邀请你参加组会。你攥着一沓打印出来的文献走出实验室，走廊灯坏了，你借着手机光又翻了两页。',
      },
      {
        ...
        log: '26岁，你把三年的自体实验数据整理成表格，发给了PI。她看了很惊讶："这些虽然不能直接用，但能帮我们生成假设。"后来她真的基于你的数据，设计了一个新实验。你盯着她回信里的"谢谢你的数据"四个字看了很久，然后把它存进了一个叫"值得"的文件夹。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '28岁，你跟PI说："我想做更多，不只是提供数据。"她让你参与了一项新实验的数据清洗和分析。半年后你的名字出现在了作者列表的倒数第二位。虽然只是二作，但你拿到了人生第一个ORCID。你把那串ORCID号背了下来——在学术的世界里，名字的位置就是位置。',
      },
      {
        id: 'start_writing',
        ...
        log: '28岁，你开了一个公众号，专门把晦涩的衰老论文翻译成普通人能懂的话。第一篇阅读量只有三百，但有人留言说"终于看懂了自噬是什么"。你把那条留言收藏了——科学的进步不只靠实验室，也靠有人把火种递出去。',
      },
      {
        id: 'deepen_methods',
        label: '深入学习统计和实验设计',
        ...
        log: '28岁，你啃起了生物统计学和实验设计。你学会了看置信区间、看样本量计算、看偏倚来源。你回头再看那些网红抗衰研究，发现一半都站不住脚。一家健康媒体看到你在公众号上的吐槽，付费5000块请你写了一篇"抗衰研究避坑指南"。稿费到账那天你盯着余额看了会儿——知识最危险的地方是让你看见多少东西是假的，可这也正是它值钱的地方。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '30岁，你成了那位教授的在职博士生。白天上班，晚上和周末做课题。你比同门大七八岁，但他们尊敬你——你是为问题来的，文凭只是顺带的。三十岁重新当学生，像是把人生重置了一次。你在实验室的工位上贴了张便签："别急，你比他们多跑了八年。"',
      },
      {
        id: 'collaborate_only',
        label: '不读博，但建立长期合作',
        ...
        log: '30岁，你没读博，但和那位教授建立了长期合作。你帮他收集真实世界的依从性数据，他让你参与组会和论文讨论。教授从课题经费里拨了8000块咨询费给你——钱不多，可这是头一回，你靠"懂生物学"吃上了饭。你把顾问聘书收进文件夹，没发动态圈。进不进体制不打紧，你人在场，你出的力在场，这就够了。',
      },
      {
        ...
        log: '30岁，那位教授把你拉进了一个衰老研究的国际协作网络。你认识了二十多位科学家，有的是做线粒体的，有的是做干细胞的老的。你成了这个网络里唯一的"民间科学家"，但他们需要你——因为你懂实践，他们懂理论。协作群的未读消息每天99+，你的头像混在一堆博士头衔里——桥梁这东西，站得低，可它连着两岸。',
      },
    ],
  },
  ...
  // 32岁：发起公民科学项目
  {
    ...
    narrative:
      ...
      '一年后，数据出来了。你发现了一个有趣的信号：某种补剂的效果，和受试者的基线炎症水平相关——基线高的人受益明显，基线低的几乎没变化。这个"异质性"的发现，也许微不足道，但它是真实的。你这才体会到：把一百多个人的故事，变成一个可以讨论的结论，这就是科学的力量。',
    options: [
      {
        id: 'publish_findings',
        label: '写成论文投预印本',
        ...
        log: '32岁，你把公民科学项目的结果投到了预印本。审稿意见褒贬不一——有人夸"开创性"，有人批"样本质量参差"。但你的发现被几位科学家注意到了，有人邀请你合作验证。一家补剂公司看中你那个"基线炎症水平决定补剂效果"的发现，付费12000块请你帮忙做人群分层咨询。你在邮件里写"合作愉快"，删掉，改成"期待数据说话"。',
      },
      {
        id: 'build_platform',
        label: '把项目做成一个长期平台',
        ...
        log: '32岁，你没让项目结束，而是搭了一个平台，让更多自体实验者上传数据。两年后平台有了五千用户，成了全球最大的民间衰老数据库之一。后台的注册曲线一路上扬——一个人是数据点，五千个人叠起来，就成了科学听得懂的一句话。',
      },
      {
        id: 'focus_on_quality',
        label: '先提升数据质量，不急着发表',
        ...
        log: '32岁，你看着参差不齐的数据，决定先做质控而不是急着发表。你重新培训了参与者，统一了检测方法，剔除了不合格样本。速度慢了，但数据的可信度高了。进度条停在质控那一栏很久——在科学里，慢就是快，一个可信的结论，胜过一百个哗众的发现。',
      },
    ],
  },
  ...
  // 34岁：参加长寿大会
  {
    ...
    narrative:
      ...
      '但你也看到了另一面：会场外的展台，有人在卖两万块一次的"年轻血浆输注"，有人在推销没有数据的"抗衰神药"。科学的激情和商业的贪婪，在这同一个屋顶下交织。先知和骗子同台，而你这种人，正站在分辨他们的位置上。',
    options: [
      {
        id: 'present_poster',
        label: '展示你的公民科学海报',
        ...
        log: '34岁，你站在自己的海报前，给路过的人讲解你的公民科学项目。有人匆匆走过，有人停下来认真听，有位诺奖得主问了你三个问题。会议结束你收到了二十多张名片。其中一家做衰老检测的生科公司，付费15000块请你帮忙做生物标志物选型的技术咨询。名片你理成一摞，用皮筋扎好——你不属于任何机构，可你的工作，配得上这个会场。',
      },
      {
        id: 'build_alliances',
        label: '重点建立跨机构合作',
        ...
        log: '34岁，你把大会当成了社交场。你约了七位科学家喝咖啡，聊合作、聊数据共享、聊未来的项目。回程的飞机上你整理了一页"潜在合作清单"，每一条都是一个可能性。飞机降落时你还没写完，空姐提醒收起小桌板，你合上电脑，嘴角带笑。',
      },
      {
        id: 'expose_quacks',
        label: '记录并揭露会场的伪科学',
        ...
        log: '34岁，你在大会现场悄悄记录了那些没有数据支撑的产品和宣称，回去后写成了一篇"长寿大会上的科学与伪科学"。文章引发了争议，有人骂你"泼冷水"，有人谢你"省了他们几万块"。评论区你置顶了那条骂你最狠的——守护一场革命的纯洁，比发动它更难，但总得有人做。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '36岁，你成了推动衰老分类讨论的活跃声音。你的文章被翻译成五种语言，你被邀请参加WHO的旁听会议。一家关注老龄化政策的健康智库付费20000块请你做了一份"衰老纳入疾病分类的影响评估"报告。报告交稿那天你在封皮上按了个指印——科学发现分子，可分子能不能到人手里，政策说了算。',
      },
      {
        ...
        log: '36岁，你发现政策的齿轮转得太慢，于是转向了更直接的事——教育。你做了一系列免费课程，教普通人看懂衰老研究、识别抗衰骗局。两年内你的课程被五十万人学过。后台的学习时长数字每天往上跳——等政策来保护人，不如先让人自己长出盔甲。',
      },
      {
        ...
        log: '36岁，你在所有公开发言里都坚持一个原则：说证据，不说愿景。有人嫌你"不够振奋人心"，但你也挡住了一批想借你名声炒作的产品。演讲稿里你划掉了所有"未来""革命""颠覆"——在这个最容易吹牛的领域，克制本身就是贡献。吹出去的牛，最后都会变成砸向科学的石头。',
      },
    ],
  },
  ...
  // 38岁：建立知识平台
  {
    ...
    narrative:
      ...
      '你在平台首页写了一句话："这里不卖任何东西，也不承诺任何奇迹。我们只提供证据，让你自己判断。"这句话是你这十几年最想对所有像22岁的你那样迷茫的人说的话。你建了一座灯塔——不图指路，只图让人在迷雾里看见，还有方向这回事。',
    options: [
      {
        id: 'grow_platform',
        label: '全职运营平台，做成权威入口',
        ...
        log: '38岁，你辞了职，全职运营平台。你组了五人团队，做了证据分级系统、做了专家审核机制、做了防骗举报通道。两年后它成了中文世界最被信任的衰老科普来源。团队的群名你改成了"看门人"——你不做研究了，但你让更多人的研究被看见，被正确地看见。',
      },
      {
        id: 'partner_academia',
        ...
        log: '38岁，你和三所大学的衰老实验室建立了合作：他们提供学术审核，你提供传播渠道。平台的文章从"民间解读"升级为"学术把关"。合作意向书签完那天，你把三份合同并排摆在桌上，拍了张照，发给22岁的自己——可惜发不出去。',
      },
      {
        id: 'keep_independent',
        label: '保持独立运营，不接广告',
        ...
        log: '38岁，你拒绝了所有抗衰产品的广告和赞助。平台靠读者小额订阅维持，钱不多，但你睡得着觉。一旦收了钱，你的"证据"就会被人质疑动机。穷一点没关系，干净最重要——抗衰领域最稀缺的，公信力算一个。你关掉又一封赞助邮件，拉黑，然后去睡了。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '40岁，你正式带了三个"徒弟"。你教他们读文献、设计实验、写综述。两年后一个考上了衰老生物学的博士，一个进了生科公司做研发，一个接手了你的公民科学平台。你把自己拆成了三份，种进了三块更年轻的土壤。冬天收到三张贺卡，你把它们夹进了那本笔记里。',
      },
      {
        id: 'open_course',
        label: '做一门系统的衰老科学公开课',
        ...
        log: '40岁，你录了一门三十讲的衰老科学公开课，从端粒（保护帽）到表观遗传，从自噬到衰老细胞。免费放在网上，一年内被三十万人学过。你把知识做成了种子，风会把它带到任何需要的地方——后台留言区有人写"我决定考衰老生物学的研究生了"，你截了图，存进了那个叫"值得"的文件夹。',
      },
      {
        ...
        log: '40岁，你婉拒了带徒弟的请求，把时间全砸在了自己的研究上。你知道传承很重要，但你也知道：你的精力有限，与其分散，不如集中。等你做出了真正重要的发现，那本身就是最好的传承——用一个能被引用二十年的结论，胜过带二十个徒弟。你关掉邮件，打开数据分析软件，窗外的天已经亮了。',
      },
    ],
  },
  ...
  // 42岁：参与的重磅论文发表
  {
    ...
    narrative:
      ...
      '论文上线那天，你的手机被祝贺信息塞满。有同行、有读者、有当年劝你别"不务正业"的亲戚。你盯着屏幕，杯壁上的水汽模糊了视线——那时候你以为，科学的殿堂离"民间人士"很远。\n' +
      '现在你的名字和那些殿堂里的人印在同一页纸上。你用了二十年，从一个外行，走到了里面。这也许是你这辈子最骄傲的事——你证明了：知识面前，真的没有门第。',
    options: [
      {
        id: 'lead_next_study',
        label: '牵头下一项更大规模的研究',
        ...
        log: '42岁，你成了下一项千人规模衰老纵向研究的共同PI。你从"被研究的人"变成了"研究别人的人"。你在启动会上说："二十年前我是受试者，今天我是研究者。这条路走到尽头，能让每个人更健康地老去，就够了。"',
      },
      {
        ...
        log: '42岁，你把那篇论文拆成了十篇科普，讲清楚了这个新标志物意味着什么、普通人怎么测、怎么用。你的平台流量翻倍，有人照着做了检测，提前发现了风险。你打开私信，一条写着"谢谢你，我去查了，果然偏高"。你回了个笑脸，关掉，又打开下一篇草稿。',
      },
      {
        ...
        log: '42岁，论文发表后你没急着做下一个项目，而是去山里待了一周。你问自己：你追求的到底是"留名"还是"有用"？答案慢慢清晰——比起被记住，你更想让某个人因为你的工作，多健康地活几年。你想：这才是"延长寿命"四个字最朴素、也最深刻的含义。',
      },
    ],
  },
  ...
  // 44岁：你的研究开始改变政策
  {
    ...
    eventType: 'milestone',
    narrative:
      '你参与搭建的那个衰老标志物数据库，被国家卫健委引用了——他们在制定老年健康评估指南时，用了你们的数据做参考。\n' +
      '消息传来那天你正在实验室整理样本。一个年轻的研究员跑进来告诉你，你先是愣了一下，然后继续把试管放进架子。但你放试管的手在抖。\n' +
      '那些被人说"民科也配谈科学"的夜晚，那些周末泡在实验室里不为升职加薪只为一个答案的时光，忽然都有了落点。现在你的工作变成了指南里的一个数字、一个标准、一个会影响几千万老年人健康评估的依据。',
    options: [
      {
        id: 'push_for_more',
        label: '推动更多研究转化为政策',
        ...
        log: '44岁，你成了卫健委老年健康专家委员会的外聘顾问。你开始在政策制定会议上发言，用数据说话，用你二十年的民间研究经验提醒那些专家："指南上的每一个数字，背后都是一个真实的老人。"你知道你改变不了一切，但你至少能让一些数字更准确，一些评估更人性化。',
      },
      {
        id: 'focus_on_data',
        label: '回到实验室，继续做基础研究',
        ...
        log: '44岁，你礼貌地拒绝了所有政策顾问的邀请。你对邀请你的人说："我擅长的是找答案，不是写文件。"你回到了数据库、回到了实验室、回到了那个你最舒服的位置。你点亮灯就够了——有人需要在聚光灯下，你做那个站在灯旁边的人。',
      },
      {
        id: 'train_next_gen',
        label: '把精力放在培养年轻研究者上',
        ...
        log: '44岁，你开始带研究生——在你搭建的公民科学平台上，而非大学的教室里。你每年选五个真正有热情的年轻人，免费教他们研究方法、论文写作、数据分析。有人问你图什么，你说"图他们比我走得远"。当年那个在论坛上发帖无人回复的门外汉，现在成了那个主动伸出手的人。',
      },
    ],
  },
  ...
  // 45岁：回答最初的问题
  {
    ...
    eventType: 'milestone',
    narrative:
      '45岁，你在整理书房时翻出了一本22岁的笔记本。扉页上写着一行字："我要搞清楚人到底能不能活更久。"\n' +
      '你坐在地上翻了很久。那些歪歪扭扭的笔记、那些被划掉又重写的假设、那些贴满便签的论文打印件——二十三年前你问了一个问题，现在你有了一部分答案：能，但靠的是自律、监测、科学进步和一点点运气——而不是一颗神药。\n' +
    ...
    options: [
      {
        ...
        log: '45岁，你退休了。你没有去海边，而是在家写了一本书——《一个普通人的二十三年抗衰笔记》。一个门外汉用二十三年时间、自己的身体、和无数个深夜换来的诚实记录。书出版那天你翻到扉页，把22岁那行字抄在了最后一页下面："能。而且值得。"',
        triggersRetirementCheck: true,
      },
      {
        ...
        log: '45岁，你没有退休。你把那本旧笔记本放回书架，打开了一个新的文档。你正在研究的新课题是"生物年龄逆转的上限在哪里"——这是你42岁之后一直在想的问题。你知道可能这辈子都看不到最终答案，但你也知道：每往前走一步，后面的人就少走一步。',
        triggersRetirementCheck: true,
      },
      {
        id: 'retire_mentor',
        ...
        log: '45岁，你选择了半退休。你不再亲自跑样本、写论文，但你每周会抽两天在平台上回答年轻研究者的问题，每月给委员会提供一次咨询意见。你在自家阳台上种了花，开始学做饭。人生的答案不在于活多久，在于活着的时候在做什么——你做的事让你觉得没有白活，这就够了。',
        triggersRetirementCheck: true,
      },
    ],
  },
...
const crossBranchEvents: NarrativeEvent[] = [
  ...
  // 27岁：日常缝隙——深夜整理补剂柜
  {
    ...
    eventType: 'normal',
    narrative:
      '失眠。台灯亮着，光圈打在厨房台面上，像一小块被切出来的深夜。水龙头没拧紧，每隔十几秒滴一下，滴一下。\n' +
      '你站在补剂柜前，瓶瓶罐罐排了两排。NMN、维D、Omega-3、镁、锌、白藜芦醇、姜黄素、NAC、甘氨酸、肌酸……有些你记得为什么开始吃，有些你已经忘了。你拿起一瓶NMN，翻到背面——保质期上个月刚过。\n' +
    ...
    options: [
      {
        ...
        log: '27岁，凌晨两点，你把那瓶过期NMN扔进了垃圾桶。玻璃瓶撞到桶壁，闷响了一声。你又花了半小时把柜子理了一遍，过期的扔、快过期的标记、还能吃的前排。理完之后你看了眼干净了不少的柜子，关上灯，回了卧室。水龙头还在滴。',
      },
      {
        id: 'just_stare',
        label: '就坐着发呆',
        ...
        log: '27岁，凌晨两点，你拿着那瓶过期NMN，在厨房的凳子上坐了下来。台灯把你的影子拉得很长。水龙头滴答滴答，冰箱嗡嗡地响。你什么都不想，就坐着，手里攥着那个凉了的玻璃瓶。不知道过了多久，你站起来，把药放回了柜子里——没扔，也没吃。你回了床，竟然睡着了。',
      },
      {
        id: 'take_anyway',
        label: '过期也没多久，吃了算了',
        ...
        log: '27岁，凌晨两点，你拧开那瓶过期NMN，倒了一粒在手心。犹豫了两秒，还是吞了。NMN很贵，过期一两周应该没事——你这样说服自己。药片滑下喉咙的时候，你忽然觉得有点荒唐：你花了这么多钱、这么多精力想要活得更久，却在凌晨两点吃一粒过期的药。你关了灯，水龙头还在滴。',
      },
    ],
  },
  ...
  // 30-35岁：镜像角色——老沈
  {
    ...
    oncePerGame: true,
    narrative:
      '你在一次生物黑客线下聚会上认识了老沈。他比你大五岁，入坑比你早三年，做的实验比你激进十倍。\n' +
      '老沈吃的东西你没见过：一种还在动物实验阶段的NAD+（能量货币）前体类似物，一瓶某课题组"内部流出来"的多肽，还有他自己从原料粉混的"配方"。他给你看他的采血频率——每周三次，胳膊上全是针眼，像被蚊子咬了一个夏天。\n' +
      '"你太保守了，"老沈拍你肩膀，"这个领域跑得快的人才能赢。等我生物年龄降到比实际小十五岁，你还在那磨蹭NMN的剂量。"\n' +
      '但你也注意到了一些事：老沈的黑眼圈很重，手有时候会抖，他说最近查出来甲状腺指标异常——"可能是某个补剂干扰了，但也无所谓，调一调就行。"\n' +
      '聚会散场，你看着老沈匆匆离去的背影，忽然有一种奇怪的感觉：他像你，又不完全是你。他走了你差一点就走上的那条路——更猛、更快、更不留余地。你不确定他是领先了，还是跑偏了。',
    options: [
      {
        id: 'warn_laoshen',
        ...
        log: '32岁，你拉住老沈，跟他说了你的担忧。他听完笑了："你们这些保守派都一样，总怕出事。出了事再说嘛。"但他没走，听你讲了十五分钟甲状腺和多肽之间的可能关联。末了他说"我查查"，语气比之前轻了些。你不确定他真会查，但至少你说了。回家的地铁上你看着车窗里自己的脸，觉得比老沈的从容了一些。',
      },
      {
        ...
        log: '32岁，你跟老沈聊了两个小时，记了三页笔记。他的某些思路确实给你打开了新角度——比如用连续血糖监测来评估补剂的代谢影响，比如把睡眠数据和炎症标志物交叉分析。但你也注意到他提到那些"实验性物质"时眼里闪的光，那种光你认识，你在22岁第一次按"买入"时也有过。你回去了，试了他的一部分方法，那些激进的你没碰。',
      },
      {
        ...
        log: '32岁，你没劝老沈，也没跟他取经。你只是看着他，像看着另一个版本的自己——那个没踩刹车的版本。聚会散场后你一个人走了很长一段路。路灯把你的影子拉长又缩短，拉长又缩短。你想起自己25岁时也差点买了一瓶来路不明的"实验级"多肽，最后没买。那个"没买"的瞬间，也许就是你和老沈的分岔路口。你把外套拉链拉到了最高，走快了两步。',
      },
    ],
  },
    ...
    options: [
      {
        ...
        log: '30岁，那条新闻像一针强心剂。你加仓了生科组合，加码了自体方案，连夜写了一篇解读。你赌的不是某只小鼠，是人类不愿向衰老低头的那口气——这口气，今天被证明是通的。',
      ...
      },
      {
        ...
        log: '30岁，你发了条动态圈："小鼠不是人，别急着庆祝。"被几个人取关了，但你不后悔。你见过太多小鼠有效、人没效的例子。真正的赌徒，不是看到希望就梭哈，是知道希望和现实之间隔着多少个深夜。你关掉动态圈，又去翻了一篇临床数据。',
      },
      {
        id: 'reflect_meaning',
        label: '思考：活得久，然后呢？',
    ...
    options: [
      {
        ...
        log: '33岁，你接管了爸爸的康复。你给他配了地中海饮食的食谱，盯着他每天走路，把烟酒断了。他骂你"比医生还烦"，但半年后他的指标好了一截。有天他忽然说"早听你的就好了"。你没接话，只是又给他盛了一碗燕麦。碗磕在桌上，响了一声。',
      },
      {
        id: 'focus_on_self',
    ...
    options: [
      {
        ...
        log: '35岁，你把补剂柜精简了一半，每天只花半小时搞健康，剩下的还给生活。你陪伴侣吃了火锅、看了电影、熬了一次夜。你说："我赌未来，但不能输掉现在。"伴侣笑了，给你夹了块毛肚。锅里的汤底咕嘟嘟冒着泡，你们都没看手机。',
      },
      {
        id: 'explain_vision',
        label: '解释你的愿景，争取伴侣理解',
        ...
        log: '35岁，你把伴侣拉到桌前，讲了两个小时你的"延寿计划"。TA听完沉默了很久，说："我不完全懂，但我信你是认真的。只是，别把我排除在外。"你们达成了一个妥协：周末两天，一天给你做实验，一天给两个人。你在日历上标了两种颜色——蓝色是你，红色是你们。',
      },
      {
        id: 'stay_the_course',
        label: '坚持自己的节奏，不愿妥协',
  ...
  // 38岁：父母衰老加速
  {
    ...
    narrative:
      ...
      '你赌了十六年抗衰，你的生物年龄比实际小六岁。但你的妈妈，正在以两倍的速度老去。你优化得了自己，优化不了她。你忽然明白了：衰老不是你一个人的敌人，它是所有人的命运。你能做的，只是在它带走你爱的人之前，多陪陪他们。',
    options: [
      {
        ...
        log: '38岁，你把回家的频率从一年一次改成了一季度一次。你陪妈妈买菜、陪爸爸下棋、给他们做你研究的健康餐。妈妈说"你做的菜没味道"，但每顿都吃光。你给不了她多二十年，但你能给她多二十个快乐的周末——你把碗洗了，又听她讲了一遍你小时候的事。',
      },
      {
        ...
        log: '38岁，你给父母量身定制了一套方案：妈妈补钙和维D防骨质疏松，爸爸控血压加阻力训练。他们嫌麻烦，但拗不过你。半年后妈妈走路稳了，爸爸血压降了。你改变不了他们的基因，但能改变他们的习惯——你把方案写在一张A4纸上，贴在他们家冰箱上，旁边就是你的照片。',
      },
      {
        id: 'accept_mortality',
        label: '接受父母的衰老，学会告别',
...
const crisisEvents: NarrativeEvent[] = [
  ...
  // 32岁：补剂导致肝损伤
  {
    ...
    narrative:
      ...
      '医生说："停掉所有补剂，两个月后复查。如果还高，要做肝穿刺。"你走出医院，阳光很刺眼。你这才怀疑：你到底是在对抗衰老，还是在加速它？',
    options: [
      {
        ...
        log: '32岁，你把补剂柜清空了。前两周你浑身不自在，像丢了什么。但两个月后复查，转氨酶回到了正常。你盯着报告，长舒一口气，又叹了口气。你赌了十年，差点把自己赌进ICU。你把空了的药格擦干净，关上柜门，手在门把上停了几秒。',
      },
      {
        id: 'identify_culprit',
        label: '逐个排查，找出元凶后精简',
        ...
        log: '32岁，你用了三个月做排除法：每周停一种，测一次肝功能。最后锁定是那瓶来路不明的"复合配方"和白藜芦醇高剂量。你扔了它们，留下了证据充分的几样。肝功能恢复了，你的方案也更干净了。这次反噬帮你去掉了垃圾，代价是一座医院的账单和三个月的恐惧——你把药瓶扔进垃圾桶，盖子没盖严。',
      },
      {
        id: 'see_specialist',
        ...
        log: '32岁，你花了一个月挂了三个专家号。肝病专家帮你逐项评估了补剂的肝毒性风险，划掉了六种，调整了三种的剂量。你说："早该来的。"专家说："大多数生物黑客都是出了事才来。"你攥着那张划满红线的清单走出医院，门口的银杏叶落了一地，踩上去很脆。',
      },
    ],
  },
  ...
  // 36岁：重大生物科技欺诈丑闻
  {
    ...
    narrative:
      ...
      '你重仓过这只股票。虽然你在泡沫时减了仓，但剩下的部分也在一天内跌了85%。更让你心寒的不在于钱，在于信任——你信过这个人，你信过他的数据，你甚至在专栏里推荐过他。\n' +
      '你打开你写过的那篇推荐文章，看着屏幕上自己写的"这是我见过最诚实的创业者"，胃里一阵翻涌。你赌了十几年抗衰，第一次被人从内部捅了一刀。技术没失败，失败的是人心。你忽然明白：这个领域最大的风险，不是科学的不确定，是骗子混在先知里。',
    options: [
      {
        id: 'admit_mistake',
        label: '公开认错，重建公信力',
      ...
      },
      {
        ...
        log: '36岁，你没写文章，而是写了一份"抗衰投资尽调清单"——二十七个必查项，从原始数据到利益冲突。你把它开源了，成了圈里的标准工具。你被骗一次，就让骗子以后更难骗人。清单最后一条写着："如果你不愿意查完这27项，就别投。"你加了个感叹号，又删了，改成句号。',
      },
      {
        id: 'doubt_everything',
        label: '怀疑一切，大幅收缩抗衰投入',
    ...
    options: [
      {
        ...
        log: '40岁，你在损失了一大半后，没崩溃。你把剩下的仓位重新配置，分散到五家不同阶段的公司。你赌的是"抗衰会突破"，赌的不是"这一家会成功"。一家失败不代表方向错，只是说明你把太多筹码压在了同一个故事上。你舔了舔伤口，重新发牌。',
      },
      {
        id: 'analyze_failure',
        label: '深挖失败原因，变成知识',
        ...
        log: '40岁，你没急着重建，而是花了一个月研究它为什么失败。你发现它的动物模型有缺陷，二期数据被过度解读，安全性信号早被忽略。你把这些写成了报告，在圈里流传。学费很贵，但学到了就是赚了——你把报告最后改了一遍，标题从"失败分析"改成了"下一次怎么赢"。',
      },
      {
        id: 'question_the_bet',
        label: '质问自己：还要继续赌吗',
        ...
        log: '40岁，你清了仓。你坐在空荡荡的书房里，看着那个归零的补剂柜和清空的股票账户，问自己："值吗？"十八年，你错过了多少火锅、多少电影、多少个不该错过的夜晚？你赌的是"活得更久"，但你好像忘了"活着"本身。你没找到答案，但你终于允许自己把这个问题问出口。',
      },
    ],
  },
];
...
const bioWarningEvents: NarrativeEvent[] = [
  ...
  // 预警1：实验数据没有突破，钱烧得很快，投资人开始催
  {
    ...
    narrative:
      '你的Excel表格里又多了一列不显著的p值。\n\n' +
      '第十八次实验了。小鼠的握力数据没有统计学差异，DNA甲基化时钟和对照组几乎重合，端粒（染色体末端的保护帽，短到一定程度细胞就不再分裂）长度的变化在误差范围内。你盯着那个0.07的p值看了很久——差一点，但科学不相信"差一点"。\n\n' +
      '你投进去的钱已经超过了你所有的积蓄。试剂贵得像液体黄金，测序仪的机时费一小时八百块，实验动物的饲养费每个月都在涨。你算了一笔账：按目前的烧钱速度，还能撑四个月。四个月之后呢？\n\n' +
      '投资人的社交软件来了。"进度怎么样了？"只有五个字，但你读懂了背后的意思。上次见面他就暗示了：基金的LP在问回报，同期投的另一个项目已经出了两篇Nature子刊。你回了"进展顺利，有突破马上汇报"，发出去之后盯着"顺利"两个字觉得刺眼。\n\n' +
      '实验室很安静，只有离心机的嗡鸣声和-80度冰箱的压缩机声。你看着笼子里那些小鼠，它们不知道自己肩负着人类延寿的希望，也不知道自己正在吃一个普通人一辈子的积蓄。你突然想：如果这些实验永远做不出阳性结果呢？如果衰老根本没有"开关"呢？如果我花的所有钱、所有时间、所有放弃的东西，最后只证明了一件事——人总是会老的？',
    options: [
      {
  ...
  // 预警2：自己的身体出了问题，长期自实验的副作用
  {
    ...
    narrative:
      '你在凌晨四点被心悸弄醒了。\n\n' +
      '心跳快得像刚跑完马拉松，但你平躺在床上。你数了一下脉搏——130次/分。你试着深呼吸，但胸口有一种紧缩感，左臂微微发麻。你不是医学生物学的吗？你应该知道这是什么。但你的第一反应不是"我可能心脏病发作了"，而是"这会不会是NMN叠加雷帕霉素的交互作用？"\n\n' +
      '你已经在自己身上做了三年实验。你轮换过六种补剂方案，试过三种不同的禁食模式，测过无数次血液指标。你的数据库里有你自己的四百多份血检报告、十二次肠道菌群测序、五次端粒长度检测。你曾经骄傲地跟人说"我是自己最好的实验对象"。\n\n' +
      '但现在你躺在黑暗中，心脏在胸腔里乱撞，你突然害怕了。你想起去年肝功能异常的时候你告诉自己"只是一过性的"，你想起三个月前开始出现的耳鸣你归因于"压力大"，你想起最近一直腹泻但你没停任何补剂——因为你需要连续的数据。\n\n' +
      '你打开手机搜索"rapamycin tachycardia side effects"，搜索结果第一条是一个Reddit帖子，标题是"I almost killed myself self-experimenting"。你看着那个标题，屏幕的光打在你苍白的脸上。心悸还在继续。你在想：我在对抗衰老，但如果我先把自己搞死了，一切数据还有什么意义？',
    options: [
      {
        id: 'stop_all_supplements',
...
const postAllInEvents: NarrativeEvent[] = [
  ...
  // 第一次学术会议
  {
    ...
    conditions: (s) => s.isAllInPath === true,
    narrative:
      '你站在一场衰老生物学学术会议的注册台前，手里攥着名片——上面印着你的名字和"独立研究者/投资顾问"。你不是博士生、不是教授、不是任何机构的研究员，但你买了全票，坐在了第一排。\n' +
      '以前你只能在视频平台看这些会议的录像，在论文的致谢里想象会场的样子。现在你就在这里——走廊里飘着咖啡和投影的味道，白板笔在幕布上沙沙地画着通路图，休息时间有人在角落里争论mTOR（细胞开关）和AMPK的互作。你不再是那个在宿舍里啃综述的业余爱好者了，你是全职投入这场赛跑的人。\n' +
      '茶歇时，一个白发教授主动过来跟你聊了起来。他看过你写的那篇关于NAD+（能量货币）前体临床数据的荟萃分析，说"有些观点挺尖锐，但数据梳理得不错"。你端着咖啡的手微微发抖——你等这句话等了六年。你不是来蹭会的，你是来证明：一个没有博士学位的人，也能坐在这张桌子前。',
    options: [
      {
        id: 'network_actively',
  ...
  // 数据说话——最新生物标志物结果
  {
    ...
    conditions: (s) => s.isAllInPath === true,
    narrative:
      '你辞职后第一次全套生物标志物检测报告出来了。你坐在家里的书桌前，深呼吸，点开PDF。\n' +
      '辞职后的这一年，你把以前挤在晚上和周末的事情全放进了白天——每天早上七点起床测心率变异性，每周三次力量训练加两次有氧，严格的16:8断食，精准到毫克的补剂方案，每月一次抽血复查。你比上班时更忙了，但忙的全是自己的事。\n' +
      '报告一页一页往下翻。空腹胰岛素、HbA1c、CRP、IL-6、LDH、维生素D、NAD+/NADH比值、端粒长度估算、表观遗传时钟……你在Excel里建了个对比表，把这次的数据和辞职前、三年前、六年前的基线并排放在一起。\n' +
      '趋势线在说话。你的生物年龄偏移比辞职前多了-2.3岁。炎症指标持续下降。胰岛素敏感性回到了二十出头的水平。但有几个指标也亮了黄灯——TSH偏高，提示甲状腺可能在长期热量限制下承受了压力；睡眠质量评分比上班时还差，因为你总在半夜醒来查论文。\n' +
      '你盯着那些数字，忽然意识到：全职投入不等于盲目加码。你的身体是你的实验对象，也是你唯一的实验对象——你赌不起失败。',
    options: [
      {
  ...
  // 不被理解——朋友觉得你疯了
  {
    ...
    conditions: (s) => s.isAllInPath === true,
    narrative:
      '大学同学聚会，你坐在圆桌旁，面前是一杯温水。\n' +
      '点菜的时候你说"我不吃精制碳水"，有人笑了："你还在搞你那套养生啊？"喝酒的时候你端着水杯，有人起哄："辞职了连酒都不喝了？"你解释你在做抗衰研究，有人问你赚多少钱，你说了实话——比上班时少，不稳定。全桌安静了两秒，然后有人打圆场："理想主义嘛，可以理解。"\n' +
      '饭局散场后，一个曾经关系最好的朋友拉着你说："我跟你说句掏心窝的，你以前在公司前途好好的，辞职搞什么长生不老，你不觉得……有点走火入魔了吗？你爸妈知道吗？你以后怎么养老？"\n' +
      '你想解释——解释能量货币、解释表观遗传、解释为什么这不是迷信而是科学——但你看着他的眼神，知道解释没用。在他眼里，你就是一个被伪科学骗了、辞了正经工作、往水里扔钱的人。你忽然感到一种深入骨髓的孤独：你全职投入的事业，在你最好的朋友眼里，是一个笑话。\n' +
      '地铁上你刷手机，看到群里有人发了一张你端着水杯的照片，配文"我们的养生达人"，后面跟了一串哈哈哈哈。你关了屏幕，靠在车窗上。车窗里你的脸比他们都年轻，但你的表情比他们都老。',
    options: [
      {
        id: 'stand_firm',
        label: '不解释，用结果说话',
  ...
  // v13新增：AI制药突破——中期投资组合增长事件
  {
    ...
    narrative:
      '你关注了三年的那家AI制药公司发布了二期临床数据——他们用AI设计的候选药物，在一项衰老相关适应症上达到了主要终点。\n' +
      '消息出来那天你整夜没睡。你从这家公司B轮就开始跟踪，在C轮时重仓买入——不是因为跟风，是因为你读过他们团队每一篇预印本，对照过靶点的生物学机制，你判断他们的分子设计逻辑是对的。市场花了两天才反应过来，第三天开盘股价跳涨。\n' +
      '这不是运气。你过去十年读的每一篇论文、跟踪的每一个靶点、参加的每一场学术会议，都在帮你做出这个判断。但你也清楚：二期临床成功不等于药物上市，后面还有三期、FDA审批、商业化——任何一步都可能翻车。\n' +
      '你现在要决定：落袋为安，还是继续持有赌更大的？',
    options: [
      {
        id: 'take_profits',
        label: '减持一半，锁定利润',
...
const lateGameEvents: NarrativeEvent[] = [
  ...
  // 同龄人——你看起来年轻10岁但钱更少
  {
    ...
    oncePerGame: true,
    narrative:
      '大学毕业二十周年聚会。你走进包间的那一刻，有几秒钟没人认出你。\n' +
      '当年睡你上铺的兄弟胖了三十斤，发际线退到了头顶，正在吃降压药。当年的班长已经白了一半头发，笑起来眼角的皱纹深得像沟壑。当年追过的女生在聊更年期和骨质疏松。而你——你知道自己看起来什么样子。你上个月刚测的表观遗传时钟说你的生物年龄是34岁。\n' +
      '"你是不是整容了？"有人半开玩笑地问。"你怎么一点都没老？"但聊到收入和房产的时候，空气微妙地变了。当年成绩不如你的人已经是总监、VP、创业者，年薪七位数、两套房子、孩子上国际学校。而你——你辞职了十几年，存款不算多，房子是小公寓，车开了十年没换。\n' +
      '有人问你"那你这些年在干什么"，你说"在研究抗衰老"。全桌笑了。那个胖了三十斤的兄弟拍着你肩膀说："你还是这么理想主义。来，喝酒！"你端着水杯，忽然不知道该骄傲还是该心酸。你赌了二十年，赢了年龄，输了世俗的成功。这笔交易值吗？\n' +
      '饭局结束，那个白了一半头发的班长走在你旁边，忽然小声说："说真的……你看起来真年轻。你那套……真的有用吗？"你看着他眼里的光——那不是嘲讽，是一个中年男人对时间的恐惧。',
    options: [
      {
        id: 'pride_in_health',
        label: '健康就是最大的财富，不后悔',
  ...
  // 讣告——同龄人去世
  {
    ...
    oncePerGame: true,
    narrative:
      '大学班级群里弹出一条消息："各位同学，张伟于昨晚因心肌梗死去世，享年45岁。追悼会定于周六。"\n' +
      '你盯着那条消息看了很久。张伟——当年篮球队的中锋，身体壮得像头牛，毕业以后进了互联网公司，一路做到高管。你对他最后的印象是去年同学聚会上他端着白酒一杯接一杯，笑着说"等我赚够了就退休养生"。\n' +
      '你翻出他的动态圈——最后一条停留在两周前，是一张加班到凌晨的工位照片，配文"又一个通宵，命真苦"。下面有人评论"注意身体"，他回了个"没事，年轻扛得住"。\n' +
      '你站起来走到镜子前，看着自己的脸。你和张伟同岁。你想起二十年前你吞下第一粒NMN时，有人说你"神经病"、"怕死"、"交智商税"。张伟也笑过你，说"等你研究出长生不老药我都七老八十了"。他没有等到七老八十。\n' +
      '你不是第一次面对死亡，但这一次格外近——一个和你同岁、同一起跑线的人，先走了。你赌了二十年"活久一点"，此刻你终于明白你为什么赌：不是为了永生，是为了不在四十五岁就变成群里的一条讣告。你打开补剂柜，把每一瓶都检查了一遍保质期。手有点抖。',
    options: [
      {
        id: 'renewed_purpose',
  ...
  // 有限与无限——接受可能活不到150，但旅程本身有意义
  {
    ...
    oncePerGame: true,
    narrative:
      '你五十岁生日那天，独自坐在书房里，翻着自己二十多年来的健康日志。\n' +
      '第一本是22岁开始记的，字迹潦草，满页是"今天开始吃NMN！""断食第三天好饿""跑了5公里"。后来的越来越专业——数据表格、趋势图、补剂调整记录、实验结论。二十八年，二十七本日志，堆在桌上像一座小型的塔。\n' +
      '你最新的表观遗传报告显示，你的生物年龄是41岁。你比同龄人年轻九岁。这是你二十八年来用无数个小时的运动、断食、阅读、抽血、自测换来的。\n' +
      '但你也清楚地知道了一件事：你大概率活不到150岁。你二十岁时相信的"奇点就在眼前""逆转衰老近在咫尺"——没有到来。抗衰老疗法的进展比你预期的慢了十年、十五年。你可能活到九十岁、一百岁——比大多数人健康、比大多数人长寿——但不是150。\n' +
      '你以为你会失落，但奇怪的是你很平静。你翻回第一本日志的第一页，上面是你22岁时写的一行字："我要活到120岁。"你笑了——那个年轻人不知道未来会怎样，但他敢赌。你合上册子，看着窗外的夕阳。你忽然想明白了一件事：你赌的从来不是一个具体的岁数，你赌的是"不向衰老投降"这件事本身。即使最终还是会老、会死——你是站着死的，不是跪着等死的。\n' +
      '这场赌局从一开始就没有"赢"的终点，只有"一直在打"的过程。而这，已经够了。',
    options: [
      {
        id: 'accept_and_enjoy',
        label: '接受有限，享受当下的每一天',
      ...
      },
      {
        ...
        log: '你开始写一本关于健康长寿的书——不是教你"活到150岁"的神话，而是基于你二十八年自体实验的真实经验：什么有用、什么没用、什么是骗局、什么值得坚持。书出版后出乎意料地畅销，你收到了无数封读者来信——有人因为你的书开始运动、有人停掉了没用的补剂、有人说"你让我不再害怕变老"。你翻着那些信，忽然明白了：你一个人活多久不重要，重要的是你让多少人的生命变得更长、更好。你的筹码已经从"自己的寿命"变成了"所有人的可能"。',
      },
      {
        id: 'keep_pushing',
        ...
        log: '你没有放慢脚步，反而加入了最新的临床试验——一种新的senolytics联合疗法正在做人体测试，你符合入组条件。妻子说你"一辈子都在赌"，你说"对，但我赌得越来越聪明了"。你知道150岁可能是奢望，但每多健康活一年，就多一年等到真正突破的机会。你在最新一本日志的第一页写："22岁的我，50岁的我还在赌。别失望。"窗外的夕阳落下去了，你打开台灯，开始读今天新到的论文。灯亮着，你就还在牌桌上。',
      },
    ],
  },
  ...
  // 48岁：同龄人的葬礼——生物黑客同伴的离世
  {
    ...
    narrative:
      '陈医生给你发了条消息：老周走了。\n' +
      '老周是你在"不死者"群里认识的第一批生物黑客，比你大三岁。他比你激进——多肽自助注射、年轻血浆输注、未经批准的基因疗法，他全都试过。三个月前他在群里兴奋地说搞到了一种新的基因重编程载体，"小鼠实验返老还童"，然后就没了消息。\n' +
      '葬礼上来了二十多个生物黑客，大多是网上认识了十几年、现实中第一次见面的人。没有人穿黑西装——老周生前最讨厌"装"。陈医生红着眼睛跟你说："他注射后第三天开始发烧，第七天多器官衰竭。那种载体根本没做过安全剂量测试。"\n' +
      '你站在墓碑前，想起老周最后一条朋友圈——一张他给自己注射的照片，配文"离永生又近了一步"。你低头看了看自己手臂上那些年自体实验留下的淡淡针痕，忽然觉得很冷。你和他之间，也许只差一个"还没出事"的距离。',
    options: [
      {
        ...
        log: '48岁，你花了一万块做了一次最全面的体检。你停掉了所有没有三期临床数据的方案，把自体实验的频率降到了每年一次。你在日志里写："老周，我替你慢下来。"激进的抗衰方案不是勇敢，是对生命的不尊重。你还是会赌，但你学会了不下那种可能输光一切的注。',
      },
      {
        ...
        log: '48岁，你写了一篇长文分析老周的案例——哪里出了错、哪个环节可以避免、什么红线绝不能越。文章在生物黑客圈传了十万次。你没有停，但你把"安全边际"四个字刻进了每一个实验方案的第一行。陈医生说"你这样他也算没白走"，你没说话。你知道这条路还长，而老周成了路边一块警示牌。',
      },
      {
        ...
        log: '48岁，你从葬礼回来后把补剂柜锁了一个月。你不去看论文、不去测数据、甚至停了晨跑。你妻子什么都没说，只是每天晚上多做一个菜。一个月后你打开了柜子，把过期的补剂扔了，没过期的重新摆好。你没有答案，但你知道——你停不下来，不是因为你不怕死，是因为你已经走了太远，回不了头了。',
      },
    ],
  },
];
