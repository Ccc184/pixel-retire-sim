...
const investorEvents: NarrativeEvent[] = [
  ...
  // 45岁：组合市值创新高，面临退休抉择
  {
    ...
    oncePerGame: true,
    narrative:
      '45岁，你的生科组合市值来到了一个你22岁时想都不敢想的数字。二十多年的复利、十几年的赛道押注、无数次临床数据的惊魂，全都凝结在这个数字里。你的身体状态比同龄人年轻七八岁，补剂柜还在，CGM还在手腕上——抗衰技术不是幻想了，它正在变成现实。\n' +
...
const experimenterEvents: NarrativeEvent[] = [
  ...
  // 38岁：表观遗传时钟检测
  {
    ...
    eventType: 'milestone',
    narrative:
      '你花了八千块，做了Horvath表观遗传时钟检测——通过DNA甲基化模式，估算你的细胞有多大年纪。等待结果的两周，你比等任何体检都紧张。你十六年的自律、上万的补剂、无数次的冰水浴和断食，全都凝结在这一个数字上。\n' +
      '报告打开的那一刻，你的手在抖——你的生物年龄比实际年龄小6.2岁，38岁的身体，细胞层面像31.8岁。你盯着那个数字，眼眶忽然湿了。你赌了十六年，第一次拿到"判决书"，而它说：你赌对了。',
    options: [
      {
        id: 'double_down',
        label: '乘胜追击，把生物年龄再压低',
  ...
  // 42岁：身体数据全面领先同龄人
  {
    ...
    oncePerGame: true,
    narrative:
      '42岁这年，你做了一次全面评估：最大摄氧量（VO2max）相当于30岁的水平，握力在同龄人前5%，骨密度正常，反应速度像35岁，表观遗传时钟显示生物年龄33.6。你的同龄人开始出现三高、脂肪肝、腰围失控，而你还能跑半马、还能硬拉自体重。\n' +
  ...
  // 44岁：你的身体成了最好的广告
  {
    ...
    eventType: 'milestone',
    narrative:
      '你44岁了。大学同学聚会上，你发现自己是唯一一个没有啤酒肚、没有白发、不需要扶着膝盖站起来的人。有人问你"是不是整容了"，有人问你"吃的什么仙丹"。你的体检报告全是绿箭头，医生反复看了两遍片子，问你"平时做什么运动"。\n' +
  ...
  // 45岁：人生的下半场
  {
    ...
    eventType: 'milestone',
    narrative:
      '45岁生日那天，你跑完了今年的第二个半马。冲过终点线时看了一眼手表：比去年快了两分钟。你的生物年龄是31岁，存款、被动收入、健康状态都允许你不再为钱工作。如果你的抗衰方案有效，你可能还有五十年甚至更久。\n' +
...
const researcherEvents: NarrativeEvent[] = [
  ...
  // 45岁：回答最初的问题
  {
    ...
    eventType: 'milestone',
    narrative:
      '45岁，你在整理书房时翻出一本22岁的笔记本，扉页写着一行字："我要搞清楚人到底能不能活更久。"你坐在地上翻了很久，那些被划掉又重写的假设、贴满便签的论文打印件——二十三年前你问了一个问题，现在你有了一部分答案：能，但靠的是自律、监测、科学进步和一点运气，而不是一颗神药。\n' +
...
const lateGameEvents: NarrativeEvent[] = [
  ...
  // 同龄人——你看起来年轻10岁但钱更少
  {
    ...
    oncePerGame: true,
    narrative:
      '大学毕业二十周年聚会，你走进包间的那一刻，有几秒钟没人认出你。当年睡你上铺的兄弟胖了三十斤正吃降压药，班长白了一半头发，当年追过的女生在聊更年期——而你上个月刚测的表观遗传时钟说你的生物年龄是34岁。"你是不是整容了？"有人问。但聊到收入和房产，空气微妙地变了：当年成绩不如你的人已是总监、VP，年薪七位数、两套房，而你辞职了十几年，存款不多，房子是小公寓。\n' +
      '有人问"那你这些年在干什么"，你说"在研究抗衰老"，全桌笑了。你端着水杯，忽然不知道该骄傲还是该心酸——你赌了二十年，赢了年龄，输了世俗的成功。这笔交易值吗？饭局结束，班长走在你旁边小声说："说真的……你那套……真的有用吗？"你看着他眼里的光，那不是嘲讽，是一个中年男人对时间的恐惧。',
    options: [
      {
        id: 'pride_in_health',
        label: '健康就是最大的财富，不后悔',
  ...
  // 讣告——同龄人去世
  {
    ...
    narrative:
      ...
      '你站起来走到镜子前。你和张伟同岁。二十年前你吞下第一粒NMN时有人说你"怕死、交智商税"，张伟也笑过你："等你研究出长生不老药我都七老八十了。"他没有等到。你赌了二十年"活久一点"，此刻你终于明白你为什么赌——不是为了永生，是为了不在四十五岁就变成群里的一条讣告。你打开补剂柜，把每一瓶检查了一遍保质期。手有点抖。',
    options: [
      {
        id: 'renewed_purpose',
  ...
  // 有限与无限——接受可能活不到150，但旅程本身有意义
  {
    ...
    oncePerGame: true,
    narrative:
      '你五十岁生日那天，独自坐在书房翻着二十多年来的健康日志。第一本是22岁记的，字迹潦草，满页是"今天开始吃NMN！""断食第三天好饿"；后来的越来越专业——数据表格、趋势图、补剂调整记录。二十八年，二十七本日志堆在桌上像一座小型的塔。你最新的表观遗传报告显示生物年龄41岁，比同龄人年轻九岁——这是你用无数个小时的运动、断食、抽血换来的。\n' +
      '但你也清楚地知道：你大概率活不到150岁。二十岁时相信的"逆转衰老近在咫尺"没有到来，进展比你预期的慢了十年、十五年。你以为你会失落，却出奇地平静。你翻回第一本日志的扉页，上面是22岁的你写的一行字："我要活到120岁。"你笑了——那个年轻人不知道未来会怎样，但他敢赌。你忽然想通了：你赌的从来不是一个岁数，是"不向衰老投降"这件事本身。即使最终还是会老、会死——你是站着死的，不是跪着等死的。这场赌局从一开始就没有"赢"的终点，只有"一直在打"的过程。而这，已经够了。',
    options: [
      {
        id: 'accept_and_enjoy',
        label: '接受有限，享受当下的每一天',
...
const experimenterAchievements: NarrativeAchievement[] = [
  ...
  // 终极：45岁的身体，30岁的细胞
  {
    ...
    title: '不老之身',
    narrative: `45岁这年，你做了一次全面评估。VO2max、握力、骨密度、反应速度、表观遗传时钟——每一项都指向同一个结论：你的身体，像三十岁出头的人。你站在镜子前，看着一张没有白发的脸、一个没有啤酒肚的身体。你赌了二十三年，从一粒NMN开始，到今天这一身"不老之身"。你不是超人，你只是一个赌徒——赌自律能跑赢时间，赌科学能改写命运。\n\n你想起22岁那个吞下第一粒胶囊的自己。TA不知道这粒药有没有用，但TA选择了相信。你想对TA说：你赌对了。你的身体，就是你的奖杯——你不是在逃避衰老，你是在和它谈判，而谈判桌上，你终于有了筹码。`,
    pathId: 'bio_gambler',
    branch: 'bio_experimenter',
    level: 3,
