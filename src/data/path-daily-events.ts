...
export const PATH_DAILY_EVENTS: DailyEvent[] = [
  ...
  // ============================================================
  // 银发守夜人 (silver_economy) 增补 — 12条
  // 扩充事件池以压低长局重复率
  // ============================================================
  {
    id: 'silver_briar_story',
    text: '徐爷爷掏出泛黄的相册，从第一页缓缓翻给你看。四九年、六六年、八九年，每张照片背后都有一段你不懂的历史。他说"现在年轻人都不愿听这些了"，你接过相册，又听他讲了一遍。',
    label: '翻旧相册',
    ageRange: [22, 60],
    conditions: (state: GameState) => state.retirementPath === 'silver_economy',
    priority: 4,
  ...
  {
    id: 'silver_family_denial',
    text: '老人的子女说"送养老院就是不想负责任"，当着你的面吵起来。你站在旁边捏着登记表没插话——等他们吵完，你才把"日间照料"和"专业照护"的区别一个字一个字讲清楚。',
    label: '子女争执',
    ageRange: [26, 55],
    conditions: (state: GameState) => state.retirementPath === 'silver_economy',
    priority: 5,
  ...
  {
    id: 'silver_birthday_cake',
    text: '给九十岁的刘奶奶过生日，她吹蜡烛前认真地许了个长愿。问你许的什么，她笑得像个孩子："许的今天这顿饭别是最后一顿。"你眼眶一热，把蛋糕往她面前推了推。',
    label: '九旬生日',
    ageRange: [24, 58],
    conditions: (state: GameState) => state.retirementPath === 'silver_economy',
    priority: 5,
    effects: { happiness: 3, stress: -1, savings: -200 },
  },
  {
    id: 'silver_legacy_letter',
    text: '帮一位老人整理遗嘱，他口述时停顿了很久："我这一辈子，没为谁活过。"你录音笔开着，却不知道该不该让他把这句话说下去。',
    label: '遗嘱口述',
    ageRange: [30, 60],
    conditions: (state: GameState) => state.retirementPath === 'silver_economy',
    priority: 6,
  ...
  {
    id: 'silver_raincoat',
    text: '下雨天去回访独居老人，他非塞给你一把伞："小姑娘，天凉别再淋雨。"你推辞不过，撑着那把旧伞走回站点，路上才发现伞骨断了一根，却挡得严严实实。',
    label: '老人赠伞',
    ageRange: [22, 50],
    conditions: (state: GameState) => state.retirementPath === 'silver_economy',
    priority: 4,
  ...
  {
    id: 'silver_smartphone_teacher',
    text: '教老人用手机挂号，他颤巍巍地记了三页笔记，每个步骤都画了箭头。第二天他打来说"我挂上号了"，语气像考了满分的小学生——你挂了电话才想起，自己教了他四遍。',
    label: '教用手机',
    ageRange: [22, 55],
    conditions: (state: GameState) => state.retirementPath === 'silver_economy',
    priority: 4,
  ...
  {
    id: 'silver_fall_call',
    text: '凌晨两点被电话吵醒，一位独居老人摔倒了。你套上外套冲过去，扶着他等救护车，他抓着你的手说"别告诉我女儿，她在外地忙"。你用他女儿的名字发了条短信，把"忙"字删了。',
    label: '深夜摔倒',
    ageRange: [24, 55],
    conditions: (state: GameState) => state.retirementPath === 'silver_economy',
    priority: 7,
    effects: { stress: 4, health: -1, parents: { relationShip: 1 } },
  },
  {
    id: 'silver_photo_scan',
    text: '帮老人把老照片一张张扫描进电脑，他指着人群里一个模糊身影说"这是我年轻时的爱人"。你小心翼翼擦去灰尘，忽然觉得此刻自己不是在做服务，是在替他留住一段时光。',
    label: '扫描旧照',
    ageRange: [22, 55],
    conditions: (state: GameState) => state.retirementPath === 'silver_economy',
    priority: 4,
  ...
  {
    id: 'silver_meal_watch',
    text: '回访时发现独居王爷爷一周没好好吃饭，冰箱里只剩半袋馒头。你下楼买了热粥和菜，看着他吃的时候，他忽然说"你比我亲闺女还惦记我"。你背过身，把落下的那点哽咽咽了回去。',
    label: '饥饿老人',
    ageRange: [24, 58],
    conditions: (state: GameState) => state.retirementPath === 'silver_economy',
    priority: 6,
    effects: { happiness: 2, stress: 2, savings: -100 },
  },
  {
    id: 'silver_community_recognition',
    text: '社区开会表彰你，主持人念你的名字时，台下十几个老人齐齐鼓掌。散会一个奶奶拉住你："大家伙都说，有你在这儿，我们心里踏实。"你第一次觉得，这工作值了。',
    label: '社区表彰',
    ageRange: [26, 55],
    conditions: (state: GameState) => state.retirementPath === 'silver_economy',
    priority: 5,
  ...
  {
    id: 'silver_young_volunteer',
    text: '带新来的大学生志愿者回访，她临走时红着眼眶说"原来老了是这样"。你拍拍她："会难受就对了，说明你把这当回事。"她点点头，第二天又来了。',
    label: '带新人',
    ageRange: [28, 55],
    conditions: (state: GameState) => state.retirementPath === 'silver_economy',
    priority: 4,
  ...
  {
    id: 'silver_own_parents',
    text: '忙了一整天照顾别人的父母，晚上才想起给自己爸妈打个电话。接起来的却是忙音——你对着"对方暂时无法接通"愣了几秒，然后一遍遍重拨，直到那声熟悉的"喂"响起。',
    label: '牵挂父母',
    ageRange: [26, 55],
    conditions: (state: GameState) => state.retirementPath === 'silver_economy' && state.parents.isAlive,
    priority: 5,
